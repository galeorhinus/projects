...
function updateStatusDisplay(data) { 
    ...
    if (!statusEl1 || !statusEl2 || !headPosTextEl || !footPosTextEl || !mattressLineEl) return;
    ...
    var headPercent = (headPosNum / HEAD_MAX_SEC) * 100;
    var footPercent = (footPosNum / FOOT_MAX_SEC) * 100;
    headPercent = Math.max(0, Math.min(100, headPercent));
    footPercent = Math.max(0, Math.min(100, footPercent));
    ...
    var points = HEAD_X_START + ',' + headY + ' ' + HEAD_X_END + ',' + MATTRESS_Y_BASE + ' ' + GAP_X_START + ',' + MATTRESS_Y_BASE + ' ' + GAP_X_END + ',' + MATTRESS_Y_BASE + ' ' + FOOT_TRIANGLE_X_START + ',' + MATTRESS_Y_BASE + ' ' + FOOT_TRIANGLE_X_END + ',' + footY + ' ' + FOOT_BAR_X_START + ',' + footY + ' ' + FOOT_BAR_X_END + ',' + footY;
