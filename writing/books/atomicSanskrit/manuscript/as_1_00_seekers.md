...
A civilization that begins from पूर्णम् (*pūrṇam*) approaches order through disciplined inquiry. A seeker examines what sustains the surrounding order, tests each conclusion against experience and inherited knowledge, and accepts the discipline required by that search.
...
Later chapters apply this same method to असुर (*asura*), आर्य (*ārya*), and संस्कृत (*saṃskṛta*). Each word describes actions or attributes that a fixed English label conceals.

---

## 0.4 संस्कृतम् (*Saṃskṛtam*) and प्राकृतानि (*Prākṛtāni*)
...
Some लौकिक (*laukika*) usage may have varied before Pāṇini. Continuous calibration kept those variations within Sanskrit's architecture, while the Vedas remained unchanged.
...
> “In the earlier age of the देवाः (*devāḥ*), सत् (*sat*) was born from **असत् (*asat*)**.” (RV 10.72.2)[NOTE: rv-10-72-2-sat-born-from-asat]

If सत् (*sat*) had to arise from असत् (*asat*), then the order aligned with सत् (*sat*) cannot be the universe’s default order. Human beings can create systems aligned with either condition. The asuric pyramid is an order created from असत् (*asat*).
...
> “ऋत (*Ṛta*) and सत्य (*satya*) were born from intensely blazing *tapas*.” (RV 10.190.1)[NOTE: rv-10-190-1-rta-satya-cocreated]
...
> “The intellect that discriminates between सत् (*sat*) and असत् (*asat*).”

How does one tell सत् (*sat*) and असत् (*asat*) apart?
...
Before human choice shapes an order toward सत् (*sat*) or असत् (*asat*), living beings act within प्रकृति (*prakṛti*).

- **विकृति (*vikṛti*)** — representing असत् (*asat*) — the **वृजिन (*vṛjina*)** movement.
