...
**Lexicon-Dependent Conlangs begin from an engineered plan but cannot generate everything they need from that plan.** When a new circumstance exceeds the initial vocabulary and procedures, a creator, founding document, later authority, or speaking community must add more material. The project remains engineered, but its ability to express something new depends upon extending its inventory.

**Generative Architectures can create new expressions from their internal design.** At this level, Esperanto and Sanskrit belong in the same quadrant. Esperanto's generative architecture lets speakers form words beyond its original vocabulary and makes the language capable of ordinary life. As new forms compete and communal usage selects among them, however, the language begins changing with its speakers. **Vivification is entropy acting upon an engineered language through ordinary communal use.** Esperanto's **vivification** demonstrates that a generative architecture alone cannot prevent that movement.[NOTE: esperanto-engineered-botanical-transition]

Sanskrit succeeds where Esperanto did not because its one generative architecture operates through two domains. The *vaidika* domain keeps an invariant body in exact transmission, while the *laukika* domain lets speakers generate new expression from the same language. Chapter 16 examines this two-domain design in full.

That design gives correction several independent checks. Reciters hear a phonetic deviation because they know the calibrated sound. Meter exposes a broken quantity. Grammar exposes a malformed derivation, and the *pāṭha* disciplines expose a damaged sequence. Distributed lineages can therefore correct a departure without asking an apex to select a prestige form. *Gauḥ* is the calibrated form because the architecture generates and verifies it, while *gāvī*, *goṇī*, *gotā*, and *gopotalikā* remain identifiable as departures from that form.

The four responses now follow the 2×2 from Chapter 2. Natural languages absorb variation into their history. Authorities keep variation out of petrified forms. Lexicon-dependent conlangs require additions when their original inventory runs out. Generative architectures can create new expression internally, but generativity alone does not preserve them against entropy. Sanskrit's two-domain architecture allows worldly use to expand while the language remains invariant.
...
**Forms outside the active orbit can drift much farther.** English vocabulary for cognitive failure has moved through *idiot*, *imbecile*, *moron*, *feebleminded*, *retarded*, *intellectually disabled*, and *neurodivergent*. A term enters as a supposedly neutral description, speakers attach the social stigma of its referent to it, and institutions eventually replace it with another term; *retarded*, for example, left United States federal statutes through Rosa's Law and later disappeared from diagnostic usage.[NOTE: rosa-law-2013] The phrase *euphemism treadmill* describes this repeated replacement.[NOTE: pinker-euphemism-treadmill]
