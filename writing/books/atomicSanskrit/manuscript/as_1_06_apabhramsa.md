...
Patañjali states the asymmetry in the पस्पशाह्निक (*Paspaśāhnika*):
...
## 6.3 गौः (*Gauḥ*) and Its Fallings-Away

Patañjali demonstrates the imbalance through **गौः (*gauḥ*)** — cow. The grammatical architecture specifies गौः (*gauḥ*), while speakers can produce a family of deviations from its sounds and form:
...
**Deviation** is a detectable departure within an architecture that retains its calibrant. When लौकिक (*laukika*) Sanskrit usage moves away from established Sanskrit शब्द (*śabda*) or grammar, the वैयाकरणाः (*vaiyākaraṇāḥ*) can locate and correct the departure because the calibrant remains unchanged.
