...
The Brāhmī thesis becomes testable by engineering content rather than corridor-of-origin chronology — stone preserves the pyramid; it does not preserve the notebook — and a harder investigation can begin: whether Brāhmī or its precursor rode Wave 1 outward, leaving the corridor scripts a diminished reflection of an Indic audiographic logic (Appendix Part 3 §§3.5–3.6). The language factory demonstrates Sanskrit's generative capacity directly. Run on a Japanese sound inventory, the architecture generates a usable constructed language.
