...
The ***सम्बोधन (*sambodhana*, vocative)*** **अग्ने (*agne*)** occurs after **उप त्वा (*upa tvā*)**, so it does not receive the accent that it would receive at the beginning of a sentence or पाद (*pāda*). Compare the opening of Ṛgveda 3.25.1, where **अग्ने॑ (*ágne*)** begins the passage and receives the accent. The word and its grammatical role remain the same; its position inside the sentence changes the स्वर (*svara*). The reciter must therefore preserve more than the dictionary form of the word.[NOTE: vedic-vocative-sentence-accent]

The last पाद (*pāda*) contains another Vedic form:
...
The recited form **एमसि (*emasi*)** resolves into **आ + इमसि (*ā + imasi*)**. Its first-person plural ending is **-मसि (*-masi*)**, which Pāṇini later documented in Aṣṭādhyāyī 7.1.46. The corresponding लौकिक (*laukika*) form is **एमः (*emaḥ*)**, with the ending **-मस् (*-mas*)**.[NOTE: vedic-personal-ending-imasi]

The additional **इ (*i*)** gives the Vedic form three syllables: **इ-म-सि (*i-ma-si*)**. The complete पाद (*pāda*) — **नमो भरन्त एमसि (*namo bharanta emasi*)** — has the eight syllables required by Gāyatrī. Replacing **एमसि** with **एमः** would remove one syllable. In this passage, the additional personal ending therefore contributes directly to छन्दस् (*chandas*). It also creates another audible checkpoint: a reciter who shortens the ending disturbs both the verbal form and the meter.
...
Chapter 16 introduces the collision through **ब्रवाणि (*bravāṇi*)** in Ṛgveda 6.16.16 and contrasts it with **तारिषत् (*tāriṣat*)** in Ṛgveda 10.186.1, where no collision occurs.[NOTE: vedic-let-bravani-tarisat] The full comparison shows that identical लेट् (*leṭ*) and लोट् (*loṭ*) forms occur mainly in the first person.

In the ***परस्मैपदम् (*parasmaipadam*)***, **भवानि, भवाव, भवाम (*bhavāni, bhavāva, bhavāma*)** can belong to either लेट् (*leṭ*) or लोट् (*loṭ*). The corresponding first-person forms in the ***आत्मनेपदम् (*ātmanepadam*)*** collide in the same way. These are identical forms rather than approximate similarities.
...
**The vaidika difference is वोचम् (*vocam*)**, which occurs without the ***अट्-आगम (*aṭ-āgama*, augment)*** **अ (*a*)**. The corresponding लौकिक (*laukika*) ***लुङ् (*luṅ*, aorist)*** is **अवोचम् (*avocam*)**, *I said* or *I proclaimed*. Modern grammars call the unaugmented Vedic लुङ् (*luṅ*) form the *injunctive*.[NOTE: vedic-injunctive-vocam]

The form must be read with the words around it. **नु (*nu*)** brings the declaration into the present moment, and **प्र वोचम् (*pra vocam*)** performs the act as the mantra begins: *I now proclaim*. The accent falls on **प्र (*pra*)**, while **वोचम्** remains unaccented. The absence of the अट्-आगम (*aṭ-āgama*), or augment, does more than shorten the line. It allows the लुङ् (*luṅ*) form to receive its time and force from the immediate passage instead of marking an ordinary past statement. The same form also removes one syllable that **अवोचम्** would add. In this passage, **वोचम्** therefore contributes both a compact semantic distinction and the required syllable count.

### A Vedic क्त्वा (*ktvā*) Form — Gerund or Conjunctive Participle

Ṛgveda 3.40.7 uses **पीत्वी (*pītvī*)** where लौकिक (*laukika*) Sanskrit uses **पीत्वा (*pītvā*)**:
...
Ṛgveda 1.24.8 uses two ***तुमर्थक रूपाणि (*tumarthaka rūpāṇi*, infinitive forms)*** where a लौकिक (*laukika*) student would expect **-तुम् (*-tum*)**:
...
The पदपाठ (*padapāṭha*) separates the first तुमर्थक (*tumarthaka*) form as **अनु-एतवै (*anu-etavai*)**, *to follow*. The mantra also uses **प्रतिधातवे (*pratidhātave*)**, *to set down*. A लौकिक (*laukika*) composition would ordinarily use **अन्वेतुम् (*anvetum*)** and **प्रतिधातुम् (*pratidhātum*)**. Pāṇini later documented **-तवै (*-tavai*)**, **-तवे (*-tave*)**, and several other Vedic तुमर्थक (*tumarthaka*) endings in Aṣṭādhyāyī 3.4.9.[NOTE: vedic-infinitives-rv-1-24-8]

Both पादाः (*pādas*) are transmitted in Triṣṭubh. The Vedic तुमर्थक (*tumarthaka*) forms are longer than the corresponding **-तुम्** formations, so replacing them with **अन्वेतुम्** and **प्रतिधातुम्** would shorten the two पादाः (*pādas*). In this mantra, the additional endings contribute to syllable count and poetic arrangement while preserving the same purpose relation.
...
| Vedic scope | भाषा (*Bhāṣā*) scope | Grammatical record |
|---|---|---|
...
| a wider Vedic use of the ***क्वसु (*kvasu*)*** formation | **उपसेदिवान् (*upasedivān*)**, from a restricted भाषा (*bhāṣā*) use of that formation | *Aṣṭādhyāyī* 3.2.107–108 |
