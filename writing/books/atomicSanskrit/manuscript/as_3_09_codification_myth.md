...
A complete test would compare Vedic Saṃhitā passages by शाखा (*śākhā*), Brāhmaṇa prose, Āraṇyaka and Upaniṣadic prose, प्रातिशाख्य (*Prātiśākhya*) and शिक्षा (*Śikṣā*) material, Yāska's निरुक्त (*Nirukta*), Sūtra prose, and लौकिक (*laukika*) compositions against the architecture Pāṇini documents.[NOTE: calibration-audit-gap]

The audit would begin by placing each example in the वैदिक (*vaidika*) or लौकिक (*laukika*) domain. It would then record the narrower boundary stated by the source: mantra, Brāhmaṇa, निगम (*nigama*), a particular text or lineage, लौकिक (*laukika*) use, or another specified context.
...
Only then would the audit ask what happened. One form may have replaced another. Both may remain available under different conditions. Meter may select between two lengths. A lineage may preserve a particular realization. A form may belong to one domain because that domain benefits from it, while unrestricted लौकिक (*laukika*) composition does not.
