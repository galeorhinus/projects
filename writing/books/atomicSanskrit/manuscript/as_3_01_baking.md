...
Deccan College Pune is the exemplar, not because it invented PIE, but because its institutional history exposes the route. The appendix follows the documented conversion mandate, the institutions that collected and circulated Sanskrit knowledge, the comparative claims built from that knowledge, and the framework's survival after its racial language became unacceptable. It then tests the result against seven Sanskrit धातवः (*dhātavaḥ*).
...
German university chairs at Berlin, Leipzig, Jena, and Göttingen then processed knowledge gathered through Calcutta, Pune, Banaras, Bombay, Madras, Oxford, and Cambridge. Without that network, European philology could not have constructed an imaginary ancestor for Sanskrit at this scale. Indian teachers and institutions supplied the Sanskrit knowledge. German universities baked the reconstructed language. The same institutional network then returned the bake to India as the authoritative account of the knowledge it had received.

Genuine Sanskrit scholarship and philological machinery occupied the same institutions, but they performed different acts. Sanskrit scholarship operated inside Sanskrit's own framework: व्याकरण (*vyākaraṇa*) on Pāṇini's terms, निरुक्त (*nirukta*) on Yāska's terms, मीमांसा (*mīmāṃsā*) on Jaimini's terms, recitation through teacher-student transmission, and lexicography within Sanskrit's own ranges of meaning. Philological machinery extracted the same knowledge, compared it, and reinterpreted it inside an external framework.
...
The institution that should have resisted the external framework became part of the channel that sustained it.
