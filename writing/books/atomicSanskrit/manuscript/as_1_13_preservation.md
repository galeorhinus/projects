...
Aural preservation faces harder design constraints. It requires trained vocal production, trained discriminating hearing, social continuity through the गुरु-शिष्य (*guru-śiṣya*) chain, and several recitation paths strong enough to detect and correct error before it becomes inheritance. It uses the body as instrument and the ear as validator. Once those design constraints are met, aural engineering becomes a powerful counter to the asuric pyramid. The standard lives in trained people, passes from teacher to student, and remains audible across society. Because people carry the standard in memory and disciplined practice, an apex cannot capture it by seizing a manuscript or archive.
...
The two paths leave different kinds of evidence. The Vedas are the primary calibrant: a fixed body of language kept audible through continuous recitation. When a form or pronunciation departs, a trained listener can compare it with the transmitted Vedic form. The प्रातिशाख्य (*Prātiśākhya*) disciplines articulate the pronunciation preserved in the Vedic branches, while the eleven पाठाः (*pāṭhāḥ*) make departures easier to detect.

Pāṇini's अष्टाध्यायी (*Aṣṭādhyāyī*) documents another path into the same architecture. Its sūtras make derivation explicit, compact, portable, and teachable. This documentation especially helps readers trained in व्याकरणम् (*vyākaraṇam*), for whom the rule becomes clear before the pattern settles through repeated use. The Vedas preserve the language in performed form. The अष्टाध्यायी (*Aṣṭādhyāyī*) explains how its forms can be derived. Pāṇini did not create another calibrant or replace the Vedas. His documentation made the existing architecture easier to examine, teach, and apply.
...
The same correction occurs in Sanskrit. Suppose a student sees the धातुः (*dhātuḥ*) **⟪धा⟫ (*dhā*)** and, by false analogy with **भवति (*bhavati*)**, writes **धाति (*dhāti*)**. The form is wrong. A reader trained in व्याकरणम् (*vyākaraṇam*) corrects by rule: **⟪धा⟫ (*dhā*)** belongs to the third **गणः (*gaṇaḥ*)**, the **जुहोत्यादि (*juhotyādi*)** class. अष्टाध्यायी (*Aṣṭādhyāyī*) 2.4.75 replaces the regular **शप् (*śap*)** marker with **श्लु (*ślu*)** for this class. Rule 6.1.10 then requires reduplication before **श्लु (*ślu*)**. Together with the remaining operations, these rules produce **दधाति (*dadhāti*)**, not **धाति (*dhāti*)**.[NOTE: juhotyadibhyah-shluh-dadhati]

A reader trained through श्रवण (*śravaṇa*) can correct by mantra. The wrong form is heard as deviant against the internalized record, and the corrector quotes the Vedic line:
...
For **दधाति (*dadhāti*)**, either reader can correct the same error. The Vedic line preserves the performed form. The अष्टाध्यायी (*Aṣṭādhyāyī*) explains its derivation even when that line is not at hand. The two methods accommodate different kinds of mind and converge on the same Sanskrit form.

The two methods are not equal foundations. Chapter 2 shows that grammatical documentation can preserve knowledge about a language without preventing that language from changing. The Vedas gave Sanskrit what documentation alone cannot provide: a large, invariant body of language kept audible and available for continuous comparison. They remain the primary calibrant. The अष्टाध्यायी (*Aṣṭādhyāyī*) makes the architecture easier to analyze, teach, and apply. Its documentation strengthens access to the calibrant without replacing it.
...
Natural speech changes through usage.

Pyramidal systems impose a standard through authority.

Sanskrit preserves alignment through calibration.
