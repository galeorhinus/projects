...
One breath passes through three stages: the throat opens, the mouth shapes the tone, and the nose carries the final hum. Lungs, vocal cords, tongue, lips, soft palate, oral cavity, and nasal cavity all participate. **Oṃ is a compact acoustic sweep through the anatomy of sound.**
...
Every language uses the same physical apparatus. The lungs supply air. The vocal cords make that air vibrate. The throat, mouth, and nose shape the vibration into speech. English, Arabic, Mandarin, Hawaiian, Xhosa, Vietnamese, and Sanskrit all begin from the same instrument. The selections differ. The instrument is one.
...
The sitar combines both patterns. Each pluck begins as a discrete attack, like a consonant event. The string then sustains and decays, like a vowel. Speech alternates between attacks and sustains the same way.
...
Sanskrit makes this physical difference part of its timing architecture. A consonant lasts briefly. A vowel can sustain the tone before or after that consonantal event. Chapter 9 shows how Sanskrit bonds the two and measures their duration.
...
The five named स्थान (*sthāna*) are a specific selection from the possible places of contact. The interdental position between the upper and lower teeth, where English makes *th*, sits between ओष्ठ्य (*oṣṭhya*) and दन्त्य (*dantya*) and receives no separate Sanskrit station. The deep pharyngeal region where Arabic makes ع and ح sits behind कण्ठ्य (*kaṇṭhya*) and remains outside the system. Chapter 8 examines the subcontinental sound inventory and asks whether languages across India already use those five places before Sanskrit selects them precisely.[NOTE: place-of-articulation-sanskrit-terms]
