...
The five Sanskrit-named places (BIL, DEN, RET, PAL, VEL) use their *sthāna* names. The seven other columns use standard labels. The five *sthāna* names define Sanskrit's selection from the broader anatomical space the human voice can reach.
