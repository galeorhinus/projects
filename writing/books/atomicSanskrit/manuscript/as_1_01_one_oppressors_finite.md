...
The frame represents the asuric pyramid itself. Its apex claims authority, its boundaries create enclosure, and its geometry uses both to create control. Each numbered block represents one obstruction placed between the reader and Sanskrit. As the chapters proceed, the book takes these obstructions one at a time. It identifies what each obstruction hides, explains how the pyramid placed it over Sanskrit, and restores the architecture concealed beneath it. When the next part opens, the corresponding block is gone and more of the Sanskrit-Sun has become visible. This sequence continues until the Sun stands clear.
...
The pyramid cannot remain secure while its subjects remember that another architecture existed and worked. That memory gives them a standard outside the pyramid. They can compare the order they inherited with the order imposed upon them and recognize containment.

The objective is to erase civilizational memory. Physical attack destroys the people, texts, temples, and practices that carry it. Disfigurement breaks the relationships among what remains. Concealment prevents later generations from recognizing the evidence, while a replacement account teaches them to remember their own past incorrectly.

The Western pyramid presents itself as non-oppressive. Openly destroying an alternative or forbidding its subjects from examining it would expose its own coercion. It therefore relies on disfigurement and concealment. Institutions disfigure the alternative by misclassifying its examples. The curriculum hides calibration by omitting the category. Certified intellectuals teach people to dismiss what remains before they can recognize it. The pyramid does not prevent its subjects from looking. It *“protects”* them from seeing.

The English Empire, like most modern pyramids, imposed several forms of control at once. England occupied the apex. The Welsh, Irish, and Scots occupied lower levels, while Indians stood lower still. The pyramid extracted from every level, but changed the scale of extraction and the method of manipulation according to where a population stood within its geometry. Within England, it disguised the pyramid as liberty while directing its subjects through class, curriculum, certification, and control over which alternatives entered public view. In India, it imposed the same architecture openly through brutality, birth- and race-based hierarchies, and force.[NOTE: english-empire-layered-pyramid]

### Compatibility Is Not Immunity

A pyramidal architecture is clearly an architecture of containment and therefore consistent with the Vedic descriptions of असत् (*asat*) and asuric action. However, not everything outside formal Vedic calibration is asuric. An आस्तिक (*āstika*) formation accepts the Veda as a calibrant. A नास्तिक (*nastika*) discipline may choose not to calibrate itself against the Veda and still live harmoniously beside it, beside other harmonious formations, and within the balance of the world. A प्राकृतिक (*prākṛtika*) culture may organize life through inherited customs shaped by its community and surroundings without feeling threatened by the Vedic calibrant. The asuric formation acts differently: because the calibrant and the balance it protects restrict apex power, the asuric formation tries to destroy, displace, shame, capture, or distort it.
...
The same insecurity drives the asuric obsession with chronology capture. The pyramid is threatened by **अनादि (*anādi*)**, that which has no beginning, and **अनन्त (*ananta*)**, that which has no end. Chronology records sequence. The pyramid converts that sequence into hierarchy: what comes earlier becomes primitive, what comes later becomes advanced, and position on the timeline is made to determine value, authority, and ownership. Once the pyramid owns the clock, it can call one layer early, another late, one primitive, another developed, one original, another borrowed. It can recast domain as period, mode as stage, architecture as evolution, and calibration as late correction. In the pyramid's story, the *Veda* must therefore be dated, stratified, and sequenced: the calibrant has to be forced into a clock before it can be made to descend.

## 1.3 Svarbhānu's Method of Concealment

In the Vedic mantra, Svarbhānu pierces Sūrya with darkness, and the worlds become मुग्ध (*mugdha*), bewildered, like one who does not know the field.

The asuric pyramid repeats Svarbhānu's method against Sanskrit in two stages. The British colonial state first attacked the social foundations that kept the language audible. After independence, the Indian government carried the attack into its highest institutions. During the Constituent Assembly debates of 1949, Jaipal Singh denounced the Sanskritization of Hindi as "puritanical fanaticism" and warned that Devanagari would retard India's progress.

A decade later, Prime Minister Jawaharlal Nehru attacked Raghu Vira's work by name in the Lok Sabha. He called Sanskrit-based terminology "artificial, unreal, absurd, fantastic and laughable." He then declared that such an approach could not support progress. Parliament had presented Sanskrit's generativity as an obstacle to the modern world.[NOTE: anti-sanskrit-progress-parliament]

As if by coordination, Julius Pokorny published his *Indogermanisches etymologisches Wörterbuch* in the same year. His dictionary gathered thousands of imaginary PIE forms into a reference work and gave the anti-Sanskrit campaign in India more ammunition. India was being taught that Sanskrit could not generate words for modern life while the West manufactured imaginary words for an imaginary ancestral language and granted them authority over Sanskrit. Chapter 19 §19.4 follows Pokorny's dictionary into modern reference works.[NOTE: pre-pie-dictionary-shift][NOTE: pie-cementing-recent-decades]
...
**Install a single apex.** The hunger of the apex becomes the demand that every plural order be subordinated to one gate. One origin. One doctrine. One permitted chronology. One authorized method. One human office that decides what counts as knowledge. The Boden Chair of Sanskrit at Oxford, established in 1832, made the pattern literal: Joseph Boden endowed the chair for the explicit purpose of converting Indians to Christianity through Sanskrit. Horace Hayman Wilson held the chair from 1832 to 1860. Monier Monier-Williams emphasized that purpose during the next election and defeated Max Müller in 1860. Both men produced Sanskrit-English dictionaries; the expanded Monier-Williams dictionary remains widely used.[NOTE: boden-chair-1832-evangelical-purpose]

**Withhold the light.** Svarbhānu darkens Sūrya.[NOTE: rigveda-5-40-5-svarbhanu-eclipse] Vṛtra withholds the waters.[NOTE: rv-1-32-vrtra] Kāliya poisons the river.[NOTE: kaliya-yamuna-poisoning] The shared structure is obstruction of circulation: light, water, knowledge, speech, and orientation. The source remains; access to what the source makes visible is blocked. Griffith mistranslated Ṛgveda 9.63.5 and hid its declaration **कृण्वन्तो विश्वम् आर्यम् (*kṛṇvanto viśvam āryam*)**, *making the whole world ārya*. A quality that can be created throughout the world cannot be a race fixed by birth. Griffith replaced this declaration with *"performing every noble work"* and rendered **अराव्णः (*arāvṇaḥ*)**, the non-givers, as *"the godless ones."* His translation removed both the mantra's non-racial meaning of आर्य (*ārya*) and its opposition to those who withhold.[NOTE: rigveda-9635-wilson-griffith]

**Steal the foundation.** Madhu and Kaiṭabha steal away the Vedas.[NOTE: madhu-kaitabha-vedas-theft] Hayagrīva-asura repeats the theft.[NOTE: hayagriva-asura-vedas-theft] The stolen thing is often unusable to the thief. Its value lies in removal. PIE repeats that method against Sanskrit: an imagined ancestor is placed above the visible calibrant, and the engineered architecture is misrepresented as one branch descended from that ancestor rather than the source itself.

**Wear false identity.** Pūtanā comes as nurse.[NOTE: putana-nurse-poison] Mārīca comes as deer.[NOTE: maricha-golden-deer] Kālanemi comes as ascetic.[NOTE: kalanemi-ascetic-hanuman] Pauṇḍraka comes as Vāsudeva.[NOTE: paundraka-vasudeva] The costume provides entry. The modern costume is polite: scholarship, translation, preservation, objectivity, public education. The categories introduced with the apparent gift allow the pyramid to take control. Max Müller privately named the goal: learn India's language and then take part in a work that would overthrow what he called “Indian priestcraft” and open the way for Christian teaching, while his public philology wore the costume of disinterested scholarship.[NOTE: muller-bunsen-1856-priestcraft-overthrow]

**Turn the gift against the giver.** Vṛkāsura receives a boon and immediately turns it against Śiva, who granted it. The popular Bhasmāsura telling repeats the same pattern.[NOTE: vrkasura-bhasmasura-boon-reversal] A civilization preserves the texts; the pyramid receives access; the pyramid returns the texts as *"mythology"*, elite production, migration evidence, philological data, or cultural artifact.

**Multiply copies.** Raktabīja turns every wound into more Raktabīja.[NOTE: raktabija-multiplication] Pokorny's 1959 dictionary gathered thousands of imaginary PIE forms into one reference work. The *American Heritage Dictionary* carried those forms into a mainstream English dictionary in 1969, then expanded them across later editions. Etymonline and other digital references repeated the same starred forms until PIE became the routine endpoint of an etymological search. Repetition made an imaginary ancestor look recorded and real.[NOTE: pre-pie-dictionary-shift][NOTE: pie-cementing-recent-decades]

**Possess the uncontainable.** Śumbha, Andhaka, and Jalandhara treat the unownable as inventory.[NOTE: shumbha-nishumbha-devi-mahatmyam][NOTE: andhakasura-shiva-purana][NOTE: jalandhara-vrinda-shiva-purana] The apex repeats the move with speech, memory, lineage, civilization, and the authority to say what they are.

**Teach surface as depth.** Virocana hears the teaching of the Self and returns with the body.[NOTE: virocana-chandogya-8-7-8-8] The surface is passed off as substance. Courtly use becomes source. Social location becomes architecture. Power vocabulary replaces engineering vocabulary. Sheldon Pollock's Sanskrit-cosmopolis thesis runs the same substitution at scholarly scale: courtly and political use is offered as the explanation for Sanskrit's power, not the engineered architecture that use depended on.[NOTE: pollock-sanskrit-cosmopolis-position-3]
...
From these Vedic encounters, the book identifies three recurring characteristics of action aligned with असत् (*asat*): containment, concealment, and control. The antagonist withholds what should circulate, hides what others should be able to recognize, and makes access depend on his power. The object may be water, light, knowledge, or memory; the relationship remains the same.

Power over others is the asuric pyramid’s motive for battle. By contrast, सनातन (*Sanātan*) Sanskrit records battles fought to protect सत् (*sat*) against असत् (*asat*). Power alone does not make an actor a protagonist or antagonist. That distinction comes from what the actor chooses to do with the power. Varuṇa props heaven, establishes the earth, and maintains an ordered space in which life, water, and light can move. Vṛtra wields comparable power to dam the same waters shut. The Veda does not condemn power, and it does not require the powerless to be innocent; it condemns power directed toward closure. Every antagonist below fails this test the way Vṛtra does — not by being weak, but by directing strength against circulation.

The book calls this recurring structure the **architecture of containment**. The eight methods above already enact it. The Vedic passages describe four of its recurring forms: concealment and projection, blockade, isolation, and enclosure. Each category below gathers actions and attributes that produce the same result.

**Concealment and projection.** आसुरी माया (*āsurī māyā*) works through two linked actions. **आवरण (*āvaraṇa*)** conceals what remains present. **विक्षेप (*vikṣepa*)** places a false appearance before the observer. The Ṛgveda calls Vṛtra **मायाविनम् वृत्रम् (*māyāvinam vṛtram*)** and Namuci **नमुचिं नाम मायिनम् (*namuciṃ nāma māyinam*)**. Vṛtra hides among the waters and blocks them (RV 2.11). The Namuci verse identifies him as *māyin* without describing the stratagem (RV 1.53.7). Svarbhānu supplies the clearest act of **आवरण (*āvaraṇa*)**: his **मायाः (*māyāḥ*)** place darkness before Sūrya and prevent the worlds from seeing what remains present (RV 5.40).[NOTE: mayin-concealment-cluster] Pūtanā appearing as a nurse, Mārīca appearing as a deer, and Kālanemi appearing as an ascetic demonstrate **विक्षेप (*vikṣepa*)**. The projected appearance conceals the actor and his purpose.[NOTE: maya-concealment-projection]

**Blockade.** The अव्रत (*avrata*) refuses the obligations that sustain ऋत (*ṛta*). The refusal prevents a required action from passing through the shared order. Indra **शासद् अव्रतान् (*śāsad avratān*)**, chastises those who follow no vow or commandment (RV 1.51.8). Another mantra describes the दस्यु (*dasyu*) as **अकर्मा... अमन्तुः अन्यव्रतः अमानुषः (*akarmā... amantuḥ anyavrataḥ amānuṣaḥ*)**: marked by non-deeds, non-thought, other commandments, and inhuman conduct (RV 10.22.8).[NOTE: avrata-vow-less-blockade] Svarbhānu and Vṛtra use **तमस् (*tamas*)**, darkness that conceals and obstructs: Svarbhānu **तमसा विध्यत् (*tamasā vidhyat*)**, pierces with darkness (RV 5.40.5); the defeated Vṛtra **दीर्घम् तमः आशयत् (*dīrgham tamaḥ āśayat*)**, lies in long darkness (RV 1.32). "Withhold the light" — Svarbhānu, Vṛtra, Kāliya — is this method exactly: the source remains, and access to it is cut.
...
Their conduct generates **गभीरम् पदम् (*gabhīram padam*)**, a deep place or state. The phrase can also mean a deep track or profound word in the hymn's speech context. This book calls the resulting separation *isolation*: departure from truth and ऋत (*ṛta*) separates its makers from the shared order.[NOTE: rv-4-5-5-gabhiram-padam-isolation]
...
The caretakers and the finite order now stand against each other. Chapter 2 examines how that category attack produced the codification myth. Sanskrit supposedly drifted as a natural language until Pāṇini imposed order upon it. Arabic and Tamil allow the chapter to test whether codification can explain Sanskrit's invariance.
