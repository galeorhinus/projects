...
Chapter 0 established the conflict between सत् (*sat*) and असत् (*asat*) at the cosmic scale. This chapter has shown how an architecture aligned with असत् (*asat*) acts: through concealment, blockade, isolation, and enclosure. Chapter 3 follows those methods into institutions, chronology, race, and language, where the pyramid can reproduce them without a named antagonist.
