...
The pyramid places Maṇḍalas 2–7 in its *earliest* layer of the *Ṛgveda*. Yet those very maṇḍalas contain **every one of the five features** documented in this chapter.[NOTE: rigveda-five-feature-cluster] To place the supposed contact after those maṇḍalas, the pyramid must claim that later speakers rewrote the Vedic corpus. Those speakers would have had to insert all five features into the mantras while preserving every recitational form and transmission pattern that Chapter 15 describes. The citations in §§17.1–17.5 show the Vedic forms that close this second route.
