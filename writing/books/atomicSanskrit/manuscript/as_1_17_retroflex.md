...
Sanskrit builds on these subcontinental traits. Its architecture takes the power of repetition, abstracts it, disciplines it, compresses it at a sonomeric level, and distributes it through the लकार (*lakāra*) system, the गण (*gaṇa*) classifications, and derived verb forms.

For example, at the consonant and syllable scale, the Veda takes the द (*d*) consonant from the atom ⟪दृश्⟫ (*dṛś*) — to see — adds the *a* svara, and places it in front, as in *da-darśa* in Ṛgveda 1.164.4: *ko dadarśa prathamaṃ jāyamānam* — “who saw the first-born as he was being born?” Another example: the atom ⟪दा⟫ (*dā*) — to give — becomes *da-dāti* in Ṛgveda 10.107.7: *dakṣiṇāśvaṃ dakṣiṇā gāṃ dadāti*. The *holding* atom ⟪भृ⟫ (*bhṛ*) becomes *bi-bharti* in Ṛgveda 7.87.4. The repeated piece changes with the atom and functions as a small grammatical switch.[NOTE: vedic-reduplication-abhyasa-examples] Pāṇini later documented and named this operation **अभ्यास (*abhyāsa*)**. The perfect, **लिट् (*liṭ*)**, can use it, as in *dadarśa*. The reduplicating class, **जुहोत्यादि गणः (*juhotyādi-gaṇaḥ*)**, can use it, as in *dadāti*. The desiderative, **सन् (*san*)**, can use it, as in *jighāṃsati*. The **चङ् लुङ् (*caṅ luṅ*)** aorist gives the same switch another home.
...
Then Sanskrit builds the discipline into the grammar itself. The receiver becomes a defined role — **सम्प्रदान (*sampradāna*)**, one of the six **कारकाः (*kārakāḥ*)** — preserved by its own case, the dative (चतुर्थी विभक्ति (*caturthī vibhakti*)), with a family of rules binding reverence, safety, trust, and grace to that receiver. What subcontinental languages manage through usage, Sanskrit manages through architecture.

Chapter 13's epigraph, RV 10.71.4 has Vāc as the agent. She reveals herself त्वस्मै (*tvasmai*), to him, like a well-adorned wife to her husband. Even knowledge is not seized by the ego; it discloses itself to the prepared receiver.
...
The tongue curls in अग्निमीळे (*agnimīḷe*). Repetition becomes grammatical in ददर्श (*dadarśa*), ददाति (*dadāti*), and बिभर्ति (*bibharti*). The self receives in मह्यम् (*mahyam*) and त्वस्मै (*tvasmai*). The doer recedes in कर्मणि (*karmaṇi*) and भावे (*bhāve*). The act folds into the next act in पीत्वा (*pītvā*) and हत्वा (*hatvā*). Five faces — in sound, in morphology, in syntax — enter one architecture.
...
Retroflexion anchors by place: अग्निमीळे (*agnimīḷe*) makes the mouth curl at the Veda's threshold, and ⟪ऋ⟫ (*ṛ*) links the मूर्धन्य (*mūrdhanya*) site to the धातुपाठ (*Dhātupāṭha*) and the name *Ṛgveda*. Reduplication concentrates meaning: ददर्श (*dadarśa*), ददाति (*dadāti*), and बिभर्ति (*bibharti*) turn a regional habit of doubling into a disciplined syllabic switch. The concept of the receiver—the one to whom an action is directed—surfaces through forms such as अस्मै (*asmai*), मह्यम् (*mahyam*), and त्वस्मै (*tvasmai*). The doer steps back through कर्मणि (*karmaṇi*) and भावे (*bhāve*). Action chaining is executed through forms such as पीत्वा (*pītvā*) and हत्वा (*hatvā*).
...
श्रुति (*Śruti*) rejects the idea that the ego can own or extract knowledge. Instead, knowledge discloses itself to those who are properly aligned. Vāc reveals her form to the prepared (*tanvaṃ vi sasre*, RV 10.71.4), and the Self reveals its form to the one it chooses; intellect alone cannot compel that disclosure (*vivṛṇute tanūṃ svām*, Kaṭha Upaniṣad 1.2.23 / Muṇḍaka 3.2.3). The human mind and intellect are treated solely as instruments. In the Kaṭha chariot metaphor (1.3.3–4), the body is the vehicle, the senses the horses, the mind the reins, and the intellect the charioteer. They serve strictly as the apparatus of action, while the Self acts as the rider.[NOTE: nimitta-chariot]

What the Veda enacts and the Upaniṣad models, the case-system encodes. The grammar marks the receiver as सम्प्रदान (*sampradāna*), while कर्मणि (*karmaṇi*) and भावे (*bhāve*) constructions systematically move the doer away from the center—a structure Pāṇini merely decoded. The Gītā states it directly: *nimittamātraṃ bhava savyasācin* (11.33) — "be a mere instrument." A grammar that refuses to center the ego in the sentence reflects a civilization that refuses to center the ego in the self. The अहंकार (*ahaṃkāra*) is constrained, and agency is distributed across the कारक (*kāraka*) system rather than gathered at an apex.
