...
The pyramid imagines populations carrying a mutating ancestor from one region to another. The Radiance Thesis follows actual teachers and communities carrying Sanskritic words, structures, and methods. This chapter examines those carriers and the routes they traveled.
...
Wave 1 proposes that Vedic-trained experts entered linguistic communities across Central and West Asia before Pāṇini. Their teaching could have placed Sanskritic words, grammatical patterns, and methods inside those natural languages. The receiving languages would then have reshaped that Sanskritic material and passed the resulting forms to later generations. Nineteenth-century European philologists found related forms across those languages. Because they assumed descent from a common natural ancestor, they projected the similarities backward and reconstructed PIE. The Radiance Thesis asks the reader to reverse that direction. The correspondences may preserve the accumulated reflections of Sanskritic contact.
...
Buddhist translation communities make this outward movement unusually easy to hear. The Sanskritic meditation word **ध्यान (*dhyāna*)** entered Chinese as **禪 (*chán*)**, and Japanese adopted the Chinese form as **禅 (*zen*)**. Chinese kept Chinese phonology, Japanese kept Japanese phonology, and each language built its own thought and practice around the form it had adopted. Say ध्यान (*dhyāna*), *chán*, and *zen* in sequence. The changing sound allows the reader to hear vivimorphosis directly.

Other words followed comparable paths. Sanskrit **क्षण (*kṣaṇa*)** appears in Chinese as **刹那 (*chànà*)**, which Japanese reads as **せつな (*setsuna*)**. **बोधिसत्त्व (*bodhisattva*)** appears in Chinese as **菩薩 (*púsà*)** and in Japanese as **ぼさつ (*bosatsu*)**. **निर्वाण (*nirvāṇa*)** appears in Chinese as **涅槃 (*nièpán*)** and in Japanese as **ねはん (*nehan*)**. Not every word traveled directly from Sanskrit into Chinese and then Japanese. Pāli, Prakrit, and Central Asian languages often carried a word through part of the journey, while translators selected forms that Chinese readers could pronounce. Each intermediary reshaped the form it carried, and those changes can still be heard in the resulting word.[NOTE: buddhist-asia-radiance]
...
Japan carries the same radiance in another form. The **五十音 (*gojūon*)** — the "fifty sounds" — arranges kana by crossing the vowels *a-i-u-e-o* with ordered consonant rows. Japanese scholarship traces this matrix to the वर्णमाला (*varṇamālā*) studied through Buddhist सिद्धं (*Siddhaṃ*) learning. Japanese scholars adapted the Sanskritic sound-grid to Japanese pronunciation. They used the architecture without replacing the sounds and structures of their own language.[NOTE: buddhist-asia-radiance]
...
The evidence differs along each route. Tibetan accounts remember a journey to India and the teaching carried home. Chinese and Japanese sources record local adaptations of Sanskritic sound analysis. Latin grammar follows Greek methods, while Hebrew grammar follows Arabic methods; those intermediaries carry part of each route.

The Greek and Arabic cases contain a different kind of evidence. Their records establish sustained contact with Indic knowledge and display the analytical similarities that followed, although no document records a particular Sanskrit teacher giving a lesson.

#### Where the Teaching Record Survives

The Chinese and Japanese sound-matrices discussed above record how Buddhist scholars adapted Sanskritic sound analysis to their own languages. Tibetan sources provide an even fuller teaching account.
...
Later Tibetan and Indian translation teams compiled the **महाव्युत्पत्ति (*Mahāvyutpatti*)** — "The Great Etymology," a Sanskrit-Tibetan lexicon containing thousands of Sanskrit terms and agreed Tibetan equivalents. Tibetan grammar already had its foundational works. The महाव्युत्पत्ति (*Mahāvyutpatti*) then helped translation teams use Tibetan equivalents consistently. The grammatical works preserve the analytical method brought from India, while the lexicon shows Tibetan scholars creating precise terminology in their own language.[NOTE: buddhist-asia-radiance]

#### Where an Intermediary Connects the Languages

**Latin** — through Greek, 4th–6th c. CE. The *Ars Maior* and the *Institutiones Grammaticae* follow the Greek grammatical model.[NOTE: donatus-priscian-grammars] Their authors applied Greek terminology, categories, and methods to Latin. Medieval and Renaissance schools then used these Latin grammars to teach Europe how to analyze language. If Greek grammar had absorbed Pāṇinian influence, the Greek and Latin records preserve the next two steps of that route.

**Hebrew** — through Arabic, 10th c. CE onward. Medieval Hebrew grammar developed under Arabic grammatical influence. Saadia Gaon, Judah ben David Hayyuj, Jonah ibn Janah, and the Andalusian Hebrew analysts who followed used Arabic methods to analyze Hebrew.[NOTE: medieval-hebrew-grammarians] Arabic therefore provides a documented intermediary between the earlier analytical method and Hebrew grammar. How the method reached Arabic remains a separate question.
...
![Figure 20.2 — Six Routes of Analytical Radiance. The records differ in strength and form: Tibetan records a teaching journey; Chinese carries an adapted sound matrix; Latin and Hebrew continue methods learned through intermediaries; Greek and Arabic record contact settings and analytical resemblance.](figures/life_after_pie/analytical_radiance_routes.svg){#fig:ch20-analytical-radiance-routes width=100%}

Figure 20.2 places the six routes beside one another. Tibetan records a teaching journey. Chinese and Japanese carry Sanskritic sound analysis adapted to their languages. Greek and Arabic retain evidence of the contact settings and the analytical structures that followed. Latin carries the Greek method forward; Hebrew does the same through Arabic.

Each stage leaves a different kind of record. One tradition remembers a teacher's journey. Another records a local adaptation, while a later language carries the method through an intermediary. The analytical structure can therefore continue even after the receiving tradition ceases to acknowledge its source.

### Radiance Across Southeast Asia

The East Asian Buddhist pathways form one part of a wider Sanskritic map. Across Southeast Asia, teachers and translators carried Sanskrit and Pāli through monasteries and centers of learning. Merchants carried words along trade routes. Courts and local scholars adopted Sanskritic names and concepts for their own purposes. The resulting words remain in daily use. Malay and Indonesian use ***bahasa***, from **भाषा (*bhāṣā*)**, as their everyday word for language. **सिंहपुर (*Siṃhapura*)**, "lion city," became Malay *Singapura* and English *Singapore*. Thai *Ayutthaya* carries **अयोध्या (*Ayodhyā*)**, while Khmer *Angkor* reaches back through *nokor* to **नगर (*nagara*)**, city.[NOTE: buddhist-asia-radiance]

Malay, Indonesian, Thai, Khmer, and Burmese each reshaped the borrowed words to fit their own sounds and grammar. People then used those words in government, learning, literature, religious thought, and daily speech.
...
These movements leave an asymmetrical record. Mitanni records selected Vedic names and technical words. East Asia retains Sanskritic words and adaptations of the sound matrix. Tibetan records a teaching journey. Greek and Arabic carry analytical structures, while Latin and Hebrew continue them through their intermediaries. Each receiving civilization deserves credit for what it built from the Sanskritic material it absorbed.

In India, the complete system remains together: the Vedas, Sanskrit's sound architecture, its grammar, its exact recitation systems, and the disciplines that connect them. The receiving cultures carry reflections; the Hindu continuum sustains the complete calibrant architecture. The routes in this chapter explain how parts traveled outward without transferring authorship of the source.
...
The Romani movement differs from the प्रतिबिम्ब (*pratibimba*) described in Chapter 19. A प्रतिबिम्ब (*pratibimba*) begins when a Sanskritic word or method enters another language and is reshaped there. The Romani carried an Indic language into new surroundings and continued speaking it while contact changed it. Their history therefore belongs within the wider history of languages and communities that left the Indian subcontinent. A civilizational account of that history must include them again.

The modern Indian diaspora carried the same inheritance under very different conditions. Indentured laborers taken to the Caribbean, Mauritius, Fiji, South Africa, and East Africa built temples, maintained ceremonies, and kept Indic words and practices alive. Later, students and professionals carried their languages and ways of life to North America and Europe. Across these migrations, families passed parts of Indian life to another generation through daily practice, even when neither Indian schools nor institutions in their new homes presented those practices as parts of a coherent civilizational architecture.

Waves 1 and 2 follow specialists carrying Sanskritic words, structures, and analytical methods. The Diasporic Wave follows whole communities carrying languages, memory, and practice. Words such as *yoga*, *mantra*, *guru*, *dharma*, *karma*, *avatar*, *namaste*, and *pundit* still reveal their Indic origin inside host languages, although they reached those languages through several routes. Diasporic communities kept many such words and practices alive, but fewer people retained all the training required to teach Sanskrit as a complete architecture. This book calls that trained ability **calibrant capacity**. It includes accurate Sanskrit pronunciation and the ability to analyze Sanskrit through व्याकरणम् (*vyākaraṇam*). It also includes the disciplines required to approach the Veda, extend लौकिक (*laukika*) usage without changing Sanskrit's architecture, and teach those abilities to another generation.

Wave 3 therefore begins with deliberate relearning among Indians in the subcontinent and across the global diaspora. Romani communities that wish to renew their connection can do the same. Learners recover Sanskrit sounds that the languages around them may no longer use, including the retroflex positions. They study Sanskrit's analytical disciplines and learn how the Vedic preservation system protects an engineered architecture.
...
5. Calibrant transmission explains why other languages carry Sanskritic resemblances. Populations may have moved along some of the same routes, but their movement did not author Sanskrit's architecture.
...
The Vedic sequence moves through three stages: eclipse, clearing, and celebration. The darkness first covers the Sun and prevents the worlds from seeing it. Indra breaks that आसुरी माया (*āsurī māyā*). Atri then uses तुरीय ब्रह्मन् (*turīya brahman*), the fourth sacred formulation, to find the Sun that had remained present behind the concealment.[NOTE: rigveda-5-40-atri-clearing][NOTE: maya-concealment-projection] The closing mantra in the sequence can then say that the Atris found what no others could. Life after PIE follows the same sequence. Readers must first identify the categories that concealed Sanskrit and remove them from the analysis. They can then examine the language through its own architecture and recognize its radiance again.

That recovery remains possible because the Vedas, Sanskrit grammar, and the lineages that teach them endured through the darkness. The architecture itself remained invariant while the pyramid altered the categories through which readers encountered it.

PIE trained readers to look for one ancestor at one point on a timeline. Sanskrit asks them to examine a pattern that repeats across several scales. The pattern begins with selected sonomers and continues through अक्षर (*akṣara*), धातुः (*dhātuḥ*), क्रियापद (*kriyāpada*), शब्द (*śabda*), and वाक्य (*vākya*). At each level, smaller constituents bond into a larger form without losing their identity. Vedic recitation and grammatical calibration carry the same architecture across generations.
