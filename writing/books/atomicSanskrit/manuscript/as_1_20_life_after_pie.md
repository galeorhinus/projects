...
The PIE account explains the spread of language primarily through migrating populations. A people carries its language into another region, and that language changes into several descendants. The Radiance Thesis examines another route. A trained teacher can carry words, knowledge, and methods into a community without replacing the language that community already speaks. A Sanskrit-trained *ārya*, skilled in *vyākaraṇam*, could teach within that community. Students could adapt what they learned to their own language and teach another generation. One teacher could therefore affect a language without bringing an entire Sanskrit-speaking population with him.
...
Later Tibetan and Indian translation teams compiled the **महाव्युत्पत्ति (*Mahāvyutpatti*)** — "The Great Etymology," a Sanskrit-Tibetan lexicon containing thousands of Sanskrit terms and agreed Tibetan equivalents. Tibetan grammar already had its foundational works. The *Mahāvyutpatti* then helped translation teams use Tibetan equivalents consistently. The grammatical works preserve the analytical method brought from India, while the lexicon shows Tibetan scholars creating precise terminology in their own language.[NOTE: buddhist-asia-radiance]

#### Where an Intermediary Connects the Languages

**Latin** — through Greek, 4th–6th c. CE. The *Ars Maior* and the *Institutiones Grammaticae* follow the Greek grammatical model.[NOTE: donatus-priscian-grammars] Their authors applied Greek terminology, categories, and methods to Latin. Medieval and Renaissance schools then used these Latin grammars to teach Europe how to analyze language. If Greek grammar had received Pāṇinian influence, the Greek and Latin records preserve the next two steps of that route.
...
Malay, Indonesian, Thai, Khmer, and Burmese each reshaped the received words to fit their own sounds and grammar. People then used those words in government, learning, literature, religious thought, and daily speech.
...
The Romani movement differs from the *pratibimba* described in Chapter 19. A *pratibimba* begins when a Sanskritic word or method enters another language and is reshaped there. The Romani carried an Indic language into new surroundings and continued speaking it while contact changed it. Their history therefore belongs within the wider history of languages and communities that left the Indian subcontinent. A civilizational account of that history must include them again.

The modern global Indian diaspora continued this movement across the past two centuries. Colonial administrators transported indentured laborers to the Caribbean, Mauritius, Fiji, South Africa, and East Africa. Plantation economies separated families from India and often tried to weaken continuity across generations. The communities nevertheless built temples, preserved ceremonies, and kept Indic words and practices alive in places far from the subcontinent. During the past half-century, students and professionals moved to North America and Europe. Teachers of classical music and yoga established new lineages there. Families built temples, opened restaurants, celebrated festivals, and taught children enough language and memory to maintain a connection with India.

More recently, large numbers of Indian engineers and technology workers entered the institutions that maintain the West's technical infrastructure. Their movement carried technical knowledge as well as living Indic languages and practices. Across these different migrations, communities brought parts of Indian life into their new homes through daily use rather than through a formal argument about civilization.

These communities faced pressure from both India and their host societies. After independence, Indian state education retained many categories inherited from British rule. Its institutions often described dharmic continuity as *communalism* and pushed *guru-shishya* lineages outside formal education. Sanskrit and the Vedas remained confined to narrow academic or ceremonial categories. Outside India, diasporic communities encountered the metropolitan form of the same progressive dogma described in Chapter 4. Their host institutions often treated Indic practices as private ethnicity, exotic custom, or material to be translated into Western categories. Despite pressure from both directions, families and communities continued carrying their languages and practices into new generations.

Waves 1 and 2 follow specialists carrying Sanskritic words, structures, and analytical methods. The Diasporic Wave follows whole communities carrying languages, memory, and practice. Words such as *yoga*, *mantra*, *guru*, *dharma*, *karma*, *avatar*, *namaste*, and *pundit* still reveal their Indic origin inside host languages, although they reached those languages through several routes. Diasporic communities preserved many such words and practices, but fewer people retained all the training required to teach Sanskrit as a complete architecture. This book calls that trained ability **calibrant capacity**. It includes accurate Sanskrit pronunciation and the ability to analyze Sanskrit through *vyākaraṇam*. It also includes the disciplines required to approach the Veda, extend *laukika* usage without changing Sanskrit's architecture, and teach those abilities to another generation.

Wave 3 therefore begins with deliberate relearning among Indians in the subcontinent and across the global diaspora. Romani communities that wish to renew their connection can do the same. Learners recover Sanskrit sounds that the languages around them may no longer preserve, including the retroflex positions. They study Sanskrit's analytical disciplines and learn how the Vedic preservation system protects an engineered architecture.

You cannot extend what you do not have.

The closing Rigvedic call is **कृण्वन्तो विश्वमार्यम् (*kṛṇvanto viśvam āryam*)**, *making the world ārya*. A person must first cultivate *āryatva* through disciplined learning and conduct before helping others do the same. The Epilogue gives the full exhortation.
...
The Vedic sequence moves through three stages: eclipse, clearing, and celebration. The darkness first covers the Sun and prevents the worlds from seeing it. Indra breaks that *āsurī māyā*. Atri then uses *turīya brahman*, the fourth formulation of disciplined speech, to find the Sun that had remained present behind the concealment.[NOTE: rigveda-5-40-atri-clearing][NOTE: maya-concealment-projection] The closing mantra in the sequence can then say that the Atris found what no others could. Life after PIE follows the same sequence. Readers must first identify the categories that concealed Sanskrit and remove them from the analysis. They can then examine the language through its own architecture and recognize its radiance again.
