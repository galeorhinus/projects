...
The motive is structural. Sanskrit threatens the pyramid because it proves that order need not descend from an apex. A distributed, calibrated, self-correcting architecture can preserve knowledge more deeply than authority can command it. If Sanskrit is seen as *saṃskṛti*, the pyramid's claim to necessity weakens. Its machinery therefore had to prevent Sanskrit from being seen whole.

That motive is civilizational envy sharpened into institutional strategy. Sanskrit displays an order the pyramid cannot generate: distributed, calibrated, self-correcting, and free of apex command. That exposes the pyramid's inferiority. The envy is personal before it is institutional: the one at the apex faces an order above his own that he did not build and cannot abide. It can rule drift. It can own codification. It cannot command calibration. So it performs category-theft: split Sanskrit before and after Pāṇini, deny the continuous architecture, and make the civilization doubt what it preserved.

The conflict is not modern, and *asuric* is not only ancient. The civilizational record remembers the same attack across time: Hiraṇyakaśipu's assault on devotion, Rāvaṇa's seizure of order for ego and empire, later foreign and colonial pyramids, and the modern machinery that still performs category-theft. The forms change. The geometry repeats. *Saṃskṛti* keeps balance. *Vikṛti* distorts it.
...
The case will also show redundancy at the human scale: the Veda preserves form as performed; Pāṇini makes the same form derivable by rule.
