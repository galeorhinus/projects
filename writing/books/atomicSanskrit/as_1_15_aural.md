...
- **§15.5** — restored "running now / running when this book is closed" civilizational hammer; restored Ch 14 §14.4 framework-vs-empirical comparative-traditions cross-reference; restored compressed pre-rational / pre-engineering orthodoxy characterization.
...
Backward — Ch 3 §3.5 (*śāstrārtha* / audience-as-witness — Auditure's structural antecedent); Ch 13 §13.5 (*Calibrated, Not Codified* — the categorical distinction this chapter operationalizes); Ch 14 §14.2 (the *Auditure* + *who guards the guards?* framework); Ch 14 §14.3 (*Chandas* as cryptographic hash; the six-layer calibration matrix); Ch 14 §14.4 (Masoretic / Quranic / Latin comparative traditions — framework matter); Ch 14 §14.5 (engineering precedes Pāṇini).
