...
- Keep the author's core claim.
- Keep Sanskrit terminology when it carries the argument.
...
- "In some sense..."
- excessive "framework," "discourse," "problematize," "intervention"
...
- Use the same direct voice.
- Reduce technical density.
- Use one Sanskrit concept at a time.
- Give the reader a familiar entry point before the Sanskrit term.
...
- Keep the architectural vocabulary.
...
> Direct, declarative, college-level prose with the book's technical vocabulary preserved but explained in sequence.
