...
*Renumbered Session 9 (Tuesday, May 12, 2026) from Ch8 → Ch17, following the split of the original Ch7 into Ch7 (*The World's First Instrument*) and Ch8 (*Mapping the Mouth*). All internal section references (§17.x) and figure references (FIGURE 17.x) updated. Metadata references to "Chapter 8" below refer to the new Ch8 (*Mapping the Mouth*), where the engineering-grid material now resides.*

*Draft v2 of complete chapter. Five sections, ~2,700 words. Source material: `archive/notes/as_1_08_mapping_mouth_notes.md` (working thesis, four-trail structure) + `retroflexParag.md` (author's voice / structural rough draft) + Session 7 author direction. Sectional spine reordered from v1: §17.1 opens with the muscular flex / wordplay argument (was buried in v1 §17.2); §17.2 lands the Hollywood-caricature confirmation with four named anchor cases; §17.3 carries the codification-perimeter case for ळ (preserved from v1 §17.3 with light tightening); §17.4 lands the AIT inversion with Müller named and the Ramdas-Savarkar Ratnagiri payoff at the chapter's emotional close; §17.5 lands the pedagogical account and the Epilogue forward-pointer. Engineering-grid material from v1 §17.2 (17 cm vocal tract, five-point sampling, adjacent-exclusion, range-boundary-exclusion) **relocated to Chapter 8** (varṇamālā chapter — that material is fundamentally about the whole grid, not the retroflex row specifically).*
...
## 17.3 What Pāṇini's Bounding Left Outside
...
Post-Pāṇinian Classical Sanskrit does not have ळ. Western philology treats the absence as evidence that Vedic Sanskrit was an earlier stage from which Classical Sanskrit descended through phonological decay. This account is an interpretive overlay on what the source texts themselves do not say.
...
**Word count:** ~2,710 words for the complete chapter prose. §17.4 is the heaviest at ~960 words (carrying the chapter's structural payoff — Müller named, the Buddha-Assalāyana inversion, the Savarkar Ratnagiri anecdote, the two-counts close); §17.1 and §17.3 are roughly equal at ~525 words each; §17.2 at ~390 words; §17.5 at ~310 words. Chapter is ~750 words leaner than v1 (~3,460 → ~2,710), reflecting the relocation of the engineering-grid material to Chapter 8 and the voice-driven compression throughout.

**Structural changes from v1.**

- **Opening reshaped.** v1 opened at §17.1 with the Savarkar Ratnagiri anecdote as scene-setter. v2 opens at §17.1 with the muscular-flex / wordplay argument carried in from the rough draft. The Savarkar anecdote moves to §17.4 as the chapter's emotional payoff, where the *m̄lencchānvarī* audience-completion lands after the engineering case has been built.
- **Engineering grid relocated to Chapter 8.** The bounded-selective-sampling argument (17 cm vocal tract; five-point sampling at 0/3/7/9/12 cm; adjacent-exclusion of the interdental and alveolar/post-alveolar region; range-boundary-exclusion of the deep-pharyngeal) was carried in v1 §17.2 and is the load-bearing engineering-thesis argument for the whole *varṇamālā*, not the retroflex row specifically. The argument is structurally Chapter 8's (the *varṇamālā* chapter). Removing it from Ch17 frees the chapter to run on the muscular-flex framing the rough draft carries, and gives Ch8 the material it needs to be the engineered-grid chapter at full strength when it gets drafted.
- **Müller named.** v1 abstracted Müller as *Western philology* and *nineteenth-century philology*. v2 names him directly, develops his German-Lutheran-Protestant-philological context, the EIC-financed *Rigveda* edition, the *Sacred Books of the East* hermeneutic, and his never-having-visited-India biographical fact. Two cluster-term deployments in §17.4: *fourth Abrahamic religion* and *missionaries of progress*. Müller positioned as the transitional figure between Christian-Abrahamic register and the secularized *progressive orthodoxy* the rest of the book develops.
...
- **§17.5 reframed.** Section title changed from *The Pedagogical Reading* to *The True Test of Āryatva* per author direction — keeps with the recurring theme of what *ārya* really means. The pedagogical account is the section's content; the section title commits the reader to the chapter's structural thesis.
...
- `agnimile-rigveda-opening` (§17.3) — *Ṛgveda* 1.1.1 standard reference
- `chandasi-bhasayam-astadhyayi` (§17.3) — Pāṇini's synchronic mode-distinction; *Aṣṭādhyāyī* edition + rule reference for the ḷ treatment
- `muller-eic-rigveda` (§17.4) — Max Müller's East India Company-financed critical edition of the *Ṛgveda* (1849-1874); *Sacred Books of the East* series (Oxford, fifty volumes, 1879-1910); Müller's never-having-visited-India biographical fact; Lutheran-Protestant philological background
- `assalayana-sutta` (§17.4) — *Majjhima Nikāya* 93; the Yona / Kamboja *ārya / dāsa* binary as foreign-bordering-nations feature
- `savarkar-ratnagiri-mleccha` (§17.4) — Savarkar's Ratnagiri-internment-period writings deploying *mleccha*-vocabulary; rhetorical-loophole anecdote requires primary-source verification (contemporary accounts 1924–1937; *Ratnagiri Parv* compiled by Balarao Savarkar; contemporary Marathi-language periodicals)
- `samarth-ramdas-mleccha-verse` (§17.4) — Samarth Ramdas's *mleccha*-deployment *ovi* to Sambhaji Maharaj; source-text location to be verified (*Dasbodh* chapter/owi, *Karunāṣṭake*, attributed letter, or compilation source)

Six stubs total. `muller-eic-rigveda` is new in v2. `assalayana-sutta` is P0 (primary land in Epilogue 8.9; supporting deployment here in §17.4). Others are P1 citation work.

**Voice notes.**

- Chronology rule operates throughout. No specific dates for Indic figures or texts (Pāṇini, Samarth Ramdas, the *Vedas*, the *Aṣṭādhyāyī*, the *Saptaṛṣi* paramparā all dated through "across many generations" or internal-frame ordering). External-event dating used where the date is the argument: Savarkar's Ratnagiri internment dated 1924–1937 in §17.4; Müller's EIC-financed *Rigveda* edition dated as "over a quarter of a century at Oxford" (external, non-Indic anchor).
- Scare quotes around *"invading ārya"* / *"Aryan invasion"* (AIT terminology, §§17.1, 8.4), *"Indo-Aryan"* (orthodoxy classification, §17.3), *"Dravidian"* and *"Munda"* (taxonomy attribution, §17.3) per Style Guide §7.1. *"Classical Sanskrit without ळ"* (§17.3) scare-quoted as the establishment self-claim contested by the codification-perimeter argument.
- Establishment-naming concrete throughout per Style Guide §7.6. *Western philology* (§17.3); *Western philology's AIT-aligned account* (§17.3); *the AIT framework* (§§17.1, 8.4); *Max Müller / Müller* (§17.4, named individual); *Sacred Books of the East* (§17.4, named apparatus); *Christian-Protestant comparative-philological hermeneutic* (§17.4, named framework). No weasel-phrasing.
...
- Two cluster-term deployments in §17.4: *fourth Abrahamic religion* (Müller's framework as precursor to the secularization Chapter 3 names); *missionaries of progress* (the secularized successor extending the work). Both deployments are at locations where the cluster's structural level is the actual referent, not casual substitutions for *the establishment*. Per Style Guide convention: 1–2 deployments per chapter; 8–12 across the book.
- Devanagari deployment: ट (*ṭa*), ड (*ḍa*), ण (*ṇa*) at §§17.1 / 8.2 / 8.4 as the load-bearing retroflex consonants; ळ at §17.3 as the load-bearing case study; *agnimīḷe* अग्निमीळे at §17.3 (Rigveda opening); the Ramdas *ovi* in full Devanagari with the audience-supplied म्लेंच्छांवरी at §17.4; *guru-shishya paramparā* गुरु-शिष्य परम्परा at §17.5; *kṛṇvanto viśvam āryam* कृण्वन्तो विश्वमार्यम् at §17.5. Lighter Devanagari density than v1, with each deployment doing load-bearing work.

**Open at revision.**

- §17.5 chapter-close hammer — current: *The flex is the test. The training is open. The work begins at the mouth.* Three-sentence rhythm; echoes the chapter's controlling wordplay; commits to the pedagogical account. Alternative candidates from `archive/notes/as_1_08_mapping_mouth_notes.md` §5.5 retained for author preference.
...
- §17.2 Hollywood caricature — four named anchor cases plus the catalog-continues gesture. If author wants additional names, candidates from broader catalog: Sacha Baron Cohen's various Asian-accent caricatures; Ashton Kutcher's PopChips commercial; numerous SNL / sketch-comedy moments. Current four feels structurally tight; adding more risks turning the section into a survey.

**Material relocated.**

- **Engineering-grid analysis from v1 §17.2 → Chapter 8 (varṇamālā chapter).** The five-point sampling grid (~0 cm labial / ~3 cm dental / ~7 cm retroflex / ~9 cm palatal / ~12 cm velar on a 17 cm adult-male vocal-tract reference; adjacent-exclusion of the interdental and alveolar / post-alveolar region; range-boundary-exclusion of the deep-pharyngeal; hammer *"This is what design looks like"*) is fundamentally the *varṇamālā* chapter's argument, not Ch17's. The retroflex sitting at the structural midpoint of the grid is one consequence of the engineered geometry the *varṇamālā* embodies; the full grid argument is one chapter back. v1's `mūrdhanya-articulation-geometry` endnote stub moves to Ch8 with the material. Ch17 references the grid implicitly (the retroflex at the midpoint of the vocal tract; the engineered sound-system) without re-developing it.
- ***Mahāprāṇa* additions paragraph from v1 §17.2 (ṭa → ṭha, ḍa → ḍha; the Sanskrit-specific engineering elaboration on top of the shared subcontinent-wide retroflex base).** Also belongs to Ch8's argument architecture — Sanskrit's *varṇamālā* elaborates on the shared subcontinental hardware through the *alpaprāṇa* / *mahāprāṇa* dimension, and the elaboration is part of Ch8's full-grid analysis. Removed from Ch17; assumed to be developed in Ch8 when that chapter is drafted.
- **Two-modes-framework introductory paragraph from v1 §17.2.** Now scaffolded across §§17.1 (one-sentence mention) and §17.3 (full development in the codification-perimeter case). The synchronic-parallel framing of *chandasi* and *bhāṣāyām* lands at the location where the framework does load-bearing work (the codification-perimeter argument for ळ).
