...
Structural significance: the alveolar set is observable in the subcontinental sound-field, and Tamil preserves it as an independent recurring sound feature. The *varṇamālā* gives the dental and retroflex stations independent rows without adding a third alveolar row between them. The comparison demonstrates different inventory assignments within the same mouth-field; the surviving evidence does not document why Sanskrit selected that margin.
