...
**Deployments:** Chapter 18 §18.9 — the evidence anchor for the Vedic use, Pāṇinian rule, Latin paradigm, and Greek comparison; Appendix Part 1 §1.5 — the compressed **⟪अस्⟫ / ⟪भू⟫** case.
...
The pyramid's reconstruction places *\*h₁es-* above the first family and *\*bʰuH-* above the second. Chapter 18 reverses that direction. Sanskrit preserves the sound-bearing atoms, the Vedic use, and the grammatical relation; Greek and Latin preserve their vivimorphed reflections.
...
**Short:** The traditional fivefold method of *nirukta* and *vyutpatti* permits four stated sound operations — addition, transposition, modification, and loss — together with a semantic extension grounded in the *dhātu*. Chapter 18 applies that method to the recorded **⟪अस्⟫ (*as / es*)** and **⟪भू⟫ (*bhū / phu / fu*)** families.

**Deployments:** Chapter 18 §18.9 — the method and worked **⟪अस्⟫ / ⟪भू⟫** comparison; Epilogue, "Where the Nectar Rises" — the proposed research protocol for applying the method across Greek, Latin, Persian, and other receiving languages.
...
Chapter 18 applies the method to two compact families. In the first, Sanskrit **अस्ति (*asti*)**, Greek **ἐστί (*esti*)**, and Latin ***est*** preserve the consonants ***s / st*** while the Sanskrit ***a*** appears as ***e*** in the receiving languages; Latin also loses the final ***i*** of the finite form or supplies its own ending in ***esse***. In the second, Sanskrit **⟪भू⟫ (*bhū*)**, Greek ***phu-***, and Latin ***fu-*** preserve the same semantic field of becoming. The voiced aspirated Sanskrit ***bh*** changes to Greek ***ph*** or Latin ***f***, the vowel shortens, and the receiving language supplies its own morphology. These are visible *varṇavikāra*, *varṇanāśa*, and *varṇāgama* operations.
...
Sources: *Kāśikāvṛtti* on *Aṣṭādhyāyī* 6.3.109, [पृषोदरादीनि यथोपदिष्टम्](https://ashtadhyayi.github.io/suutra/6.3/6.3.109/?transliteration_target=iast); the Sanskrit, Greek, and Latin sources listed under endnote `as-bhu-being-paradigm`.
