...
The chapter's deployment: Mishra's contemporary articulation provides a living lineage-chain anchor for the structural account the chapter develops. The breath-pedagogy framing recovers the phonological-engineering claim from inside the lineage-chain's own contemporary practice, not from an external philological reconstruction.
...
**Short:** The ***śruti*** (श्रुति, *that which is heard*) category preserves the four *Vedas* (*Ṛgveda*, *Yajurveda*, *Sāmaveda*, *Atharvaveda*) plus *Brāhmaṇa*, *Āraṇyaka*, and *Upaniṣad* literature through *exact phoneme-level* preservation — the Indic engineering at its most rigorous; layered infrastructure combines the *Prātiśākhya* / *Śikṣā* literature, Pāṇini's *Aṣṭādhyāyī*, the eleven *pāṭhas*, and the *guru-shishya* lineage-chain. The Indic counterpart of the book-coined ***Auditure***.
...
The framework is internal to the book's own polemic and does not have an external scholarly source. Its closest precedents are Sanskrit's own categorical distinctions: *śruti* (the corpus form, *that which is heard*) and *smṛti* (the remembered form), with the contemporary recovery as a third form the lineage-chain has not previously had occasion to name.
