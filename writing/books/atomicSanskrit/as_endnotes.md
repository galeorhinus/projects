...
**Deployments:** Chapter 11 §11.8 ¶ — methodology disclosure for the *prayoga* audit's operational definition; Chapter 11 §11.8 ¶ — anchors the 67.6% tier-share number.
...
**Short:** Ch 11 §11.8 percentages compute against the **3,839 distinct *dhātuḥ* labels visible in the Digital Corpus of Sanskrit**, not the **2,168 canonical entries in the Dhātupāṭha**. The DCS surplus comes from variant readings, recension-specific entries, and items not registered in the canonical *Dhātupāṭha*.
