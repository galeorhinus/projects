...
**Deployments:** Preface ¶15 — the survey-of-prior-work paragraph; the second of three named precedents (Briggs, Kak, Staal) for adjacent engineering / formal-systems readings of the Sanskrit continuum.
...
**Deployments:** Preface ¶15 — the survey-of-prior-work paragraph; the third named precedent for engineering / formal-systems readings of the Sanskrit continuum.
...
The chapter's deployment: Mishra's contemporary articulation provides a living-paramparā anchor for the structural reading the chapter develops. The breath-pedagogy framing recovers the phonological-engineering claim from inside the paramparā's own contemporary practice, not from an external philological reconstruction.
