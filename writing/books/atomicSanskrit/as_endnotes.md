...
In modern linguistic terms, the stated environment makes **ळ** a condition-generated form of **ड** within this Ṛgvedic account. The distinction is architectural rather than anatomical: the mouth produces **ळ**, the Vedic transmission preserves it, and the phonetic discipline specifies when it appears. Other Indic languages can give **ळ** independent contrast and a complete recurring series; that separate use does not turn the Ṛgvedic form into an additional reusable Sanskrit coordinate.
