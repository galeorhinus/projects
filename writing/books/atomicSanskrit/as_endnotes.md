...
The four measurements in the figure answer four different questions. **Inventory share** measures how much of the *Dhātupāṭha* construction each scaffold holds. **Text-visible *dhātu* share** measures how many DCS-visible *dhātavaḥ* sit on that scaffold. **Combination share** measures derivational and reactive spread using the DCS-derived (*upasarga*, *pratyaya*) combination count. **Occurrence share** measures actual textual weight. The result is stronger than inventory compression alone: the top ten scaffolds do not merely dominate the list; they also dominate actual use.
...
The opening of Patañjali's *Mahābhāṣya* — the *Paspaśāhnika*, the introductory *āhnika* — raises the question ***किं प्रयोजनं व्याकरणस्य (*kim prayojanam vyākaraṇasya*)*** — *"what is the purpose of grammar?"* — and answers with five received purposes, the ***पञ्च प्रयोजनानि (*pañca prayojanāni*)***:
...
**Short:** **Petrified Languages** is the figure's classification for languages or formal forms whose organic origin is combined with low adaptive generativity because external authority restricts correction and extension. The initial comparative cases are Quranic Arabic, Biblical Hebrew under the Masoretic apparatus, and ecclesiastical Latin. The classification applies to the guarded language or form rather than automatically extending to every language spoken by the surrounding communities.
...
**Deployments:** Preface ¶ (the *closing-positioning* paragraph anchored on *Nāsadīya Sūkta* humility-as-received-text); Chapter 17 §17.7 (the honest answer to the origin-mechanism demand).
