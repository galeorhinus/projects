...
**Short:** The Wiktionary entry on Sanskrit ***पश्यति*** (*paśyati*, "he sees") holds the machinery's account that the paradigm is suppletive — *paśyati* derives from PIE *\*speḱ-*, the remainder of the paradigm from PIE *\*derḱ-*; Chapter 18 §18.9 uses the entry as a compact example of the pyramid's account splitting one Sanskrit *dhātu*-family across multiple reconstructed PIE ancestor-forms.
