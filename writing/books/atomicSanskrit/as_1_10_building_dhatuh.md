...
- §10.8 — restored the ***progressive orthodoxy*** orthogonal-third-frame setup: the progressive orthodoxy frames Sanskrit either as raw-natural-poetic (Romantic-linguistic) or as raw-grammatical-formal (Pāṇinian-formal); the engineering-enables-poetry position is the third frame.
