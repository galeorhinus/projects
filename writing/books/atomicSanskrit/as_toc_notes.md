...
- **Photography is engineered light-capture. The *varṇamālā* is engineered sound-capture — *Audiography*.** The book coins ***Audiography*** (Latin *audi-* + Greek *-graphia*, parallel to *photography*) to name the engineered visual rendering of articulated sound that the *varṇamālā* specifies and that Brāhmī, Devanāgarī, and the other Indic scripts implement. Photography (1839) is celebrated as the West's engineering of the capture of visible reality; audiography — the same operation on audible reality, many thousands of years earlier, at higher resolution along more channels than any subsequent script has matched — is the parallel term the orthodoxy did not coin. Pairs with *Auditure* as the book's two sound-anchored engineering coinages: *Auditure* preserves sound through recitation; *audiography* renders sound as image. The orthodoxy's six-way script typology refuses the seventh category (audiography) to which one script family in the world belongs. Chapter 14 §14.3 and Appendix Part 3.
