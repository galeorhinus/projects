...
This chapter examines why the botanical metaphor has been institutionally defended for over 150 years and why it continues to be defended today. The metaphor is not a casual academic convenience. It is a structural firewall protecting three pillars of Western thought: two historical (the Aryan Invasion Theory and the Biblical chronology of human history) and one contemporary and far more potent (the secular dogma of progress, the linear evolutionary teleology that mandates a perpetual ascent from the primitive to the advanced). The third pillar does not require religious belief; it only requires faith in linear time. It is held universally across the modern academy and is the reason the engineering thesis remains controversial today. The chapter introduces the operative terminology for this contemporary class — the *illiberal*, etymologically the inverse of "generous" — and withholds the Sanskrit primary-source name for the Epilogue.
...
* **§6 — What the Project Cannot Show.** Predictions stated explicitly — what the engineering thesis predicts the project will and will not find. Specification-layer invariance documented across thousands of years of continuous transmission. The architectural fact the project cannot reach: its corpus works entirely at the attested-usage layer; the specification layer is not in scope.
* **§7 — The Confirmation.** Forward-looking invitation. The choice Deccan College made in 1948 can be unmade today. The data is welcome; only the framework has to change. The same corpus, reframed, supplies direct empirical evidence for the engineering thesis. Three reframe paragraphs (apabhraṃśa geography, generative output, semantic extension) and three chronology-reframe paragraphs (reject BCE/CE imposition; replace with relative chronology from internal cross-references; accept orphans). Table A.2 *The Reframe* compresses the comparison. What the reframe offers Sanskrit (recovery of engineered architecture in a register the modern academy can read) and the world (comparative apparatus for engineered-preservation traditions). Closing on the *Deccan College made a choice in 1948. It can make a different choice today. The data is already there. Only the framework has to change* hammer.
