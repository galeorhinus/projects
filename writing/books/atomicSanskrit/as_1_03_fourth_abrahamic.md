...
- §3.4 — restored the **outward-absorption mechanism** paragraph (priesthood absorbs tradition-internal scholars from civilizations its doctrine has already turned into objects of study; colonial honors system as elevation-rite); forward-pointer to Appendix Part 1. Forward-referenced from CLAUDE.md's heroic-erasure block.
