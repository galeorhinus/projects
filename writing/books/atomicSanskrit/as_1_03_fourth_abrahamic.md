...
Appendix Part 0 gives the older diagnostic vocabulary underneath these operations: the *paṇi* hoards, the *vṛtra* blocks circulation, and the *rākṣasa* carries predation or disguise into the field.
...
![Figure 3.1b — Same Pyramid, Four Versions: V4. Progressivism keeps the same pyramidal structure and secularizes the vocabulary into progressivism, priests of progress, church of progress, missionaries of progress, jihadis of progress, and believers / pliables / deniers.](figures/fourth_abrahamic/same_pyramid_progressivism.svg){#fig:ch3-same-pyramid-v4 width=86%}
...
Chapter 2 introduced the linear-progress pillar. This chapter develops the doctrinal formation holding it. Appendix Part 3 prosecutes the foundational dogma at the script level. The main chapters prosecute the progressive dogma at the language level. Both are surfaces of the same asuric pyramid.
...
Chapter 17 names the trap behind that pedagogy: population movement is made to do the work of civilizational authorship.
...
![Figure 3.2 — Pyramid and Swastika: Two Architectures of Authority. The pyramid authorizes from above; the swastika architecture transmits, tests, and corrects through society itself.](figures/fourth_abrahamic/pyramid_and_swastika.svg){#fig:ch3-pyramid-swastika width=92%}
...
- §3.1 — restored the **Ambedkar block-quote** from *Pakistan, or the Partition of India* (1940/1945) in place of Codex's one-line summary. Verbatim primary source preserved as central Indic-internal authority.
...
- §3.4 — restored the **outward-absorption mechanism** paragraph (priesthood absorbs civilization-internal scholars from civilizations its doctrine has already turned into objects of study; colonial honors system as elevation-rite); forward-pointer to Appendix Part 1. Forward-referenced from CLAUDE.md's heroic-erasure block.
...
- §3.6 — restored the **Schleicher-as-asuric-operator paragraph**: by the 1860s Schleicher had the recipe and refused to use it; manufactured the botanical-tree metaphor instead; Appendix Part 5 §5.8 develops the case.
