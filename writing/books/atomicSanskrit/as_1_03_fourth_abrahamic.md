...
| Islam | caliphal-political authority; juristic schools; fatwa apparatus | *ulema* → imams → muftis → ordinary Muslims |
...
Aṣṭāvakra defeats the gate before he defeats Bandin. He exposes the error: a council that judges by age, appearance, and external standing before hearing the argument is not a council of the learned. It is a council of fools. The tradition's verdict is clear. The hero is Aṣṭāvakra. The villain is Bandin.[NOTE: ashtavakra-bandin-mahabharata]
...
- §3.1 — restored the **Ambedkar block-quote** from *Pakistan, or the Partition of India* (1940/1945) in place of Codex's one-line summary. Verbatim primary source preserved as load-bearing Indic-internal authority.
- §3.3 — restored the **PIE-cementing-in-recent-decades** paragraph as the §3.3 close. Names the church's institutional hardening of PIE in the catechetical layer during exactly the window of India's dharmic-civilizational re-emergence; forward-pointer to Ch 18.
- §3.4 — restored the **outward-absorption mechanism** paragraph (priesthood absorbs tradition-internal scholars from the civilizations the orthodoxy reads; colonial honors system as elevation-rite); forward-pointer to Appendix Part 1. Forward-referenced from CLAUDE.md's heroic-erasure block.
- §3.4 — restored the **Jamison–Brereton vindication** clause to the Wilson/Griffith translation paragraph: the 2014 Oxford academic translation restores *"making it all Ārya"* and *"smashing away the non-givers,"* vindicating the suppressed account.
- §3.6 — restored the **asuric-defeat-archive paragraph** (Hiraṇyakaśipu / Mahiṣāsura / Rāvaṇa / Vṛtra). Each story is a recipe; *Sanātan* carries the recipes for defeating asuric formations.
- §3.6 — restored the **Schleicher-as-asuric-operator paragraph**: by the 1860s Schleicher had the recipe and refused to use it; manufactured the botanical-tree metaphor instead; Appendix Part 4 §4.8 develops the case.

**Codex compressions retained:**

- Six-section structure (Codex merged previous §3.6 *Tamas and the Pyramid* + §3.7 *The Contest of Architectures* into one §3.6 *The Asuric Pyramid*).
- H3 subsections flattened throughout §3.2 and §3.6.
- §3.2 *Closing the Loop* sub-section compressed into the chapter-spine pointer at the end of §3.2.
- §3.5 *Bandin's Gate* tightened (escalator-of-authorized-challenge / journal-reputability circularity / "Bandin's foolishness was visible" rhetorical contrast all dropped).
- §3.6 historical-extensions (Islamic conquests / Delhi Sultanate / Mughal interregnum / Christian colonial / post-colonial communalism) dropped since Ch 2 §2.2 develops the Abrahamic-substrate argument in full.
- §3.6 Wave-3 / Ch 19 forward-pointer compressed (the Epilogue handles activation).
