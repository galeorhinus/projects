...
The machinery made Pāṇini heroic under a false label — the *codifier* who froze a drifting language into order. Life after PIE restores the right one: Pāṇini is heroic as *decoder*, compressor, and transmitter. He took an operating architecture already carried by the *Vedas*, the *Prātiśākhya* discipline, recitation lineages, and pre-Pāṇinian *vaiyākaraṇāḥ*, and made it explicit enough to travel. Sanskrit does not begin with him. Sanskrit's method becomes more portable through him.
