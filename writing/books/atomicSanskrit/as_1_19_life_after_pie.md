...
AISWEEP-END -->
This is the **Diasporic Wave**: demographic, communal, embodied. It is a separate category from the three calibrant waves. It carries language, music, food, ritual, kinship, memory, and civilizational habit into host societies that did not invite the carriers and often persecuted them.
...
<!-- AISWEEP-OLD
The diaspora's persistence is structurally significant because the headwinds operate from both sides. Inside the subcontinent, the post-colonial secular machinery
AISWEEP-END -->
