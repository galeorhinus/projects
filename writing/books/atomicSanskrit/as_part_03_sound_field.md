...
We have moved past two distortions: the plant-metaphor that forced *dhātuḥ* into a botanical category, and the codification myth that made Sanskrit depend on later stabilization. The next obstruction is alphabetic reduction: the pyramid flattening *varṇa* into letter. Descended stays cracked — the deepest descent-block falls only when Rāhu is dispelled in Part VI.
