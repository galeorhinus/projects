...
>
> Purpose: (a) capture the planned series structure as currently conceived; (b) park material diverted out of *Atomic Sanskrit* for forthcoming volumes; (c) hold the article-asymmetry between what is alive (Sanskrit — definite article, *the* linguistic architecture) and what is excavated (forthcoming volumes — indefinite article, *a* political architecture, *an* economic architecture).
