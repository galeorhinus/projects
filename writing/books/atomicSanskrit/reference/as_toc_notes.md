...
This chapter examines why the botanical metaphor has been institutionally defended for over 150 years and why it continues to be defended today. The metaphor is not a casual academic convenience. It is a structural firewall protecting three pillars of Western thought: two historical (the racial Arya thesis and the Biblical chronology of human history) and one contemporary and far more potent (the secular dogma of progress, the linear evolutionary teleology that mandates a perpetual ascent from the primitive to the advanced). The third pillar does not require religious belief; it only requires faith in linear time. It is held universally across the modern academy and is the reason the engineered Sanskrit thesis remains controversial today. The chapter introduces the operative terminology for this contemporary class — the *illiberal*, etymologically the inverse of "generous" — and withholds the Sanskrit primary-source name for the Epilogue.
...
* **The doctrinal level.** **Progressive dogma** — the cross-partisan, post-Enlightenment doctrinal formation that holds the linear-progress teleology as the controlling premise against which all argument is staged. Its individual practitioners are heterogeneous in political alignment, religious commitment, and disciplinary affiliation; what they share is the assumption that humanity moves upward across time.
...
* **§2.6 — The English Contrast.** Same OED method applied to English produces structural decay (*hlāfweard* → *Lord*, four-case collapse, three-gender loss, half-Latinate vocabulary overlay) vs. applied to Sanskrit produces specification stability (*yantra* / *dharma* / *brahman* invariant; eight cases held; three genders held; *Dhātupāṭha* held). Same method, different architectural pictures from architecturally different systems.
...
* **New Chapter 14 — Living Evidence.** The śikṣā discipline and the eleven *pāṭhas* now have a dedicated chapter, presented as the empirical proof that the engineered architecture has actually held continuously throughout the Sanskrit continuum.
