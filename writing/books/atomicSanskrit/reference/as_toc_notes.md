...
*The prosecutorial close on PIE. Two sections: §18.1 *PIE in the Sky* (the prosecutorial case — bookkeeping defense rejected, logic of non-existent etymon, catalog of failures, third-pillar diagnosis, recent-decades cementing); §18.2 *PIE must Die* (the *Pratibimba* killing move — Sanskrit as calibrant, contacted languages as calibrated, what philology assembled into a starred ancestor is the average of the reflections). Chapter title delivers the verdict; closing hammer re-delivers it: *"PIE is in the sky. The architecture is on the ground. PIE must die."* Provocations #3.*
