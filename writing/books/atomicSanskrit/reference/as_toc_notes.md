...
1. **Sanskrit is the only created language in the world. All others are evolved — what linguists call "natural" languages.** The civilization that produced Sanskrit named it ***saṃskṛtam*** (literally *consciously assembled* or *wholly created*) and distinguished it explicitly from natural languages, which the same tradition called ***prākṛtāni*** (literally *the natural*). The engineered-versus-natural distinction is the Sanskrit tradition's own self-description, in its own terms, carried continuously across many thousands of years. **Chapter 1.**
...
12. **This book coins five English terms for engineering categories the academic establishment has not named.** Each has a Sanskrit counterpart the Indic tradition has been using for many thousands of years.
    ...
    - ***Flexture*** (Latin *flexus*, "bending" + *-tūra*) — content preserved through choreographed gesture and posture; the classical Indian dance traditions (*Bharatanāṭyam*, *Kathakaḷi*, *Odissī*, *Kuchipudi*, *Manipuri*, *Mohinīāṭṭam*, *Kathak*) operating as engineered carriers. Sanskrit terms: ***mudrā*** / ***hasta*** as the gesture vocabulary, ***nāṭyaśāstra*** as the codified specification. Chapter 15.
...
* Connect this to the book's thesis:
  ...
  * The grammatical tradition is built to preserve this permanence, not to chronicle change.
...
* Define धातुः (dhātuḥ) in its full semantic range:
  ...
  * a metal or elemental substance in metallurgical and alchemical traditions.
...
* Open with the Maharashtrian *mleccha*-against-occupier tradition:
  * Samarth Ramdas Swami समर्थ रामदास स्वामी — strategic-advice verse to Chhatrapati Sambhaji Maharaj naming the Mughal occupiers as *mleccha* — supplies the seventeenth-century textual-tradition source.
...
* Establish the retroflex set as the operational marker of *āryatva*:
  ...
  * Mastery of this articulation is the audible test the tradition would have applied.
  * On this test, AIT's invading *ārya* fails — and would have been classified *mleccha* by the tradition itself.
...
The architectural model presented in Part IV is theoretical. This Part demonstrates that the architecture has actually held — that the engineered system was not merely designed but successfully implemented. Two chapters: the engineered preservation system itself, and the living evidence of its continuous operation across the full span of the tradition.
...
* Demonstrate the empirical result: the preservation of svara and mātrā across the full span of the tradition, verified across geographically distant lineages with no observable divergence.
