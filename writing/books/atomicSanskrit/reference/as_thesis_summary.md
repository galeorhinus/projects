...
39. **The word *asura* cannot decide the side.** Sanskrit has two distinct formations with the sound-form ***asura***: ***asu-ra***, connected with **असु (*asu*)**, breath, and ***a-sura***, the book's diagnostic name for an actor who turns power against radiance. The Ṛgveda uses the sound-form in praised and hostile contexts, but the surrounding words do not tell us how every occurrence should be divided. The listener must examine what the actor does. The pyramid diverts attention from that exercise of **विवेक (*viveka*)** by replacing conduct with factional identity. The book uses ***asuratva*** for recurring acts of concealment, obstruction, and control. **Chapter 3 §§3.6–3.7; Chapter 4 §4.6; Chapter 19 §19.8.**
