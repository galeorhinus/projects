...
### Texture — breathe, and ration the hammers (don't eliminate them)

Uniform tightness is itself an AI tell, and it is the counterweight the compression discipline (SKILL.md §4A) needs. Human prose varies pace: most sentences stay clean and direct, but **some run long, subordinate a clause, and meander a little before they resolve.** In each section, let one or two sentences stretch out and get complex on purpose; do not file every sentence to the same short, clean length.
