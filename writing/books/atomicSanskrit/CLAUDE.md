...
Front matter: `as_0_01_preface.md` (and future `as_0_02_acknowledgments.md`). Body chapters: `as_1_00_seekers.md` (Ch 0) through `as_1_20_life_after_pie.md` (Ch 20). Epilogue: `as_2_01_epilogue.md`. Appendix parts: `as_3_01_baking.md` through `as_3_06_vedic_carrier.md`.
...
- ***cartel*** — the heaviest hammer (coordinated commercial collusion). **Ration deliberately** — reserve for one or two heavy hits per prosecutorial chapter (Ch3 §3.5, Ch18 §18.4, Appendix §3). Overuse cheapens it.
...
- Per-chapter pattern lands naturally: 0 in chapters that don't engage the establishment generically; 1–2 in chapters that do; 3+ in heavily prosecutorial chapters (Ch2, Ch3, Ch18, the Appendix). Total across the book likely 20–35.
