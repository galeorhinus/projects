...
- ***asuric pyramid*** — the ontological diagnosis. Deploy when the prose moves from doctrine and institution to the underlying formation: ego, control, hierarchy, extraction, and the desire to lord over others. Ch 3 §3.6 establishes; Ch 18 close names as the perpetrator; the Part I opener names as the accused.
