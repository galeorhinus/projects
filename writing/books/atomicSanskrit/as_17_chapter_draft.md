...
*Draft v1 split from the consolidated PIE chapter (Session 4). Two sections: §17.1 *PIE in the Sky* (the prosecutorial case against PIE — bookkeeping defense rejected, logic of non-existent etymon, catalog of failures across the engineered Sanskrit thesis, third-pillar diagnosis, recent-decades cementing); §17.2 *PIE must Die* (the *Pratibimba* killing move — Sanskrit as calibrant, contacted languages as calibrated, what philology assembled into a starred ancestor is the average of the reflections). The chapter closes with the verdict hammer that recycles §17.1's hammer and adds the imperative: "PIE is in the sky. The architecture is on the ground. PIE must die." Chapter 18 picks up the affirmative answer.*
