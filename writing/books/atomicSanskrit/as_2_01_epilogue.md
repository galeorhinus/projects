...
The invitation therefore goes outward to the whole field Sanskrit touched: to South Asia, the Indo-European colonial-language world, and the wider Buddhist Asian world. The older machinery taught these peoples to inherit fragments without knowing the source, reflections without seeing the calibrant, and words without being told what had touched them. The call now asks them to relearn. It requires relearning what *ārya* means, relearning Sanskrit, and relearning discipline, restraint, generosity, skill, and conduct. For those still trapped inside the word *Aryan*, the invitation demands recovering a discipline rather than a race. It urges them not merely to claim *āryatva* but to become capable of it.

The invitation is not ethnic. It is architectural.

## The Inward Correction

India must not replicate the pyramid by building smaller pyramids inside itself. Modern schooling, bureaucracy, broadcasting, and state language policy have often treated living regional speech as if it were defective because it does not match the standardized form chosen by committee, capital, university, or textbook. Marathi has its Pune standard; other Marathi speech-fields have been treated as lesser. The long attempt to classify Konkani as a dialect of Marathi, and the resistance that established it as a language in its own right, hold the memory of that pressure.[NOTE: konkani-marathi-language-pressure] The pattern is not unique to Maharashtra. It repeats wherever a living *prākṛtika bhāṣā* is subordinated to a single authorized standard.
...
Three shadows remain on the field, exceeding the reach of any single argument. The institutions keep their own custody through departments, journals, curricula, and state-funded colonial Indology. Structural power does not dissolve merely upon hearing a case. The public mind lags the proof, leaving textbooks and encyclopedias to repeat *"Sanskrit is Indo-European"* long after the architecture becomes visible. The deepest shadow remains inward: a trained hesitation makes a civilization ask the pyramid's permission before trusting its own categories. None of these fall to argument alone. The work of opening custody, retraining habit, and replacing hesitation with civilizational confidence requires the collective effort of many Atris, not just one author.
...
The asuric formation tried to silence the call by telling the world that *Sanātan* and Sanskrit were secondary. The preceding chapters establish the opposite case. The civilization is not secondary. The calibrant remains visible and actively operating.

Two *created* fractals have stood in the argument since the beginning: the pyramid and the swastika. The pyramid repeats apex authority at every scale. The swastika repeats distributed order, calibrated responsibility, and welfare without apex command. The argument has shown how the pyramid split Sanskrit into two false categories: defining the pre-Pāṇinian era as *prakṛti* (a plant, a descendant) and the post-Pāṇinian era as codification (a language frozen by grammar). The true category now returns to reject these divisions. Sanskrit stands as *saṃskṛti*: engineered recurrence, measured sound, disciplined memory, self-correction, and architecture held for *bhūta-hitam*.
