...
- §14.3 (canonical's "the standard account ... reads the visible differences as evidence of organic mutation") → "the Western philological dogma treats the visible differences ... as evidence of organic mutation" (per the banned *reads X as Y* interpretive-sense rule).
