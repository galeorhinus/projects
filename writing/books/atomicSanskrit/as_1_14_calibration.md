...
The same division appears among verbal forms. The Vedic corpus preserves the *leṭ-lakāra*, the injunctive, and other resources required by its passages. Laukika speakers use a tighter productive set for open composition, while the Vedic alternatives remain available in the passages that preserve them. Chapter 10 called this ***वैचित्र्य (*vaicitrya*)***, engineered range: Sanskrit preserves additional range where that range performs a defined task.
