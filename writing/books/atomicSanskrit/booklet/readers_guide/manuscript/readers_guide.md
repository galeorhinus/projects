...
Tamil, Toda, and Kurukh form the southern comparison. Korku, Mundari, and Ho form the forest-belt comparison. Linguistics classifies the first set as Dravidian and the second as Austroasiatic, outside the Indo-European family to which it assigns Sanskrit.
...
![](../figures/atom_assembly.svg)

Sanskrit measures sound through मात्रा (*mātrā*), a unit of duration. In the convention used by the book's diagrams, each of these consonants occupies half a mātrā and the short vowel occupies one. The widths of the tiles show those different measures. Consonants sit on the upper level; the vowel sits below them.
...
Patañjali tells a story in which Bṛhaspati sets out to teach Indra every valid Sanskrit word. The teacher proceeds word by word. A thousand divine years pass, and he still has not reached the end. How could a human student complete the same task?
...
The familiar account credits Pāṇini with “codifying” Sanskrit and thereby stopping its drift. Codification means setting out accepted forms and rules systematically. The further claim, that doing so makes a language remain unchanged, needs its own explanation.

Tamil provides a comparison. The *Tolkāppiyam* records extensive grammatical knowledge, yet Tamil continued changing across generations. The document allows later readers to study earlier forms. Its existence did not keep everyday speech fixed.
...
Movement of people and authorship of a linguistic system are different claims. Evidence that people traveled does not, by itself, identify who organized Sanskrit's sounds, built its word-forming operations, or established its Vedic preservation architecture.

The book's alternative begins with the connected system already examined in this guide: Sanskrit's subcontinental sound field, its construction, and the way the Vedas keep that construction available. Chapter 18 distinguishes that examination from the author's personal speculation about how the engineers first brought the system together.
...
**Sonomer:** the book's term for a specified sound unit within Sanskrit's sound architecture.
