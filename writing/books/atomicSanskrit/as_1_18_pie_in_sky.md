...
*Draft v2 (2026-05-20). Codex compression of v1 (6,408 → 1,818 words; ~72% reduction, most aggressive of any chapter) with Tier 1 + Tier 2 fully restored and Tier 3 = Codex compressions retained. Codex's 8-section structure preserved. **Tier 1 restorations**: Schleicher's *Compendium der vergleichenden Grammatik der indogermanischen Sprachen* (1861) asterisk-invention + 1868 fable's specific reconstructed words (\**ávis*, \**akvā́sas*, \**kr̥nuto*, \**wl̥qis*, \**ágrom*) in §18.1; Tolkien's Quenya/Sindarin scope (phonology / morphology / syntax / vocabularies thousands of words) and Okrand's 1984 Klingon specifics (agglutinative case-and-aspect morphology) in §18.1; Schleicher-as-named-asuric-operator clause + Ch 3 §3.6 cross-reference in §18.1; Patañjali's *siddha* framework + *dhātuḥ*-as-root mistranslation in §18.3; AHD 3rd ed (1992) and MW 10th ed (1993) specific dictionary citations in §18.5; Sanskrit's three-stage demotion (source → ancestor-among-siblings → cognate-among-many) in §18.5; vivimorphosis full naming with Ch 12 §12.5 reference + "atom → molecule → seed → root — life begins" arrows in §18.6; Mitanni evidence + engineered-model-category-contact-linguistics-lacks framing in §18.6; Mayrhofer EWAia explicit citation + Indic-internal-vs-historical-philological positions divergence paragraph + Ch 8 §8.3 *s*→*h* shift cross-reference in §18.7; Second Shanti series forward-pointer for the political-architectural development of the suric/asuric distinction in §18.7; Appendix Chapter Zero (Part 1) *Baking the Mother Tongue* forward-pointer + dṛś derivational specifics (*kṛt* suffix *-ana* on *guṇa*-grade *darś-*) + "Sanskrit schoolchild can show the steps" line + *theory*/Watkins paragraph in §18.8. **Tier 2 restorations**: "Pie in the sky" arrival-as-phrase + engineer-trained-mind context in chapter opening; "Behind every starred PIE form sits a baker" hammer; Thomason-Kaufman's two central claims (any feature can transfer; intensity/duration predicts depth) in §18.6. **Tier 3 compressed**: Codex's chapter opening retained; Codex's verdict-register closes throughout preserved. **Devanagari first-use audit**: बीज (*bīja*) and अपशब्द (*apaśabda*) first-use pairings restored as vivimorphosis-chain terms specific to this chapter; selective Devanagari at §18.3 architectural-test recall items deferred per the recall-of-established-terms judgment applied in Ch 17.*
...
![Figure 18.1 — PIE Keeps Returning to Sanskrit. The chart measures how much of each reconstructed PIE consonant inventory is covered by Sanskrit, with Tamil as a control. The curve moves away from Sanskrit and then reloads Sanskrit-like material; the historical lanes show context, not causation.](figures/build/pie_in_sky_sanskrit_containment_trajectory.svg){#fig:ch18-pie-trajectory width=92%}
...
The triad locks. The calibrant is the engineered original. Calibrant contact is the process. The *Pratibimba* is what the calibrated language carries afterward. Where philology under the descent assumption treated the systematic correspondences as evidence of a vanished common ancestor, the calibrant framework identifies the same correspondences as evidence of a shared *Pratibimba* — reflections of a single calibrant footprint, refracted through the internal histories of each contacted language. The correspondences have not changed. The explanation has. What philology assembled into an imaginary ancestor is the average of the *Pratibimbas* — a summary statistic misrepresented as a source.
...
**Word count:** ~3,500 words across the chapter opening + eight sections. Codex base 1,818 + Tier 1 + Tier 2 + Tier 3 compressed.

**Restoration log (Codex base → merged v2):**

- **Chapter opening** — restored "Pie in the sky" arrival-as-phrase + engineer-trained-mind context ("I was a mechanical engineer in the auto industry at the time, with no professional stake in comparative philology"); restored the "Behind every starred PIE form sits a baker" hammer.
- **§18.1** — restored Schleicher's *Compendium der vergleichenden Grammatik der indogermanischen Sprachen* (1861) asterisk-invention history; restored the 1868 fable's specific reconstructed words (\**ávis*, \**akvā́sas*, \**kr̥nuto*, \**wl̥qis*, \**ágrom*) and the fable title *Avis akvāsas ka*; restored Tolkien's Quenya/Sindarin scope (phonology / morphology / syntax / vocabularies running to thousands of words) and Okrand's 1984 Klingon specifics (agglutinative case-and-aspect morphology); restored Schleicher-as-named-asuric-operator clause with explicit Ch 3 §3.6 cross-reference.
- **§18.3** — restored Patañjali's *Mahābhāṣya*-anchored *siddha* framework (canonical's full treatment: "the bond between word and meaning is *siddha* — established, not subject to drift"); restored the *dhātuḥ*-as-root mistranslation paragraph ("PIE depends on it. Recovering *dhātuḥ* as a structural constituent — the move Chapter 6 made — dissolves the foundation PIE rests on").
- **§18.4** — restored *progressive orthodoxy* + *church of progress* cluster deployment (per CLAUDE.md doctrinal+institutional cascade).
- **§18.5** — restored AHD 3rd ed (1992) and MW Collegiate 10th ed (1993) specific dictionary citations with side-by-side entries; restored Sanskrit's three-stage demotion ("Sanskrit progressively demoted from *source* to *ancestor-among-siblings* to *cognate-among-many*"); restored the *yoke* dictionary entries (1993 MW vs contemporary); restored the full vivimorphosis arrow-chain for *yoke* with "atom → molecule → seed → root — life begins"; restored the close with the *Pratibimba* footprint anchor.
- **§18.6** — restored Thomason-Kaufman's two central claims (any feature can transfer; intensity/duration predicts depth); restored the Mitanni evidence as direct documentation; restored the "engineered-model category contact linguistics lacks" framing with the substrate / superstrate / adstrate / Ross's metatypy null-result enumeration; restored vivimorphosis full naming with Ch 12 §12.5 reference + the three-stage *śabda* / *bīja* / *apaśabda* mechanism named in the chapter; restored the *deva* worked example with the vivimorphosis arrow chain + the "atom → molecule → seed → root — life begins" close.
- **§18.7** — restored Mayrhofer EWAia explicit citation ("standard account (Mayrhofer, *Etymologisches Wörterbuch des Altindoarischen*)"); restored the Indic-internal-vs-historical-philological positions divergence paragraph (Mayrhofer treats early-Rigvedic *asura* as positive "lord, mighty one" with privative as post-Rigvedic reanalysis — the chapter acknowledges and overrides on structural grounds); restored Ch 8 §8.3 *s* → *h* shift cross-reference with the *Sindhuḥ* → *Hinduš* parallel; restored Second Shanti series forward-pointer for the political-architectural development of the suric / asuric distinction.
- **§18.8** — restored *dṛś* derivational specifics ("*kṛt* suffix *-ana* on the *guṇa*-grade *darś-*"; "*kṛt* suffix *-ti*"; "gerundive in *-ya*"; "present-tense stem, generated through standard present-stem derivation"); restored "a Sanskrit schoolchild can show the steps" line; restored the *theory* / Watkins-"perhaps" paragraph (no Sanskrit cognation listed); restored the Appendix Chapter Zero (Part 1) *Baking the Mother Tongue* explicit forward-pointer with the institutional-cartel framing.

**Devanagari first-use audit:**

- **§18.6 / §18.7 / §18.8** — restored first-use Devanagari pairings for the vivimorphosis-chain terms specific to this chapter: **बीज (*bīja*)** and **अपशब्द (*apaśabda*)**. The chain terms anchor the chapter's central polemic move (engineered *śabda* → seed → organic *apaśabda*) and warrant Devanagari first-use.
- **प्रतिबिम्ब (*Pratibimba*)** — Devanagari already paired in Codex base at §18.5 and §18.6.
- **दृश् / दर्शनम् / दृष्टि / दृश्यम् / पश्यति / स्वर् / सुरः / असुरः / दिव् / देवः / मा / मातृ / युज् / युग** — all paired with Devanagari in the vivimorphosis-chain arrow blockquotes (each chain-step gets the Devanagari + Roman + gloss).
- **§18.3 architectural-test recall items** (*varṇamālā*, *dhātavaḥ*, *mūrdhanya*, *siddha*, *pāṭha*, *Prātiśākhya*, *Śikṣā*) — retained in italic Roman per the recall-of-established-terms judgment applied in Ch 17 (each was introduced with Devanagari in its anchor chapter; adding Devanagari to all seven in §18.3's failure-list would over-load the prosecutorial cadence).
...
- §18.7 confession-hammer: "*Contested* is the confession. // **PIE is a lie.**"
- §18.8 close: triad lock + 5-line verdict hammer (PIE is a lie / accused is now convicted / asuric pyramid is the perpetrator / PIE must die / the prosecution rests).

**Endnote stubs in this chapter:** `pre-pie-dictionary-shift`, `schleicher-1868-fable`, `conlangs-tolkien-okrand`, `pie-term-history`, `pie-cementing-recent-decades`, `early-19c-comparative-philology-bopp-pott`, `jakobson-1959-nursery-words`, `thomason-kaufman-1988`, `ross-metatypy-takia`, `asura-standard-etymology-contested`, `wiktionary-pasyati-suppletion`.

**Cross-references:**

Backward — Ch 1 (botanical metaphor; *dhātuḥ*-as-root mistranslation); Ch 3 §3.6 (asuric pyramid; Schleicher as named asuric operator); Ch 4 (Patañjali's *siddha* framework); Ch 5 (calibrant — internal anchoring); Ch 6 (recovering *dhātuḥ* as structural constituent); Ch 8 §8.3 (*s* → *h* Indo-Iranian shift); Ch 12 §12.5 (vivimorphosis three-stage mechanism); Ch 13 + Ch 14 (calibration matrix, preservation architecture); Ch 16 (retroflex / *mūrdhanya* / *āryatva*); Ch 17 (the wrong question; architectural test).

Forward — Ch 19 (life after PIE — the affirmative answer); Appendix Chapter Zero (Part 1) *Baking the Mother Tongue*; Second Shanti series (political-architectural development of the suric / asuric distinction).
