...
Chapter 17 separated movement from authorship. This chapter applies the distinction to the imaginary ancestor itself.
...
- **§18.4** — restored *progressive dogma* + *church of progress* cluster deployment (per CLAUDE.md doctrinal+institutional cascade).
...
- **§18.7** — restored Mayrhofer EWAia explicit citation under the Western philological dogma; restored the Indic-internal-vs-historical-philological positions divergence paragraph (Mayrhofer treats early-Rigvedic *asura* as positive "lord, mighty one" with privative as post-Rigvedic reanalysis — the chapter acknowledges and overrides on structural grounds); restored Chapter 9 §9.5 *s* → *h* shift cross-reference with the *Sindhuḥ* → *Hinduš* parallel; restored Second Shanti series forward-pointer for the political-architectural development of the suric / asuric distinction.
