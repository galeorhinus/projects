...
One may look and still not see Speech. One may listen and still not hear her.`\textsuperscript{[1]}`{=latex}
...
I have not extended this mistrust to areas that are neither my interest nor my domain of expertise.`\textsuperscript{[4]}`{=latex}
...
I was working through the second verse of the first chapter:`\textsuperscript{[5]}`{=latex}
...
The methodology of the book is straightforward. It begins with what Sanskrit's *paramparā* said about Sanskrit, in its own words. It takes the *Vedas* seriously as the corpus the architecture preserves — the implicit grammatical machinery operating in every recitation rule — and Pāṇini's *Aṣṭādhyāyī* as the explicit *sūtra*-level documentation of that machinery (***vyākaraṇam***, Sanskrit's own word, naming the activity as *analysis* rather than construction). It takes Patañjali's *siddhe śabdārthasambandhe*`\textsuperscript{[9]}`{=latex} seriously as a foundational axiom rather than dismissing it as theological flourish. It takes the *varṇamālā*'s organization by physiological articulation seriously as engineering rather than coincidence. It takes the eleven *pāṭhas* of Vedic recitation`\textsuperscript{[10]}`{=latex} seriously as a redundancy system rather than cultural ornament. And then it asks, repeatedly, the same question: *what kind of system is this, when described from inside its own logic rather than from outside it?*
...
As a Hindu, I was not raised to claim perfect knowledge. I was raised to seek, to question, and to know where knowledge stops. The *Nāsadīya Sūkta* (*Ṛgveda* 10.129) includes that humility in the Vedic corpus itself: even at the origin of the cosmos, not-knowing is permitted.`\textsuperscript{[11]}`{=latex}
...
*That is whole. This is whole. From the whole, the whole emerges. Take the whole from the whole, and the whole still remains.*`\textsuperscript{[12]}`{=latex}
...
***Decoded by many*** names the pre-Pāṇinian *vyākaraṇa* lineage — Śākalya `{\devanagarifont शाकल्य}`{=latex}, Āpiśali `{\devanagarifont आपिशलि}`{=latex}, Kāśyapa `{\devanagarifont काश्यप}`{=latex}, Gārgya `{\devanagarifont गार्ग्य}`{=latex}, Gālava `{\devanagarifont गालव}`{=latex}, Cākravarmaṇa `{\devanagarifont चाक्रवर्मण}`{=latex}, Bhāradvāja `{\devanagarifont भारद्वाज}`{=latex}, Saunaga `{\devanagarifont सौनाग}`{=latex}, Senaka `{\devanagarifont सेनक}`{=latex}, Sphoṭāyana `{\devanagarifont स्फोटायन}`{=latex} — Yaska's *Nirukta* (`{\devanagarifont निरुक्त}`{=latex}, citing pre-Yaska decoders Sthaulāṣṭhīvi and Śakapūṇi), the *Prātiśākhya* (`{\devanagarifont प्रातिशाख्य}`{=latex}) discipline that decoded the phonetic-engineering layer, and the *Śikṣā* (`{\devanagarifont शिक्षा}`{=latex}) discipline that decoded the articulatory specification. Chapter 4 names the grammatical roster in detail; Chapter 10 §10.12 develops Yaska's *agni* decoding as a worked example. ***Pāṇini's decoding is the finest*** — the praise the orthodoxy delivers is granted without hedge. What is denied is the role-attribution that smuggles the engineering credit forward to a decoder.
...
The chapter's epigraph now lands: "Two are the created orders in this world: the divine and the asuric. The divine has been described at length; hear from me, Pārtha, the asuric."`\textsuperscript{[39]}`{=latex}
...
>
> *Given that the bond between word and meaning is established, and given that worldly word-usage is prompted by meaning, śāstra regulates correct usage.*`\textsuperscript{[47]}`{=latex}
...
>
> *Many are the corruptions; few are the words.*`\textsuperscript{[48]}`{=latex}
...
> **`{\devanagarifont गावी}`{=latex} (*gāvī*), `{\devanagarifont गोणी}`{=latex} (*goṇī*), `{\devanagarifont गोता}`{=latex} (*gotā*), `{\devanagarifont गोपोतलिका}`{=latex} (*gopotalikā*).**`\textsuperscript{[49]}`{=latex}
...
The orthodox account claims direct evidence of drift inside the Vedic corpus. It points to differences across the four Vedas, across Rigvedic *maṇḍalas*, across Saṃhitā / Brāhmaṇa / Āraṇyaka / Upaniṣad layers, across recensions, across accent systems, and across word forms.`\textsuperscript{[50]}`{=latex}
...
If Sanskrit is built from **`{\devanagarifont वर्णाः}`{=latex} (*varṇāḥ*)** into *dhātavaḥ*, and from *dhātavaḥ* into **`{\devanagarifont शब्दाः}`{=latex} (*śabdāḥ*)**, then the system is not biological. It is architectural. It is a system of structured assembly.
...
The tongue is the most complex moving part: tip, blade, body, and base. Above it sit the upper teeth, the alveolar ridge, the hard palate, the soft palate, and the uvula. At the front are the lips. At the back is the throat. The distance from lips to glottis averages roughly seventeen centimeters in adult males, ~14–15 cm in adult females, and shorter still in children, with the adult range running from about 13 cm to about 20 cm. The architecture is the same.`\textsuperscript{[58]}`{=latex}
...
That unit is the **`{\devanagarifont अक्षर}`{=latex} (*akṣara*)** — the imperishable. The morphology is exact: *a-* (privative) + √*kṣar* (to flow, to perish) — *that which does not decay*. The name is not neutral. Latin has *littera*, a mark. Greek has *gramma*, what is written. Arabic has *ḥarf*, an edge. Sanskrit names the writing-and-utterance primitive *akṣara*, the imperishable. The non-decay claim sits inside the name.`\textsuperscript{[74]}`{=latex}
...
The vocabulary developed here is not modern explanation imposed backward. *Sthāna*, *karaṇa*, *prayatna*, *prāṇa*, *ghoṣa*, *anunāsika*, *sparśa*, *swara*, *antaḥstha*, *ūṣman*, *varga*, *varṇa*, and *varṇamālā* belong to the Sanskrit grammatical and phonetic disciplines themselves. The *Prātiśākhya* and *Śikṣā* materials document the architecture as already operating vocabulary.`\textsuperscript{[75]}`{=latex}`\textsuperscript{[76]}`{=latex}
...
Frits Staal saw the structural point clearly when he compared the *varga* system to Mendeleev's periodic table.`\textsuperscript{[77]}`{=latex} The comparison is right. Each *sparśa* consonant sits at a coordinate determined by constituent properties, just as a chemical element sits inside a reference system determined by its constituent properties.
...
The same logic extends beyond *sparśa*. *Swaras* sample vowel-space and add time: *hrasva*, *dīrgha*, and *pluta*.`\textsuperscript{[83]}`{=latex} *Antaḥstha* occupy the in-between mode. *Ūṣman* operate constricted breath. *Ayogavāha* specifies breath termination. The full *varṇamālā* is not a list. It is the integrated specification of the speaking body.
...
The southern languages — Tamil, Kannada, Malayalam, Telugu, Tulu — preserve the five-zone place axis and the retroflex series. They do not operate the full *mahāprāṇa* series natively in the same way Sanskrit does; aspirates generally enter through Sanskritic vocabulary.`\textsuperscript{[86]}`{=latex} That difference matters. These languages are not failed Sanskrit. They are parallel selections from the same regional substrate.
...
The eastern subcontinent — Bengali, Odia, Assamese, Maithili's eastern edge — preserves the retroflex series and the five-zone axis. Bengali's `{\devanagarifont व}`{=latex} / `{\devanagarifont ब}`{=latex} merger occurs inside the labial zone, exactly where the matrix carries a close neighbor. Odia remains especially conservative in its consonant inventory.`\textsuperscript{[87]}`{=latex}

The Sindhu region adds the cleanest exclusion case. Sindhi preserves retroflexion, the five-zone axis, and aspiration, but also operates implosives — ɓ, ɗ, ʄ, ɠ — that Sanskrit does not include.`\textsuperscript{[88]}`{=latex} The sound-field contains them. The *varṇamālā* rejects them.
...
Now compare the matrix with the broader superset. The subcontinental field contains more than the five Sanskrit places. Tamil operates an alveolar contact-station distinct from dental and retroflex.`\textsuperscript{[89]}`{=latex} Ho, Mundari, and related languages operate glottal stops or checked consonants.`\textsuperscript{[90]}`{=latex} Persian-and-Arabic-influenced registers carry labio-dental fricatives such as *f*.`\textsuperscript{[91]}`{=latex} Sindhi operates implosives. Some regional systems carry fine distinctions around the palatal zone.
...
The selected sound-particle is the **`{\devanagarifont वर्ण}`{=latex} (*varṇa*)**. The stable sound-unit is the **`{\devanagarifont अक्षरम्}`{=latex} (*akṣaram*)** — the imperishable. Chapter 8 named the structure: an *akṣara* is not a mark first and a sound second. It is an engineered sound-unit made visible. The visible form belongs to **`{\devanagarifont लिपि}`{=latex} (*lipi*)**. The architecture belongs to the mouth.
...
The **`{\devanagarifont शिक्षा}`{=latex} (*Śikṣā*)** discipline gives Sanskrit a timing grid. The unit is the **`{\devanagarifont मात्रा}`{=latex} (*mātrā*)** — a measure of duration. The system does not merely ask where the tongue strikes or how the breath moves. It asks how long the sound holds.`\textsuperscript{[92]}`{=latex}
...
This table will do heavy work in Chapter 10. The template notation there — C, V1, V2 — is not a typographic convenience. It encodes duration. **C** is half a *mātrā*. **V1** is one *mātrā*. **V2** is two *mātrās*. A *dhātuḥ* such as *gam* (`{\devanagarifont गम्}`{=latex}) is therefore not merely CVC. It is ½ + 1 + ½. A *dhātuḥ* such as *bhū* (`{\devanagarifont भू}`{=latex}) is ½ + 2. The atom has a timing envelope before it has a template.
...
Punjabi confirms the danger. Its tones developed after voiced aspirates weakened or merged; the lost consonantal contrast leaked into neighboring vowels as pitch.`\textsuperscript{[93]}`{=latex} Some Pahari languages show related tonal developments.`\textsuperscript{[94]}`{=latex} Tone here is evidence of drift after an older consonantal contrast weakened. Sanskrit's preserved grid prevents that drift.
...
**Sindhi implosives.** Sindhi carries implosive consonants. Sanskrit does not. Implosives are voiced stops with inward airflow, acoustically close enough to ordinary voiced stops to crowd the row. The field contains them; the grid rejects them.`\textsuperscript{[95]}`{=latex}

**Tamil alveolar.** Tamil preserves an alveolar contact-station between dental and retroflex. Sanskrit excludes it. The tongue-tip axis would become too crowded if dental, alveolar, and retroflex were all full grid rows.`\textsuperscript{[96]}`{=latex}

**Glottal stop.** Some central-eastern languages use glottal closure phonemically. Sanskrit does not. It assigns the glottal/breath region to different work: *visarga* and related breath-gestures.`\textsuperscript{[97]}`{=latex}

**Labio-dental fricatives.** The *f* / *v* region appears through contact registers and in non-subcontinental languages. Sanskrit keeps the labial row bilabial. It does not crowd the front edge of the mouth with a second labial contact-station.`\textsuperscript{[98]}`{=latex}
...
The evidence is visible in the architecture. No signed plan is needed for the same reason no signed plan is needed to recognize the engineering of Kailasa at Ellora. The temple's architects are anonymous; the temple's engineering is not.`\textsuperscript{[100]}`{=latex} The rock carries the record.
...
The epigraph gives the engineering rule before physics does. A *sūtra* is few-syllabled, unambiguous, essence-bearing, facing in every direction, without padding, and faultless. This is **`{\devanagarifont सूत्रलाघव}`{=latex} (*sūtra-lāghava*)**: engineered brevity — maximum recoverable structure in minimum form.
...
This chapter turns *sūtra-lāghava* into an empirical test. If the principle is architectural, the *dhātuḥ* should display **atomic concision**: small form, stable identity, high generative reach. First, the physics refresher.
...
## 10.2 From Sound-Particles to Atoms
...
The *varṇamālā* (`{\devanagarifont वर्णमाला}`{=latex}) is the particle inventory. The system built from those particles is the **`{\devanagarifont धातुः}`{=latex} (*dhātuḥ*)**.
...
The metaphor is physical, not biological. The same word *dhātuḥ* operates in metallurgy, *Rasaśāstra* (`{\devanagarifont रसशास्त्र}`{=latex}), and *Āyurveda* (`{\devanagarifont आयुर्वेद}`{=latex}): foundational constituent, underlying element, stable bearer. The grammatical *dhātuḥ* belongs in that family. It is the stable semantic constituent of the linguistic system.

The object is already on the table. Chapter 0 named the *Dhātupāṭha* (`{\devanagarifont धातुपाठ}`{=latex}) as the inventory of roughly two thousand semantic atoms. This chapter uses a working corpus of **2,168 *dhātavaḥ*** from that inventory. Chapter 1 showed what the mistranslation as "root" damaged. Chapter 6 restored *dhātuḥ* to its own category: the constituent that holds. The working examples can now be plain: **`{\devanagarifont कृ}`{=latex} (*kṛ*)**, to do or make; **`{\devanagarifont गम्}`{=latex} (*gam*)**, to go; **`{\devanagarifont भू}`{=latex} (*bhū*)**, to be or become; **`{\devanagarifont दृश्}`{=latex} (*dṛś*)**, to see; **`{\devanagarifont ज्ञा}`{=latex} (*jñā*)**, to know. These are not words. They are the atoms from which words are assembled.
...
- **`{\devanagarifont वर्णाः}`{=latex} (*varṇāḥ*)** — engineered phonetic particles.
- **`{\devanagarifont धातवः}`{=latex} (*dhātavaḥ*)** — stable semantic atoms built from those particles.
...
> particles `{\symbolfont →}`{=latex} atoms `{\symbolfont →}`{=latex} molecules

Chemistry operates on matter. Sanskrit operates on sound. The substrate differs. The combinatorial architecture is the same.

The first measurement is particle length: the number of *varṇāḥ* inside each *dhātuḥ*. The examples already show the scale. **`{\devanagarifont कृ}`{=latex} (*kṛ*)** has two particles. **`{\devanagarifont गम्}`{=latex} (*gam*)** has three. **`{\devanagarifont भू}`{=latex} (*bhū*)** has two. **`{\devanagarifont दृश्}`{=latex} (*dṛś*)** has three. **`{\devanagarifont ज्ञा}`{=latex} (*jñā*)** has two.
...
The figure gives the answer. The particle-count peak lands at three: **58.2%** of the inventory. Four-particle atoms remain heavy at **25.7%**. Five-particle atoms drop to **3.6%**. Six-and-above is the cliff at **0.5%**. The inventory is not drifting toward length. It concentrates identity into compact forms.
...
The Sanskrit system then names the bonded result **`{\devanagarifont अक्षरम्}`{=latex} (*akṣaram*)** — the imperishable. A *svaraḥ* and one or more *vyañjanāni* bond into a stable sound-unit, and the script captures it as an audiograph. The *akṣaram* is the stable sound-bond made visible.
...
The empirical distribution confirms it. The 2-*mātrā* envelope alone carries **998 entries — 46.03%** of the inventory. The 2½-*mātrā* atoms add another **566 (26.11%)**, lifting cumulative coverage past **78%**; through 3 *mātrās* the cumulative reaches **94%**. Past 3½ *mātrās* the cliff begins: every value from 4 onward sums to under **3%** of the corpus. Three *mātrā* values carry the inventory; the architecture commits to a narrow band of measured time.

## 10.5 `{\devanagarifont धातुरचना}`{=latex} - *Dhāturacanā* — The Atomic Scaffold

The next step is abstraction. Each atom — each *dhātuḥ* — fills a specific arrangement of atomic particles. Across the 2,168 *dhātavaḥ* of the *Dhātupāṭha*, many atoms share the same arrangement pattern. That shared pattern is the **`{\devanagarifont धातुरचना}`{=latex} (*dhāturacanā*)** — the atomic scaffold, the constructed arrangement underneath each filled atom.
...
Different *dhātavaḥ* fill the same atomic scaffold. **`{\devanagarifont गम्}`{=latex} (*gam*), `{\devanagarifont नम्}`{=latex} (*nam*), `{\devanagarifont पच्}`{=latex} (*pac*), and `{\devanagarifont वद्}`{=latex} (*vad*)** are four distinct atoms inhabiting one shape — consonantal contact (**C**), short-vowel nucleus (**V1**), consonantal contact (**C**) — **CV1C** <img src="figures/icons/scaffold_cv1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1C scaffold">. In Pāṇini's *-ādi* naming convention (*gam*-and-following), the shape is the **`{\devanagarifont गमादि}`{=latex} `{\devanagarifont रचना}`{=latex} (*gamādi racanā*)** — the *gamādi* scaffold.`\textsuperscript{[101]}`{=latex} The timing is already inside the scaffold.
...
The most common atomic scaffold is the same one the examples just used. The `{\devanagarifont गमादि}`{=latex} `{\devanagarifont रचना}`{=latex} (*gamādi racanā*) CV1C <img src="figures/icons/scaffold_cv1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1C scaffold"> alone accounts for **926 entries — 42.71%** of the corpus. The broader three-particle class peaked in the first figure; the scaffold analysis now shows the dominant shape inside that peak.

The distinction matters:

- **Scaffold / *dhāturacanā*** — the measured arrangement: **`{\devanagarifont गमादि}`{=latex} (*gamādi*)** CV1C <img src="figures/icons/scaffold_cv1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1C scaffold">, **`{\devanagarifont स्मरादि}`{=latex} (*smarādi*)** CCV1C <img src="figures/icons/scaffold_ccv1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CCV1C scaffold">, **`{\devanagarifont कल्पादि}`{=latex} (*kalpādi*)** CV1CC <img src="figures/icons/scaffold_cv1cc_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1CC scaffold">, **`{\devanagarifont वाचादि}`{=latex} (*vācādi*)** CV2C <img src="figures/icons/scaffold_cv2c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV2C scaffold">.
...
## 10.6 Ten *Racanāḥ* Carry the Inventory

The empirical distribution is decisive. The **`{\devanagarifont धातुपाठ}`{=latex} (*Dhātupāṭha*)** lists 2,168 *dhātavaḥ* across ten **`{\devanagarifont गणाः}`{=latex} (*gaṇāḥ*)**. After **`{\devanagarifont अनुबन्ध}`{=latex} (*anubandha*)** stripping, the corpus inhabits 69 observed *racanā* scaffolds. But the distribution is not flat. Ten scaffolds carry **91.01%** of the corpus.`\textsuperscript{[102]}`{=latex}
...
|:-:|:-:|---|:-:|---:|---|
| <img src="figures/icons/scaffold_cv1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1C scaffold"> | CV1C | **`{\devanagarifont गमादि}`{=latex} (*gamādi*)** | 2 | 926 (42.71%) | `{\devanagarifont दध्}`{=latex}, `{\devanagarifont वद्}`{=latex}, `{\devanagarifont भद्}`{=latex}, `{\devanagarifont मद्}`{=latex}, `{\devanagarifont मुद्}`{=latex} |
| <img src="figures/icons/scaffold_ccv1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CCV1C scaffold"> | CCV1C | **`{\devanagarifont स्मरादि}`{=latex} (*smarādi*)** | 2½ | 232 (10.70%) | `{\devanagarifont स्कुद्}`{=latex}, `{\devanagarifont श्विद्}`{=latex}, `{\devanagarifont स्पद्}`{=latex}, `{\devanagarifont क्लिद्}`{=latex}, `{\devanagarifont ष्वद्}`{=latex} |
| <img src="figures/icons/scaffold_cv1cc_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1CC scaffold"> | CV1CC | **`{\devanagarifont कल्पादि}`{=latex} (*kalpādi*)** | 2½ | 216 (9.96%) | `{\devanagarifont कुर्द्}`{=latex}, `{\devanagarifont खुर्द्}`{=latex}, `{\devanagarifont गुर्द्}`{=latex}, `{\devanagarifont पर्द्}`{=latex}, `{\devanagarifont कत्थ्}`{=latex} |
| <img src="figures/icons/scaffold_cv2c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV2C scaffold"> | CV2C | **`{\devanagarifont वाचादि}`{=latex} (*vācādi*)** | 3 | 214 (9.87%) | `{\devanagarifont गाध्}`{=latex}, `{\devanagarifont बाध्}`{=latex}, `{\devanagarifont नाध्}`{=latex}, `{\devanagarifont नाथ्}`{=latex}, `{\devanagarifont षूद्}`{=latex} |
| <img src="figures/icons/scaffold_cv2_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV2 scaffold"> | CV2 | **`{\devanagarifont धादि}`{=latex} (*dhādi*)** | 2½ | 89 (4.11%) | `{\devanagarifont भू}`{=latex}, `{\devanagarifont दॄ}`{=latex}, `{\devanagarifont नॄ}`{=latex}, `{\devanagarifont जॄ}`{=latex}, `{\devanagarifont णी}`{=latex} |
| <img src="figures/icons/scaffold_v1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="V1C scaffold"> | V1C | **`{\devanagarifont इषादि}`{=latex} (*iṣādi*)** | 1½ | 70 (3.23%) | `{\devanagarifont अत्}`{=latex}, `{\devanagarifont अद्}`{=latex}, `{\devanagarifont इद्}`{=latex}, `{\devanagarifont अक्}`{=latex}, `{\devanagarifont अघ्}`{=latex} |
| <img src="figures/icons/scaffold_ccv2c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CCV2C scaffold"> | CCV2C | **`{\devanagarifont ह्रादादि}`{=latex} (*hrādādi*)** | 3½ | 65 (3.00%) | `{\devanagarifont ह्राद्}`{=latex}, `{\devanagarifont ह्लाद्}`{=latex}, `{\devanagarifont स्वाद्}`{=latex}, `{\devanagarifont श्लोक्}`{=latex}, `{\devanagarifont स्रोक्}`{=latex} |
| <img src="figures/icons/scaffold_cv1_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1 scaffold"> | CV1 | **`{\devanagarifont क्रादि}`{=latex} (*krādi*)** | 1½ | 64 (2.95%) | `{\devanagarifont न}`{=latex}, `{\devanagarifont भृ}`{=latex}, `{\devanagarifont हृ}`{=latex}, `{\devanagarifont धृ}`{=latex}, `{\devanagarifont सृ}`{=latex} |
| <img src="figures/icons/scaffold_ccv2_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CCV2 scaffold"> | CCV2 | **`{\devanagarifont स्थादि}`{=latex} (*sthādi*)** | 3 | 49 (2.26%) | `{\devanagarifont श्रा}`{=latex}, `{\devanagarifont ग्ला}`{=latex}, `{\devanagarifont स्ना}`{=latex}, `{\devanagarifont ग्लै}`{=latex}, `{\devanagarifont म्लै}`{=latex} |
| <img src="figures/icons/scaffold_ccv1cc_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CCV1CC scaffold"> | CCV1CC | **`{\devanagarifont स्पर्धादि}`{=latex} (*spardhādi*)** | 3 | 48 (2.21%) | `{\devanagarifont स्पर्ध्}`{=latex}, `{\devanagarifont स्वर्द्}`{=latex}, `{\devanagarifont ष्वस्क्}`{=latex}, `{\devanagarifont क्रुञ्च्}`{=latex}, `{\devanagarifont त्वञ्च्}`{=latex} |

The *gamādi* <img src="figures/icons/scaffold_cv1c_gray.svg" style="height:1em;vertical-align:-0.2em" alt="CV1C scaffold"> alone carries **42.71%** of the corpus; ten scaffolds together cover **91.01%**. The conclusion is not that Sanskrit has short words. The conclusion is that Sanskrit uses a small number of measured scaffolds to carry the overwhelming majority of its semantic atoms. The architecture is not merely compact. It is selective.
...
Inventory is the first test. Actual use is the second.
...
**Compression.** Compact forms persist and generate. The *Dhātupāṭha* should peak near the minimum particle count compatible with semantic distinction. It does. The DCS usage check shows that the same compression survives the move from inventory to Sanskrit in use.
...
Compression succeeds immediately. §10.4's *mātrā* envelope and §10.6's *racanā* spine establish it: a narrow timing band, ten dominant scaffolds, **81% of the inventory** inside compact, repeatable shapes. §10.7 then adds actual use: the same ten scaffolds carry most *dhātavaḥ* that appear in texts, most measured combinations, and most counted occurrences.

Older derivative counts already pointed in the same direction. The most productive *dhātavaḥ* are structurally small. *Kṛ* anchors 75+ primary derivatives; *bhū*, *dā*, *dhā*, *jñā*, *hṛ*, *nī* each generate 40–55 derivatives apiece.`\textsuperscript{[104]}`{=latex}
...
Compression says: keep the atom short. Distinguishability says: do not let shortness produce blur. The cleanest test therefore stays inside the same *mātrā* budget. If the system were merely minimizing duration, the scaffolds inside one timing envelope should be interchangeable. They are not. The inventory repeatedly spends its small time-budget on consonantal edges around a vowel nucleus.`\textsuperscript{[105]}`{=latex}
...
| 3 | 231 | **CV2C + CCV2 + CCV1CC** | 193 / 231 = **83.5%** | The bucket does not smear into arbitrary length; three scaffolds carry most of it through either long-vowel signature or dense consonantal framing. |
| 4 | 188 | **CV2CV1 + CV1CV2** | 163 / 188 = **86.7%** | The disyllabic family still concentrates around ordered, repeatable scaffolds instead of spreading evenly across possible forms. |

The two-*mātrā* row is the decisive one. **CV1C** and **V2** occupy the same timing budget. One uses three particles and two consonantal contacts; the other uses one long vowel. Pure duration-minimization would have no reason to prefer the former so decisively. Sanskrit does. The dominant atom is not merely short. It is short and acoustically edged.

The 2½-*mātrā* row repeats the verdict. **CCV1C** and **CV1CC** together carry nearly four-fifths of the bucket. The system adds consonantal definition around the short vowel rather than allowing duration alone to do the work. Compression creates the envelope; distinguishability chooses the scaffold.

The full consonant-position proof belongs to Chapter 11: which *varṇāḥ* prefer release, which prefer closure, which bond clusters, which neutralize, and which places avoid repetition. Chapter 10 only needs the bridge. Shape is already non-random before the individual particles are analyzed.

But distinguishability alone also fails. A system could be distinguishable with longer atoms — five, six, or seven particles, each acoustically separated. Distinguishability does not explain why the corpus peaks at three, why the cliff begins at five, why ten scaffolds carry the inventory, or why short atoms are the most generative.
...
No natural drifting language generates that disciplinary constellation. The disciplines exist because the language can bear them.

Yaska's decoding of **`{\devanagarifont अग्नि}`{=latex} (*agni*)** at *Nirukta* 7.14 makes the point concrete. The text predates Pāṇini and is foundational to the etymological decoding discipline. Yaska treats one word with four independent *dhātu*-level decodings, two attributed to earlier named pre-Pāṇinian decoders:`\textsuperscript{[107]}`{=latex}
...
![Position-role map of the *varṇamālā*'s consonants across single-*akṣara* atoms. Each bubble is one consonant; horizontal position is total onset deployment (atom-start + cluster-joiner-before-vowel), vertical position is total coda deployment (cluster-joiner-after-vowel + atom-end), and bubble size encodes inner-cluster activity. **`{\devanagarifont र}`{=latex}** stands alone as the universal bonder — the only consonant covering all four position-roles at meaningful magnitude and the only one with substantial inner-cluster work. **`{\devanagarifont क}`{=latex}**, **`{\devanagarifont व}`{=latex}**, **`{\devanagarifont प}`{=latex}**, **`{\devanagarifont श}`{=latex}** populate the onset-specialist edge; **`{\devanagarifont ष}`{=latex}**, **`{\devanagarifont ज}`{=latex}**, **`{\devanagarifont स}`{=latex}**, **`{\devanagarifont ट}`{=latex}**, **`{\devanagarifont ड}`{=latex}** the coda-specialist edge; **`{\devanagarifont ल}`{=latex}** sits near the diagonal as the structural neutralizer. The dashed line marks the onset = coda diagonal.](figures/build/building_dhatuh_role_map_color.svg){#fig:building-dhatuh-role-map width=95%}
...
Second, *la* (`{\devanagarifont ल}`{=latex}) operates as a structural neutralizer. Its profile is unusually balanced across initial and final deployment, broad vowel compatibility, and multi-role use.
...
***Holding its structure through bonding.*** A *dhātuḥ* combines with *upasargāḥ* (`{\devanagarifont उपसर्गाः}`{=latex}) and *pratyayāḥ* (`{\devanagarifont प्रत्ययाः}`{=latex}) — the bonding chemistry Chapter 12 develops — without losing its identity. *Kṛ* (`{\devanagarifont कृ}`{=latex}) in *karoti* (`{\devanagarifont करोति}`{=latex}, does), *kāryam* (`{\devanagarifont कार्यम्}`{=latex}, that which is to be done), *kartṛ* (`{\devanagarifont कर्तृ}`{=latex}, the doer), *karma* (`{\devanagarifont कर्म}`{=latex}, the deed), *saṃskāra* (`{\devanagarifont संस्कार}`{=latex}, the consecration), *prakṛti* (`{\devanagarifont प्रकृति}`{=latex}, the original nature), *vikṛti* (`{\devanagarifont विकृति}`{=latex}, the modification), *ākāra* (`{\devanagarifont आकार}`{=latex}, the form), *upakāra* (`{\devanagarifont उपकार}`{=latex}, the assistance), *parikāra* (`{\devanagarifont परिकार}`{=latex}, the surrounding arrangement) — across all of these, *kṛ* (`{\devanagarifont कृ}`{=latex}) persists as the recognizable atomic unit. The *upasargāḥ* and *pratyayāḥ* attach to it, modify the molecular meaning, but do not consume the atom. The atom is what comes through every bond intact.

***Without losing its constitutive form.*** The *dhātuḥ* (`{\devanagarifont धातुः}`{=latex}) does not mutate the way the botanical metaphor's "root" mutates. A botanical root grows, branches, drinks water, gathers nutrients, and changes its shape across the plant's lifetime. The *dhātuḥ* does not. The *dhātuḥ* in *karoti* (`{\devanagarifont करोति}`{=latex}) is the same *dhātuḥ* in *karma* (`{\devanagarifont कर्म}`{=latex}), the same *dhātuḥ* in *saṃskāra* (`{\devanagarifont संस्कार}`{=latex}), the same *dhātuḥ* in the *Vedas*, the same *dhātuḥ* in the *Bhagavad Gītā*, the same *dhātuḥ* in the *Rāmāyaṇa*. The form is the constant; what varies is what bonds to it.

***Physical constant of the system, not a mutating organic root.*** This is the not-botanical declaration Chapter 1's prosecution of the botanical metaphor, Chapter 6's reclamation of the *dhātu* terminology, and the present chapter's atomic-physics framing prepare in their turns. The *vyākaraṇa* discipline's term *dhātu* (`{\devanagarifont धातु}`{=latex}) — the same term operating in metallurgy, in *Rasaśāstra*, in *Āyurveda* — places the unit in the engineering category by terminological choice. The mistranslation as "root," the imposition of botanical decay-and-growth onto a unit the *paramparā* placed in the engineering category, is the philological orthodoxy's structural error.
...
The corollary's consequences run forward. Chapter 11 develops the periodic-table arrangement of the *dhātavaḥ* — atoms arranged by valency and reactivity. Chapter 12 develops the bonding chemistry that produces *śabdāḥ*. Chapter 13 develops the *Aṣṭādhyāyī* (`{\devanagarifont अष्टाध्यायी}`{=latex}) as the rule-system that operates on the entire chemistry.
...
The chapter began with *sūtra-lāghava*: engineered brevity. It now returns with the answer. The principle does not stop at the *sūtra*. It reaches down into the atom. *Varṇāḥ* combine into *dhātavaḥ*. The *mātrā* grid gives the atom its timing envelope. The *racanā* scaffold gives the atom its measured construction. Compression sizes the atoms. Distinguishability protects them. Engineering-poetry assigns them with acoustic intelligence. The DCS usage check adds pressure from the texts: the scaffolds that carry the inventory also carry most *dhātavaḥ* that appear in Sanskrit texts, most measured combinations, and most occurrences.

That is atomic concision. The *dhātuḥ* is small, but not thin. It is brief, but not empty. It carries recoverable structure, stable identity, and generative reach in minimum form.
...
The next chapter tests that arrangement by particle-count, *varga* column, inherent vowel, and DCS-measured reactivity. Chapter 10 has shown engineered brevity at the atomic level: scaffolded construction, actual-use pressure, and identity preserved through compact form. Chapter 11 asks whether the particles arrange periodically.

That is the next test.

# Chapter 11 — The Periodic Table of Gaṇāḥ

---

## 11.1 Pāṇini Decoded the Table

Pāṇini decoded the *dhātavaḥ* (`{\devanagarifont धातवः}`{=latex}). He did not engineer them.

Sanskrit was engineered before Pāṇini. The Vedas encoded it through *chandas* (`{\devanagarifont छन्दस्}`{=latex}), *śruti* (`{\devanagarifont श्रुति}`{=latex}), and *paramparā* (`{\devanagarifont परम्परा}`{=latex}). The *vaiyākaraṇāḥ* (`{\devanagarifont वैयाकरणाः}`{=latex}), the decoders, read that encoding across generations of analytical work. Pāṇini's decoding is the finest.

He named the ten **`{\devanagarifont गणाः}`{=latex} (*gaṇāḥ*)**, the inflectional classes. He documented the **`{\devanagarifont विकरण}`{=latex} (*vikaraṇa*)**, the column signature that distinguishes one conjugational pattern from another.`\textsuperscript{[108]}`{=latex} He showed how *dhātavaḥ* enter the grammar's molecular machinery.
...
Mendeleev organized the chemical elements by structural property; chemical behavior emerged from position in the table.`\textsuperscript{[109]}`{=latex} He did not sort elements by what they "meant." He sorted them by behavior, and the chemistry became visible.
...
The atom is the *dhātuḥ* (`{\devanagarifont धातुः}`{=latex}). The head-bond is the *upasargaḥ* (`{\devanagarifont उपसर्गः}`{=latex}): *pra-*, *vi-*, *sam-*, *abhi-*, *anu-*, and the rest of the prefix set. The tail-bond is the *pratyayaḥ* (`{\devanagarifont प्रत्ययः}`{=latex}): the suffix family that activates the atom into finite, participial, or derivative form. A distinct (*upasarga*, *pratyaya*-class) pair that produces an attested form is one valency unit.

Valency is chemical yield, not subjective importance.

*Kṛ* (`{\devanagarifont कृ}`{=latex}, to make) carries valency 1,062 in the Digital Corpus of Sanskrit.`\textsuperscript{[110]}`{=latex} *Bhū* (`{\devanagarifont भू}`{=latex}, to be) carries 504. *Dhā* (`{\devanagarifont धा}`{=latex}, to place) carries 386. These are not claims about prestige or usefulness. They are corpus-attested bonding counts.
...
Natural-language drift can produce frequency concentration. It does not produce this full signature: concentration plus compactness plus structural regularity. In many languages, high-frequency forms become irregular — English *be / have / do* are suppletive; Latin *esse / ire / ferre* are suppletive; Greek *eimi / oida / ph`{\symbolfont ē}`{=latex}mi* are suppletive. The frequency-irregularity correlation is one of the most-replicated findings in natural-language morphology. Sanskrit reverses the pattern. The most productive atoms are structurally minimal. Path C gives Spearman ρ = -0.4334 between valency and particle count; the matched MW subset gives -0.490. The corpus confirms what Chapter 10 found from another window.
...
C1: unvoiced unaspirates — `{\devanagarifont क}`{=latex} `{\devanagarifont च}`{=latex} `{\devanagarifont ट}`{=latex} `{\devanagarifont त}`{=latex} `{\devanagarifont प}`{=latex}.  
C2: unvoiced aspirates — `{\devanagarifont ख}`{=latex} `{\devanagarifont छ}`{=latex} `{\devanagarifont ठ}`{=latex} `{\devanagarifont थ}`{=latex} `{\devanagarifont फ}`{=latex}.  
C3: voiced unaspirates — `{\devanagarifont ग}`{=latex} `{\devanagarifont ज}`{=latex} `{\devanagarifont ड}`{=latex} `{\devanagarifont द}`{=latex} `{\devanagarifont ब}`{=latex}.  
C4: voiced aspirates — `{\devanagarifont घ}`{=latex} `{\devanagarifont झ}`{=latex} `{\devanagarifont ढ}`{=latex} `{\devanagarifont ध}`{=latex} `{\devanagarifont भ}`{=latex}.  
C5: nasals — `{\devanagarifont ङ}`{=latex} `{\devanagarifont ञ}`{=latex} `{\devanagarifont ण}`{=latex} `{\devanagarifont न}`{=latex} `{\devanagarifont म}`{=latex}.

The periodic-table column for an atom is the column of its first consonant.`\textsuperscript{[112]}`{=latex} Semivowels, sibilants, and `{\devanagarifont ह}`{=latex} function as additional structural columns. Vowel-initial atoms occupy a separate band.
...
The *gaṇāḥ* still reveal the deeper column structure. The *juhotyādi* class enriches the C4 voiced-aspirate column at 33.3% in the inventory and 42.9% in corpus-attested atoms, three to four times the C4 rate of other *gaṇāḥ*.`\textsuperscript{[113]}`{=latex} Reduplication requires acoustic robustness; C4 supplies it. *Curādi* concentrates at C1. *Adādi* lifts C3. *Svādi* lifts C4 for its own reasons. The inflectional classes are cross-sections through the phonetic-functional grid.

An orthogonal axis confirms the table: the atom's inherent vowel. *Kṛ*, *hṛ*, and *vṛt* carry `{\devanagarifont ऋ}`{=latex}. *Dhā*, *dā*, *sthā*, *jñā*, and *yā* carry `{\devanagarifont आ}`{=latex}. *Gam*, *kram*, *han*, and *pad* carry `{\devanagarifont अ}`{=latex}. Across the corpus, inherent vowel splits the valency distribution sharply. Vowel-`{\devanagarifont ऋ}`{=latex} atoms generate 13.6% of the corpus from 3.3% of the inventory, with mean valency 34.35.`\textsuperscript{[114]}`{=latex} Seven of the nine canonical polyvalent atoms sit in the open-vowel core: `{\devanagarifont अ}`{=latex}, `{\devanagarifont आ}`{=latex}, `{\devanagarifont ऋ}`{=latex}.
...
That matters because the corpora are engineered for different purposes. The *Ṛgveda* (`{\devanagarifont ऋग्वेद}`{=latex}) is *śruti* — oral-preservation target. The *Atharvaveda* (`{\devanagarifont अथर्ववेद}`{=latex}) is *śruti* — ritual-cosmological target. The *Mahābhārata* (`{\devanagarifont महाभारत}`{=latex}) is *smriti* — narrative-transmission target. The *Rāmāyaṇa* (`{\devanagarifont रामायण}`{=latex}) is *smriti* and *itihāsa* — poetic-narrative target. Four sub-corpora, four design purposes, one shared atomic inventory.

The canonical nine polyvalent atoms — *kṛ, bhū, sthā, gam, jñā, dā, dhā, nī, hṛ* — are attested **9/9** in every sub-corpus.`\textsuperscript{[115]}`{=latex} The *smriti* corpora carry the full canonical set in their top-20 lists. The *śruti* corpora carry six of nine in their top-20 lists, with ritual-specific atoms — *vah* (`{\devanagarifont वह्}`{=latex}), *yam* (`{\devanagarifont यम्}`{=latex}), *bhṛ* (`{\devanagarifont भृ}`{=latex}), *cakṣ* (`{\devanagarifont चक्ष्}`{=latex}) — substituting in the top tier.
...
Chapter 10 named the compression principle at the *varṇa* `{\symbolfont →}`{=latex} *dhātu* layer — the smallest sufficient set of sound-particles to span the meaning-space is engineered in. The *dhātu* `{\symbolfont →}`{=latex} *śabda* layer carries the same principle one level up. The smallest sufficient set of atoms — those whose combinatorial reach generates the lexicon — is engineered in, arranged on a grid the *varga* columns and the inherent vowels reveal.
...
The preceding chapters establish the *varṇamālā* as the engineered phonetic grid, the *dhātavaḥ* as semantic atoms, the *gaṇāḥ* as the periodic table of reactivity, the *upasargāḥ* and *pratyayāḥ* as the chemistry of synthesis, and the *Aṣṭādhyāyī* as the formal specification. The system is integrated and complete.
...
The named *Śikṣā* texts are compact because they are training manuals, not survey essays. The *Pāṇinīya-Śikṣā*, *Yājñavalkya-Śikṣā*, *Vāsiṣṭhī-Śikṣā*, *Āpiśali-Śikṣā*, and *Bhāradvāja-Śikṣā* belong to that world of disciplined production.`\textsuperscript{[122]}`{=latex} They read like operating instructions for a precision instrument. Points of articulation are enumerated. Vowel durations are quantified in **`{\devanagarifont मात्रा}`{=latex} (*mātrā*)** counts; consonants are fixed at half a *mātrā* — ***`{\devanagarifont अर्धमात्रा}`{=latex} `{\devanagarifont तु}`{=latex} `{\devanagarifont व्यञ्जनम्}`{=latex}***.`\textsuperscript{[123]}`{=latex} Modes of contact between articulators are specified. Consequences of slippage at each point are tabulated. The mechanical character of the texts is the mark of the architecture working through them.
...
This is why the Veda is not a written text first and a recitation second. The recitation is the primary body. Writing is a later reflection. The standard enumeration of the *Vedāṅgas* preserves the priority correctly: *Śikṣā* stands first.`\textsuperscript{[124]}`{=latex} Sound-production precedes the grammar that analyzes the form, the etymology that explains it, the ritual that employs it, and the calendrical discipline that times its use.

Auditure is the foundation. *Śikṣā* trains the body that carries it.

## 15.2 The Eleven *Pāṭhas*

The eleven *pāṭhas* divide into two groups. The five *prakṛti-pāṭhas* are primary recitations. The six *vikṛti-pāṭhas* are modified recitations that apply deeper permutations. Together they form one of the densest preservation codes any civilization has produced.`\textsuperscript{[125]}`{=latex}
...
Vedic recitation survives in multiple geographically separated lineages: the Nambūdiri Brahmins of Kerala; Maharashtra Brahmin lineages; Tamil Nadu and Karnataka lineages; the Banaras and Allahabad lineages of the northern plains; Gujarat and Rajasthan lineages of the western coast; the Kashmir Pandit lineages preserved through displacement.`\textsuperscript{[129]}`{=latex} These communities did not operate as one centralized institution and have no documented contact across most of the cross-lineage matrix. They preserved through parallel *guru-shishya* chains.

The recitations can be compared. Recordings exist. Frits Staal's fieldwork on Nambūdiri recitation in the 1970s placed recitation traditions into audio and film archives.`\textsuperscript{[130]}`{=latex} Later recordings extend the corpus. Where lineages differ, the differences are named, located, and governed by *śākhā* specification. They are not random drift.

The phonetic constants match at the level the architecture predicts: *varṇa* inventory, accent where preserved, *sandhi* execution, metrical structure, and recitational discipline. The lineages become independent witnesses. Their testimony agrees.`\textsuperscript{[131]}`{=latex}

UNESCO recognized Vedic chanting in 2003 as a Masterpiece of the Oral and Intangible Heritage of Humanity.`\textsuperscript{[132]}`{=latex} The recognition is not the authority. The recitation is the authority. But the citation matters because even an external institution had to acknowledge the continuity and precision of the practice in front of it.
...
The priests of progress have been writing this story for seventy years.`\textsuperscript{[135]}`{=latex} One scholar made the retroflex the seminal areal-feature exhibit. Another carried the position into the standard textbook account. A third pushed a Munda-substrate variant when the Dravidian version came under empirical strain. A fourth, from inside the framework, argued that the substrate hypothesis was not supported by the data. The dissent was filed and ignored. The textbook line continued.
...
The empirical record reverses the substrate claim at four measurable levels. Chapter 10 §10.13 develops these findings in full with the figures; this section draws on them as the case-in-chief.
...
The chapter's epigraph states the site directly. The meaning is simple: `{\devanagarifont मूर्धा}`{=latex} (*mūrdhā*) — the head / roof of the mouth — is the articulatory site for `{\devanagarifont ऋ}`{=latex} (*ṛ*), the `{\devanagarifont टु}`{=latex} (*ṭu*) class, `{\devanagarifont र}`{=latex} (*ra*), and `{\devanagarifont ष}`{=latex} (*ṣa*).`\textsuperscript{[137]}`{=latex} But the line does more than state the rule. Its own sound-body performs it. In the operative word `{\devanagarifont ऋटुरषाणां}`{=latex} (*ṛṭuraṣāṇāṃ*), the first vowel is `{\devanagarifont ऋ}`{=latex} (*ṛ*); the consonantal spine is `{\devanagarifont ट}`{=latex}-`{\devanagarifont र}`{=latex}-`{\devanagarifont ष}`{=latex}-`{\devanagarifont ण}`{=latex} (*ṭ-r-ṣ-ṇ*) — retroflex, semi-retroflex, retroflex, retroflex. The mouth must enter the site to say the rule that names the site. Sanskrit's phonetic science does not merely describe the architecture from outside. It makes the speaker perform the architecture while naming it.
...
Sanātan's own primary-source authority shows the opposite of what AIT claims. The **`{\devanagarifont असलायनसुत्त}`{=latex} (*Assalāyana Sutta*)** of the **`{\devanagarifont मज्झिमनिकाय}`{=latex} (*Majjhima Nikāya*)** preserves a dialogue in which the Buddha, responding to Assalāyana on the question of *varṇa* (`{\devanagarifont वर्ण}`{=latex}), observes that the bordering nations of **`{\devanagarifont योन}`{=latex} (*Yona*)** and **`{\devanagarifont कम्बोज}`{=latex} (*Kamboja*)** — the Greek and Iranian-frontier regions immediately outside the dharmic subcontinent — operate with only two varnas, *ārya* and *dāsa*, where the dharmic-Indic frame has the full fourfold *varṇa* system.`\textsuperscript{[143]}`{=latex}
...
That was the force of the moment. Savarkar did not need to utter the word; the audience completed it for him. The monitoring machinery of the British colonial state could not charge the speaker for a word the speaker had not spoken.`\textsuperscript{[144]}`{=latex}`\textsuperscript{[145]}`{=latex}
...
The origin question still admits two speculations. Both begin from the same epistemic position: nobody knows what is upstream of Sanskrit. One speculation admits this. The other hides it.`\textsuperscript{[147]}`{=latex}

Speculation is not the fault. Every human mind speculates at the edge of what it can know. The fault begins when speculation is laundered into certainty, when one civilization's conjecture is called theory and another civilization's self-understanding is demoted to belief.`\textsuperscript{[148]}`{=latex} Where measurement can decide, theory earns its name. Where measurement cannot reach, humility is the only honest register. The asuric move is to claim perfect knowledge precisely where perfect knowledge is unavailable.
...
> akin to Old High German *muoter*, Latin *māter*, Greek *m`{\symbolfont ē}`{=latex}t`{\symbolfont ē}`{=latex}r*, Sanskrit *mātṛ*`\textsuperscript{[149]}`{=latex}
...
And in early-19th-century philology — across the foundational works of the comparative-method machinery as it was being built`\textsuperscript{[154]}`{=latex} — Sanskrit was routinely placed at or near the source position of Indo-European etymological chains.
...
The orthodox account has a stock deflection for the *mother* case: the "nursery word" argument — the universal infant-babble cluster of *mama*-type forms across unrelated languages (Roman Jakobson, "Why 'Mama' and 'Papa'?", 1959), treated as a phonetic universal rather than evidence of cognation.`\textsuperscript{[156]}`{=latex}
...
The standard account (Mayrhofer, *Etymologisches Wörterbuch des Altindoarischen*) pushes Sanskrit *asura-* through Indo-Iranian **\*asura-** toward a *contested* PIE **\*h`{\symbolfont ₂}`{=latex}nsu-** meaning "life force" or "lord."`\textsuperscript{[159]}`{=latex}
...
> *"The root is suppletive — although `{\devanagarifont पश्यति}`{=latex} (paśyati) derives from Proto-Indo-European \*spe`{\symbolfont ḱ}`{=latex}-, the remainder of the morphological paradigm is derived from Proto-Indo-European \*der`{\symbolfont ḱ}`{=latex}-."*`\textsuperscript{[160]}`{=latex}
...
Old Persian supplies the contrast. The Behistun inscription, transliterated into Devanagari, can be read today by a fluent student of Sanskrit.`\textsuperscript{[163]}`{=latex} The grammar, the dhātu structures, much of the vocabulary — all of it sits within recognizable distance of the language a modern Indian student is trained in. A fluent modern speaker of Persian, presented with the same text, does not have the same experience. The two languages were close kin in their attested forms. They have ended up in radically different relationships to their own past.
...
The calibrant framework has three phases.`\textsuperscript{[169]}`{=latex}
...
The dates are the spine. **Franz Bopp** (1791–1867), trained at Paris under Antoine-Léonard de Chézy and at London under Henry Thomas Colebrooke, published *Über das Conjugationssystem der Sanskritsprache in Vergleichung mit jenem der griechischen, lateinischen, persischen und germanischen Sprache* in 1816.`\textsuperscript{[177]}`{=latex} The work treats Sanskrit verbal morphology as the structural anchor against which Greek, Latin, Persian, and Germanic verbal systems are compared. Bopp's *Vergleichende Grammatik der Sanskrit-, Send-, Armenischen-, Griechischen-, Lateinischen-, Litauischen-, Altslavischen-, Gothischen- und Deutschen* (1833–1852) carried the comparison across the family. Sanskrit was still the anchor; the comparative method was being built around it.
...
This appendix names the category the foundational orthodoxy declined to name: ***audiography***, the engineered visual capture of articulated sound.

Chapter 8 §8.5 introduced the **`{\devanagarifont अक्षर}`{=latex} (*akṣara*)** as the audiograph — the imperishable sound-unit made visible. Chapter 13 §13.3 named the Brāhmī-from-Aramaic claim as heroic erasure at the script level. Appendix Part 3 develops the prosecution.

## 3.1 The Parallel

The framing of Brāhmī as a script *adapted from Aramaic* is structurally identical to the framing of Sanskrit as a language *descended from Proto-Indo-European*. Both moves identify an Indic engineered system. Both locate its origin outside India. Both credit India with downstream adaptation, refinement, and elegance. Both deny India authorship of the architecture. The Indic civilization is allowed to decorate what someone else built. It is not allowed to build.

Aramaic is real and PIE is not. PIE is a reconstructed projection with no inscription, no speaker, no community, no text — a starred form that exists only inside the textual framework that posits it. Aramaic is an attested script with surviving inscriptions and historical communities. The difference is real, but it does not save the move. The operation is structurally identical: foreground the alleged source, recede the Indic engineering, call the result adaptation. The fact that one source is real and one reconstructed only changes the orthodox account's level of comfort with the claim.

The Aramaic-as-Brāhmī-source case is harder to dismantle because Aramaic exists and can be pointed to. The PIE-as-Sanskrit-source case is easier to dismantle because the source itself can be shown to be a projection. The harder case awaits its prosecutor. The easier case is what the main chapters do.

This appendix prosecutes the ***foundational orthodoxy*** — the doctrinal stratum Chapter 3 §3.2 names alongside the *progressive orthodoxy*. The foundational orthodoxy defends *engineered writing began in the Near-Eastern-to-European corridor*: Sumerian cuneiform, Egyptian hieroglyphs, Phoenician alphabet, Greek extension, Latin script. The book's main chapters prosecute the progressive orthodoxy that obscures the engineered Sanskrit thesis in the deep past. This appendix prosecutes the foundational orthodoxy that obscures the *varṇamālā*'s engineering outside the privileged corridor. The two orthodoxies are coordinated; the engineering of the **`{\devanagarifont वर्णमाला}`{=latex} (*varṇamālā*)** is the load-bearing target both coordinate to obscure.

## 3.2 The "Brilliantly Adapted" Move

The standard account does not claim Brāhmī was crudely copied from Aramaic. It claims something more careful: Brāhmī was adapted from Aramaic *brilliantly*. An unnamed Indian adapter, the account holds, took the Aramaic consonantal-alphabet template — twenty-two consonants, right-to-left, no systematic encoding of place of articulation — and through inventive genius transformed it into the Indic *abugida*: roughly forty-eight characters arranged by **`{\devanagarifont स्थान}`{=latex} (*sthāna*)** and **`{\devanagarifont प्रयत्न}`{=latex} (*prayatna*)**, vowels as diacritic modifications, written left-to-right, the *varga* matrix laid out in phonetically-principled order.

The adapter receives praise. The architecture disappears.

The praise is the mechanism. By elevating the adaptation as *brilliant*, the orthodox account credits an unnamed Indic figure with creative ingenuity *and* anchors the script's origin outside India. The brilliance gets to belong to India; the engineered architecture the script renders does not. The unnamed adapter is celebrated for *adapting* — transforming a borrowed template — and is *not* celebrated for what they would have to be celebrated for if the architecture were original to India: the design of the *varṇamālā* itself, the mapping of the mouth, the construction of the multi-axis phonetic specification.

This is the **heroic erasure** move Chapter 13 §13.3 named and Chapter 8 §8.6 established as a standing convention. The *church of progress* elevates a downstream operator and erases the engineering the operator was supposedly working within. Pāṇini becomes the brilliant codifier; the engineered language disappears. The *Prātiśākhya* authors become careful phoneticians; the engineered sound-system disappears. The imagined Brāhmī adapter becomes brilliant; the *varṇamālā* disappears.
...
That is the archive of survival, not the archive of invention. Stone preserves what authority wanted preserved. The texts are apex speech carved into durable matter. They are not evidence that writing began with the apex — only that the apex had the resources to make writing survive.

The same logic holds elsewhere, and the structure becomes sharper. Hammurabi's stele. Darius's Behistun inscription. The pyramids of Egypt make the structure exact: monumental tombs for the ultra-powerful, hieroglyphic accounts sealed into stone, the apex preserved in the architectural form built to preserve it. The pyramids are not the archive of how Egypt wrote. They are the archive of how Egypt buried its pharaohs — and the writing survived because the tomb did. The ***asuric pyramid*** Chapter 3 §3.6 names is not only a metaphor here. It is the literal shape stone preserves best.

A distributed civilization leaves a different archive. Notes, teaching aids, accounts, letters, mnemonic prompts, working drafts, students' exercises, household records, market communication — these live on palm leaf, birch bark, wood, cloth, temporary tablets. In the Indian climate, that archive dies. The absence of surviving notebooks is not evidence that no one wrote notes. It is evidence that stone survives and palm leaf rots.

This matters because **`{\devanagarifont लीपि}`{=latex} (*lipi*)** was not the civilizational calibrant. Chapter 13 §13.3 disqualified writing for the *sāṃskṛtika* bucket; the chronology objection is the foundational orthodoxy's last move on the script question once that disqualification has landed. The calibrant was sound: the *varṇamālā*, the eleven **`{\devanagarifont पाठाः}`{=latex} (*pāṭhāḥ*)**, the **`{\devanagarifont प्रातिशाख्य}`{=latex} (*Prātiśākhya*)** discipline, **`{\devanagarifont शिक्षा}`{=latex} (*Śikṣā*)**, **`{\devanagarifont छन्दस्}`{=latex} (*Chandas*)**, **`{\devanagarifont व्याकरणम्}`{=latex} (*Vyākaraṇam*)**, and the **`{\devanagarifont गुरुशिष्यपरम्परा}`{=latex} (*guru-shishya paramparā*)**. Writing could serve the system without carrying the system. A civilization that placed preservation in the mouth and ear had no need to make writing its primary archive.

The deeper invention is not the visible mark. It is the ordered sound-system the mark renders. Once the *varṇamālā* exists, writing the **`{\devanagarifont अक्षराः}`{=latex} (*akṣaras*)** is procedural in the same way writing numerals is procedural once place value exists. The hard engineering is the system. The marks are the interface.

The first durable Brāhmī inscription dates the surviving interface. It does not date the *varṇamālā*. It does not date the mapping of the mouth. It does not date the invention of the *akṣara* as the imperishable sound-unit made visible.
...
The Aramaic script — like its parent Phoenician — is a consonantal alphabet. Each glyph represents a consonant. The letter order (*alep*, *bet*, *gimel*, *dalet*, ...) is the residue of accumulated scribal practice in the Near East; it carries no acoustic logic, no place-of-articulation principle, no manner-of-articulation principle. Vowels are supplied by the reader from knowledge of the language. Aramaic is a writing technology. It is not a phonetic specification.

Brāhmī implements the same engineered architecture as Devanāgarī — the same *varṇamālā*, the same precise encoding of pronunciation; only the glyph shapes differ.`\textsuperscript{[181]}`{=latex} The *varga* matrix appears in Brāhmī's pedagogical ordering of consonants: five rows (velar, palatal, retroflex, dental, labial) traverse the five places of articulation from back to front of the mouth; within each row, five manners of articulation (unvoiced unaspirated, unvoiced aspirated, voiced unaspirated, voiced aspirated, nasal) follow a consistent sequence. The vowel-diacritic system distinguishes inherent-vowel consonants from consonants modified by long *ā*, short *i*, long *ī*, short *u*, long *ū*, and the diphthongs *e*, *ai*, *o*, *au* — each vowel attached as a positional modification of the consonant glyph rather than as a separate letter. The **`{\devanagarifont अयोगवाह}`{=latex} (*ayogavāha*)** — **`{\devanagarifont अनुस्वार}`{=latex} (*anusvāra*)** and **`{\devanagarifont विसर्ग}`{=latex} (*visarga*)** — represent breath-gesture diacritics, distinct from both consonants and vowels.

None of this is in Aramaic. The *varga* matrix is not in Aramaic. The *sthāna* / *prayatna* organization is not in Aramaic. The vowel-diacritic system is not in Aramaic. The *ayogavāha* category is not in Aramaic. The encoded phonetic content of Brāhmī has no source in Aramaic, because the Aramaic script does not encode that content at all.

What adaptation of Aramaic could plausibly carry forward is glyph-shape resemblance at the level of a few individual letters. Some Brāhmī letters look broadly similar to some Aramaic letters. Even granting this, what it could establish is glyph-borrowing — surface forms of some letters — not the encoding system the script implements. The encoding system could not be borrowed from a source that does not have it. The system is in the *varṇamālā*. The *varṇamālā* has no Aramaic equivalent.

The foundational orthodoxy's claim reduces to: a few glyph-shapes may show contact influence. That is a much smaller claim than *Brāhmī derives from Aramaic*.

## 3.5 Audiography — The Term the Foundational Orthodoxy Did Not Coin

Orthodox typology names six categories: *logographic*, *syllabary*, *alphabet*, *abjad*, *abugida*, *featural*. The typology classifies scripts by surface property — what signs represent. It does not classify scripts by what they are engineered to do.
...
The *varṇamālā*, rendered as Brāhmī and its descendants, is the engineered capture of *audible* reality as a stable visual artifact. The same operation as photography, performed on a different physical phenomenon, many thousands of years earlier, at far higher fidelity than any subsequent writing system has matched. Photography captures three rough channels of visible light (RGB). The *varṇamālā* captures the full articulation matrix of the human mouth — five places of articulation × five manners of articulation × inherent-and-modified vowel set × the *ayogavāha* breath-gestures — every dimension on which a speech sound can vary, encoded with positional precision in the glyph.

The church of progress did not coin the parallel term. There is no entry in any standard reference for *audiography* in this sense. The achievement was not given a name in its own vocabulary.

The coinage lands here. ***Audiography*** — Latin *audi-* (hear) + Greek *-graphia* (writing), the same hybrid pattern as *television* or *automobile* — names the engineered visual rendering of articulated sound that the *varṇamālā* specifies and that Brāhmī, Devanāgarī, and the other Indic scripts implement. An ***audiograph*** is one ***akṣara*** — one engineered sound-unit made visible, with the *varṇa*-classification (the *sthāna* / *prayatna* engineering Chapter 8 §8.5 documents) encoded in the glyph's position within the *varga* matrix. ***Audiography*** is the system. An ***audiographer*** is its practitioner — the *Śikṣā* and *Prātiśākhya* *ācāryas* who carry the audiographic specification across generations.

*Akṣara*, the Sanskrit name for the unit, literally means *that which does not decay* — *a-* (privative) + √kṣar (to flow, to perish). Sanskrit did not name the unit a letter, a mark, or a written scratch. It named it the imperishable. Photography captures visible reality into a medium that decays (silver halide breaks down; paper yellows; pixels rot). Audiography captures audible reality into a unit whose name asserts non-decay. The appendix title makes the claim explicit: the audiograph is *imperishable*.
...
| Sound | articulated mouth-gestures of the speaker | *sthāna* + *prayatna* engineering rendered as *varga*-matrix | an audiograph (the *akṣara*-glyph) | ***audiography*** | audiographer (*ācārya* of *Śikṣā* / *Prātiśākhya*) |
...
The coinage pairs with ***Auditure*** (Chapter 13 §13.4; Chapter 14 §§14.1–14.2): two sound-anchored engineering achievements operating in complementary directions. *Auditure* names the speech-hearing preservation method that holds the Vedic corpus in its engineered form across thousands of years without a perishable medium — sound preserved as sound, *śruti*, what is heard. *Audiography* names the engineered visual rendering of that same sound when writing is needed — sound captured as image, the *varṇamālā* made visible. *Auditure* is the primary engineering: the civilization refused the written medium for its *sāṃskṛtika* content and built the speech-hearing chain. *Audiography* is the secondary engineering: when writing is needed for derived purposes, the engineering of the *varṇamālā* renders sound with precision, never as scripture and never as the locus of the core content.

The foundational orthodoxy has *scripture* in its vocabulary because its civilization placed its sacred content on the written word. It does not have *Auditure* because admitting the term would mean admitting another civilization refused that placement and engineered something more sophisticated. The foundational orthodoxy has *photography* because Europe engineered the capture of light. It does not have *audiography* because admitting the term would mean admitting India engineered the capture of sound first, at higher resolution, along more channels, and called it the *varṇamālā*.
...
King Sejong the Great of Joseon Korea engineered Hangul in 1443. Sejong documented the engineering principle himself in the *Hunminjeongeum* preface: consonant shapes depict the articulators (tongue position, lip position, throat configuration); vowel shapes encode tongue height and rounding. The script is audiographic by Sejong's own statement of design — articulated sound rendered as glyph, mapped systematically by mouth-geometry.

The ***priests of progress*** celebrate this engineering openly. **Geoffrey Sampson** coined ***featural*** in *Writing Systems: A Linguistic Introduction* (1985) specifically to name what Hangul does, calling Hangul *"perhaps the most scientific writing system ever devised."* UNESCO created the King Sejong Literacy Prize in 1989, named for him. South Korea observes a national Hangul Day. Orthodox typology added an entire category to house Hangul. The named inventor is celebrated; the date is recorded to the year; the engineering documentation is treated as engineering documentation; the typological vocabulary was coined to capture what Sejong did.

The same priests of progress apply *abugida* — borrowed from Ge'ez — to the *varṇamālā* and its descendants. The *varṇamālā*'s engineering is anonymized; the date is dissolved into pre-history; the *Prātiśākhya* and *Śikṣā* documentation disciplines are treated as descriptive linguistics rather than engineering specification; the consonant-by-place organization is treated as taxonomic curiosity rather than systematic encoding of pronunciation as glyph-position.

Hangul is the proof that the church of progress *can* recognize audiographic engineering when the politics permit. It created vocabulary, awards, and typological categories to celebrate one engineered audiographic script. It refused to create any of these for the other, much larger family — the family that engineered the category in the first place.

The difference is one of distance from the foundational civilizational claim. Korean Hangul, engineered in 1443, sits comfortably downstream of the Near-Eastern-to-European corridor. Celebrating Sejong adds an Asian achievement to the record of human ingenuity without dislocating the foundational claim about *who invented writing*. The church of progress can be generous because generosity costs it nothing.

The *varṇamālā*, engineered in the Indic civilization many thousands of years before the foundational corridor begins, is differently positioned. Acknowledging it as engineered audiographic writing would place the original engineered capture of articulated sound at a time and in a civilization that dislocate the foundational claim. The ***asuric pyramid*** cannot afford the acknowledgment. So the engineering is erased — the origin anonymized, the date dissolved, the documentation reduced to taxonomic linguistics, the typological vocabulary withheld. The church of progress recognizes audiographic engineering when recognition costs it nothing, and erases audiographic engineering when recognition would cost it the foundational civilizational claim.

The scale of the erasure is the second polemic move. The script family orthodox typology classifies as *abugida* serves roughly 1.5 billion users across South Asia, Tibet, and Southeast Asia — most of the literate population east of the Indus and west of the Pacific, with the Sinosphere as the principal exception. Korean Hangul, classified under *featural*, adds another eighty million. The audiographic family is the writing-system architecture of close to a third of the world's literate population. The orthodox classification — *abugida* for the Indic family, *abugida* again for the Pallava-derived Southeast Asian family, *featural* for Hangul — labels what is one engineering achievement, with two transmission lineages and one independent reinvention, using three categories that name surface properties rather than engineering content. The unifying category — *audiography* — was the one term the church of progress declined to coin.
...
The miscategorization is not an accident of historical scholarship that better data will correct. It is the structural move by which orthodox typology refuses to acknowledge that one engineering category covers close to a third of the world's writing.
...
The Hebrew Bible names the written word as the medium of the covenant; the Torah is given in writing on Sinai. The Christian gospel of John opens with *the Word was God* — the *logos*. The Qur`{\symbolfont ʾ}`{=latex}ān's first revelation to Muḥammad begins with *iqra`{\symbolfont ʾ}`{=latex}* — *read, recite*. All three original Abrahamic religions are religions of the written word. All three locate their foundational moment in a textual act.

The ***fourth Abrahamic religion*** — the asuric formation Chapter 3 §3.6 names — inherits the same orientation in secular form. Its foundational orthodoxy makes the modern academy's history of civilization a history of writing: civilizational beginning dated to the beginning of writing; the development of writing systems treated as the key index of civilizational origin. The Sumerian invention of cuneiform, the Egyptian hieroglyphic system, the Phoenician alphabet, the Greek extension of Phoenician to include vowel letters, the Latin script — these are the foundational moments the foundational orthodoxy names. The *engineering of writing* is located inside the Near-Eastern-to-European corridor; later scripts including Brāhmī are treated as adaptations of templates that originated there. The *progressive orthodoxy* operates in coordination, treating later-along-the-corridor as more-advanced; the two doctrinal strata together complete the architecture this appendix prosecutes.
...
The Brāhmī-from-Aramaic narrative is not random. It is a defense of the foundational civilizational claim Chapter 3 §3.6 names — the script-level analogue of the Sanskrit-from-PIE narrative. Both do the same asuric work in different media. The book's main chapters dismantle the second; this appendix names the first as a parallel target.

## 3.8 An Invitation

*Atomic Sanskrit* prosecutes the language-engineering case and dismantles it. The script-engineering case is a sibling project — the same operation in a different medium — and deserves the same dismantling. This appendix does not take it on.

The project, if someone wants to take it up, has several components. Comparative study of the Brāhmī inscriptional record alongside the contemporary Aramaic, Kharoṣṭhī, and Phoenician inscriptional records, with attention to encoding-system differences rather than glyph-shape comparisons. Engagement with the *Prātiśākhya* and *Śikṣā* literature as documented phonetic-engineering discipline — the texts that demonstrate Brāhmī's encoding system is older than the script that renders it. Comparative analysis of the historical claims around Aramaic-Brāhmī contact dating: how firmly do the standard datings rest, and what would changing them require? Engagement with the scriptural-history scholarship on Abrahamic-substrate claims to the invention of writing. An account of Brāhmī's encoding system — the *varga* matrix, the vowel-diacritic system, the *ayogavāha* — as the genuine engineering content the script renders, with the source-script question reframed as a glyph-shape question rather than a system question.

The project requires some combination of: Sanskrit fluency sufficient to read the *Prātiśākhya* and *Śikṣā* texts in the original; training in epigraphy and the history of writing systems; familiarity with the comparative scholarship on Aramaic, Phoenician, and the Near-Eastern alphabetic family; willingness to read the Abrahamic-substrate scholarship on the *invention of writing* as a claim to be tested rather than as background fact.

The architecture is waiting for the account. The philological apparatus has examined the interface — the visible glyphs of Brāhmī. It has not decoded the system the interface renders. The same engineering thesis the main chapters develop for Sanskrit applies, with appropriate substitution, to Brāhmī: the script is the *varṇamālā* made visible; the *varṇamālā* is the engineering; the engineering predates the visible interface; and the engineering is Indic.
...
> - **Place-level inner-position activity** — *mūrdhanya* (`{\devanagarifont मूर्धन्य}`{=latex}) class at 32.5%; load-bearing for the retroflex-as-architecturally-central argument in Ch 10 §10.13 and Ch 16 §16.3.
...
> - **The *ṛ* (`{\devanagarifont ऋ}`{=latex}) / *ra* (`{\devanagarifont र}`{=latex}) retroflex bridge** — cross-inventory coupling at the *mūrdhanya* site. The appendix has the raw *ṛ*-vowel-frequency data at §5.7 but not the bridge analysis Ch 10 §10.13 and Ch 16 §16.3 carry.
...
|---|---:|---:|---|---|
| 2 (minimum) | 236 | 10.9% | CV, VC | *kṛ* `{\devanagarifont कृ}`{=latex}, *bhū* `{\devanagarifont भू}`{=latex}, *dā* `{\devanagarifont दा}`{=latex}, *jñā* `{\devanagarifont ज्ञा}`{=latex}, *pā* `{\devanagarifont पा}`{=latex}, *ji* `{\devanagarifont जि}`{=latex}, *hu* `{\devanagarifont हु}`{=latex}, *ad* `{\devanagarifont अद्}`{=latex} |
| 3 (modal) | 1,051 | 48.5% | CVC, CCV, VCV | *gam* `{\devanagarifont गम्}`{=latex}, *pat* `{\devanagarifont पत्}`{=latex}, *vac* `{\devanagarifont वच्}`{=latex}, *yam* `{\devanagarifont यम्}`{=latex}, *labh* `{\devanagarifont लभ्}`{=latex}, *sthā* `{\devanagarifont स्था}`{=latex} |
| 4 | 676 | 31.2% | CCVC, CVCC, CVCV | *svap* `{\devanagarifont स्वप्}`{=latex}, *kalp* `{\devanagarifont कल्प्}`{=latex}, *jval* `{\devanagarifont ज्वल्}`{=latex}, *bandh* `{\devanagarifont बन्ध्}`{=latex}, *granth* `{\devanagarifont ग्रन्थ्}`{=latex} |
| 5 (threshold) | 156 | 7.2% | CCVCC, CVCVC, CCVCV | *spand* `{\devanagarifont स्पन्द्}`{=latex}, *skand* `{\devanagarifont स्कन्द्}`{=latex} |
| 6+ (cliff) | 42 | 1.9% | — | — |
...
The *ṛ* signal later becomes the bridge to `{\devanagarifont र}`{=latex} (*ra*): vowel and consonant coupled at the retroflex-adjacent site (Ch 10 §10.13; Ch 16 §16.3 develop the bridge). The raw appendix data already shows the load-bearing fact. Sanskrit did not treat *ṛ* as marginal. It made *ṛ* architecturally central.
...
The apparatus assigns relative dates to Sanskrit texts partly through linguistic features. A text with more "archaic" features is earlier. A text with fewer "archaic" features is later. The sequence is then used to prove the language changed from archaic to later. The conclusion is folded into the method that produced the sequence.`\textsuperscript{[183]}`{=latex}
...
The bond comes first. Usage comes after. *Śāstra* regulates usage. It does not manufacture the bond.`\textsuperscript{[185]}`{=latex}
...
That is the audit the codification story requires.`\textsuperscript{[186]}`{=latex}
...
The book's title — ***Atomic Sanskrit*** — names this thesis. The full stack is: *varṇa* / particle `{\symbolfont →}`{=latex} *dhātuḥ* / atom `{\symbolfont →}`{=latex} *śabda* / molecule, with *upasarga* + *pratyaya* as the bonding chemistry and *racanā* as the structural scaffold.
...
**Book-coined English.** The engineered visual capture of articulated sound; the rendering of a *varṇa* via the *akṣara*-and-*lipi* apparatus. Coined for Appendix Part 3 (*The Imperishable Audiograph*); deployed in Chapters 8, 9, and 13.
...
**Standard, book-reframed.** Pāṇini's foundational grammar — the *Eight-Chapter* treatise. The canonical *vyākaraṇa* text. The orthodoxy reads it as the codification of a previously-drifting language; the book reframes it as the finest *decoding* of an architecture already engineered into the *Vedas*. Cited across Chapters 4, 6, 8, 10, and Appendix Part 7; the codified `{\symbolfont →}`{=latex} decoded reframing is load-bearing for the standing polemic phrase (*Sanskrit was engineered. Encoded in the Vedas. Decoded by many. Pāṇini's decoding is the finest*).
...
**[109] `mendeleev-1869-table`.**  **Short:** [TBD: Citation+Context]
...
**[110] `path-c-corpus-attested-valency`.**  **Short:** [TBD: Mini-essay]
...
**[111] `path-c-corpus-attested-valency`.**  **Short:** [TBD: Mini-essay]

**Deployments:** Chapter 11 §11.2 ¶ — methodology disclosure for the Path C operational definition; Chapter 11 §11.3 ¶ — anchors the 67.6% tier-share number.

Path C operationalizes a *dhātu*'s reactivity as **corpus-attested combinatorial valency** — the count of distinct (*upasarga*, *pratyaya-class*) pairs that produce attested forms in the reference Sanskrit corpus. The reference corpus is the Digital Corpus of Sanskrit (Hellwig, 2010–2024; CC BY 4.0), accessed through the `OliverHellwig/sanskrit` GitHub mirror at the 2026-05-18 commit; 15,900 CoNLL-U files; 1,007,361 VERB-tagged tokens; 3,839 unique bare *dhātavaḥ* attested across the corpus. *Pratyaya*-class is normalized as a coarse approximation of the Pāṇinian *pratyaya* space — finite forms as the tuple (Tense, Mood, Voice) e.g. *fin:Pres+Ind+Act*; non-finite forms as the VerbForm value e.g. *nfin:Part*. Path A correlation (matched MW subset of 121 *dhātavaḥ*): Spearman ρ = +0.6647. The full reproducibility bundle — scripts, derived data, methodology, sensitivity tests — lives in `analysis/ganah/` with synthesis in `FINDINGS.md`. See dossier for sub-corpus extraction details, the Bhagavadgītā-not-in-DCS substitution note, and the Rāmāyaṇa-as-smriti-epic decision.

**[112] `varga-column-as-engineering-axis`.**  **Short:** [TBD: Mini-essay]
...
**[113] `cross-gana-column-distribution`.**  **Short:** [TBD: Mini-essay]
...
**[114] `inherent-vowel-secondary-axis`.**  **Short:** [TBD: Mini-essay]
...
**[115] `cross-corpus-invariance`.**  **Short:** [TBD: Mini-essay]
...
**[148] `speculation-theory-asuric-certainty`.**  The chapter is not attacking speculation. It is attacking the asuric conversion of speculation into authorized certainty: one civilization's conjecture becomes "theory," while the civilization under study has its categories demoted to "belief."

**[149] `pre-pie-dictionary-shift`.**  The displacement of Sanskrit from the terminus of Indo-European etymological chains to one daughter alongside others (with PIE inserted as reconstructed terminus) is a two-century arc — Bopp 1816 (Sanskrit as ancestor) `{\symbolfont →}`{=latex} Schleicher 1861 (common source distinct from Sanskrit) `{\symbolfont →}`{=latex} mid-20c (academic references) `{\symbolfont →}`{=latex} 2000s (popular references); *Merriam-Webster's Collegiate 10th* (1993) still showed Sanskrit-at-terminus for *mother*. See Expanded Endnotes for the staged chronology.
...
**[178] `schleicher-1861-compendium`.**  ***August Schleicher*** (1821–1868), ***Compendium der vergleichenden Grammatik der indogermanischen Sprachen*** (Hermann Böhlau, Weimar, 1861; 2nd ed. 1866) — *the inversion moment*. The work introduces the ***Stammbaumtheorie*** (family-tree theory) explicitly: a single common ancestor *distinct from any attested language* (the *Ursprache*) branching into daughter Indo-European languages; Sanskrit, previously the anchor, is demoted to *one daughter language among siblings*. The asterisk-before-reconstructed-form convention — Schleicher's notational invention — gives the machinery a typographic mark for *forms posited but not attested*. Schleicher's 1863 pamphlet *Die Darwinsche Theorie und die Sprachwissenschaft* made the biological-organic framing explicit. *The bake* operating at its central moment.

**[179] `schleicher-1868-fable`.**  August Schleicher, "Eine fabel in indogermanischer ursprache," *Beiträge zur vergleichenden Sprachforschung* 5 (1868): 206–208 — the first complete text composed entirely in reconstructed PIE (*Avis akvāsas ka*), every word marked with the asterisk convention Schleicher had introduced in his 1861 *Compendium*; the fable has been rewritten by Hirt (1939), Lehmann-Zgusta (1979), and Kortlandt (2007) on incompatible reconstructions.

**[180] `brugmann-grundriss-1886`.**  ***Karl Brugmann*** (1849–1919), of the Leipzig ***Junggrammatiker*** (Neogrammarian) school, ***Grundriss der vergleichenden Grammatik der indogermanischen Sprachen*** (Karl J. Trübner, Strasbourg, 1886–1893; revised 1897–1916, with Berthold Delbrück's syntactic volumes) — *the cementing moment*. The work systematized the comparative method around the ***Ausnahmslosigkeit der Lautgesetze*** doctrine (sound laws operate without exception, licensing reverse-engineering) and consolidated a comprehensive reconstructed PIE — phonology, morphology, lexicon — on the basis of comparative-method work. The reconstructed ecosystem operated as a self-validating system in which methodology and output were mutually reinforcing. *The bake's industrial-scale production line*.

**[181] `brahmi-devanagari-structural-identity`.**  Brāhmī (`{\devanagarifont ब्राह्मी}`{=latex}) and Devanāgarī (`{\devanagarifont देवनागरी}`{=latex}) are structurally identical at the encoding-system level (abugida structure, *varṇamālā* (`{\devanagarifont वर्णमाला}`{=latex}) inventory, *sthāna* (`{\devanagarifont स्थान}`{=latex}) / *prayatna* (`{\devanagarifont प्रयत्न}`{=latex}) organization, conjunct formation) and differ only at the surface (glyph shapes, *śirorekhā* (`{\devanagarifont शिरोरेखा}`{=latex}), stroke ductus, numerals); the architecture both Indic scripts share has no equivalent in Aramaic, so glyph-shape borrowing cannot produce the engineered specification.

**[182] `productivity-inversion-natural-language`.**  Natural languages display the *frequency-irregularity correlation* — high-frequency forms tend toward suppletive idiosyncrasy (English *be / have / do*; Latin *esse / ire / ferre*; Greek *eimi / oida / ph`{\symbolfont ē}`{=latex}mi*); the correlation is one of the most-replicated findings in natural-language morphology, explained by high-frequency forms being mastered as wholes and resisting analogical regularization. Sanskrit shows the *opposite* pattern: the most-productive *dhātus* (*kṛ, bhū, gam, sthā, dā, dhā, jñā, hṛ, nī*) are the most structurally *minimal* (CV / CVC) *and* the most paradigmatically *regular*. Empirical signature in the *Dhātupāṭha* curated sample: Spearman ρ = −0.485 between productivity and particle count; CV pattern mean productivity 2.9× the CCVCC pattern's; top-20 productivity ranks dominated by minimal-particle patterns. Both axes are engineered at once.

**[183] `vedic-classical-circular-dating`.**  Appendix Part 7 names the circular method behind the drift story: linguistic features are used to arrange Sanskrit texts into an assumed archaic-to-later sequence, and the resulting sequence is then cited as proof that Sanskrit drifted from Vedic to Classical.

**[184] `panini-cites-pre-paninian-grammarians`.**  Pāṇini's *Aṣṭādhyāyī* (`{\devanagarifont अष्टाध्यायी}`{=latex}) cites by name a roster of pre-Pāṇinian grammarians — ***Āpiśali*** (`{\devanagarifont आपिशलि}`{=latex}, 6.1.92), ***Kāśyapa*** (`{\devanagarifont काश्यप}`{=latex}, 1.2.25, 8.4.67), ***Gārgya*** (`{\devanagarifont गार्ग्य}`{=latex}, 7.3.99, 8.3.20), ***Gālava*** (`{\devanagarifont गालव}`{=latex}, 6.3.61, 7.1.74, 8.4.67), ***Cākravarmaṇa*** (`{\devanagarifont चाक्रवर्मण}`{=latex}, 6.1.130), ***Bhāradvāja*** (`{\devanagarifont भारद्वाज}`{=latex}, 7.2.63), ***Saunaga*** (`{\devanagarifont सौनाग}`{=latex}), ***Senaka*** (`{\devanagarifont सेनक}`{=latex}, 5.4.112), and ***Sphoṭāyana*** (`{\devanagarifont स्फोटायन}`{=latex}, 6.1.123) — each citation recording where Pāṇini ratifies, modifies, or preserves alternative analyses; the *Aṣṭādhyāyī* is not the founding moment of Sanskrit grammar but the finest decoding of a discipline with substantial prior depth.

**[185] `siddhe-shabdarthasambandhe-mbh`.**  Patañjali's *Mahābhāṣya* (`{\devanagarifont महाभाष्य}`{=latex}) opens with ***siddhe śabdārthasambandhe*** (`{\devanagarifont सिद्धे}`{=latex} `{\devanagarifont शब्दार्थसम्बन्धे}`{=latex}) inside the fuller formulation ***siddhe śabdārthasambandhe lokato 'rthaprayukte śabdaprayoge śāstreṇa dharmaniyamaḥ*** (`{\devanagarifont सिद्धे}`{=latex} `{\devanagarifont शब्दार्थसम्बन्धे}`{=latex} `{\devanagarifont लोकतोऽर्थप्रयुक्ते}`{=latex} `{\devanagarifont शब्दप्रयोगे}`{=latex} `{\devanagarifont शास्त्रेण}`{=latex} `{\devanagarifont धर्मनियमः}`{=latex}). The sequence anchors Chapter 4's argument: the word-meaning bond is *siddha* (`{\devanagarifont सिद्ध}`{=latex}, already established), worldly usage follows, and *śāstra* regulates correct usage. It does not manufacture the bond. See endnote `patanjali-siddhe-shabdarthasambandhe` for the full Kielhorn-edition citation and the parallel Preface deployment.

**[186] `calibration-audit-gap`.**  The codification story requires an empirical audit it has not supplied: pre-Pāṇinian and para-Pāṇinian Sanskrit witnesses should be tested against Pāṇini's documented architecture after separating mode, meter, recension, optionality, domain, and actual drift.

**[187] `mitanni-indic-technical-vocabulary`.**  Mitanni Indic vocabulary matters here only as an external stability anchor: the attested forms look like technical transmission from an already functioning Indic system, not like a language waiting to be stabilized by later Pāṇinian codification.
