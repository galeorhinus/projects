...
This volume is the *Source and Reference Companion* to the printed book *Atomic Sanskrit: The Radiant, Calibrant, and Fractal Architecture of Sanātan*. The printed book carries one-sentence endnotes — citation anchors, named references, the load-bearing sentence the printed-book reader needs at the point of citation. The companion carries the full long-form: technical appendices, complete bibliographic citations, primary-source quotes, verification trails, source-history discussions, structural-significance analysis. The two volumes share a single source. The printed book's endnote at *"See expanded endnote for X"* points here.
...
Each Pāṇinian *dhātu* citation form carries **`{\devanagarifont अनुबन्ध}`{=latex} (*anubandha*)** sounds — phonemes present in the citation that are not part of the underlying *dhātu*, used to signal grammatical properties the **`{\devanagarifont अष्टाध्यायी}`{=latex} (*Aṣṭādhyāyī*)** applies later in derivation. The **`{\devanagarifont इत्संज्ञा}`{=latex} (*it-saṃjñā*)** rules of *Aṣṭādhyāyī* 1.3.2–1.3.9 specify which phonemes are *anubandhas*. Three rules apply to *dhātavaḥ* and are implemented in every analysis script:
...
- **Cluster-joiner specialist class** — new §6.4 with the 6-atom specialist table (`{\devanagarifont र}`{=latex}, `{\devanagarifont य}`{=latex}, `{\devanagarifont फ}`{=latex}, `{\devanagarifont न}`{=latex}, `{\devanagarifont ल}`{=latex}, `{\devanagarifont व}`{=latex} at inner/total ≥ 25%) and the 73% second-in-cluster headline (top 5: `{\devanagarifont र}`{=latex}, `{\devanagarifont व}`{=latex}, `{\devanagarifont ल}`{=latex}, `{\devanagarifont ष}`{=latex}, `{\devanagarifont य}`{=latex}).
...
- **CVC place × place matrix** — new content in §6.9; carries both OCP visualization and *mūrdhanya* C`{\symbolfont ₂}`{=latex} asymmetry on one figure.
...
- **Particle-count distribution** — preserved at 11.6% / 58.2% / 25.6% / 3.6% / 0.5% (matches Ch 10 §10.7 canonical statement); §6.7 now slimmed and frames its unique contribution as the falsification narrative (48.5% `{\symbolfont →}`{=latex} 58.2% under corrected anubandha-stripping).
- ***Juhotyādi* C4 share** — 31.8% (pre-correction) `{\symbolfont →}`{=latex} 33.3% (post-correction inventory) `{\symbolfont →}`{=latex} 42.9% (Path C corpus-restricted). All three numbers and the methodological narrative now appear in §6.11.
- **Scaffold count** — 69 (pre-cleanup) `{\symbolfont →}`{=latex} 47 (post-cleanup, matching Ch 10 §10.8). Long-tail count: 59 `{\symbolfont →}`{=latex} 37. §6.10 re-stratified: near tail 5 scaffolds at 5.90%, mid tail 10 at 1.75%, deep tail 22 at 1.34% (totaling 9.00% — matches Ch 10 §10.8 *vaicitrya* statement).
...
- `{\devanagarifont धातुपाठ}`{=latex} (*Dhātupāṭha*) — opening frame
- `{\devanagarifont गणाः}`{=latex} (*gaṇāḥ*) — §6.1
- `{\devanagarifont माधवीय}`{=latex} `{\devanagarifont धातुवृत्ति}`{=latex} (*Mādhavīya Dhātuvṛtti*) / `{\devanagarifont सिद्धान्तकौमुदी}`{=latex} (*Siddhāntakaumudī*) / `{\devanagarifont क्षीरस्वामिन्}`{=latex} (*Kṣīrasvāmin*) — §6.1
- `{\devanagarifont अनुबन्ध}`{=latex} (*anubandha*) / `{\devanagarifont अष्टाध्यायी}`{=latex} (*Aṣṭādhyāyī*) / `{\devanagarifont इत्संज्ञा}`{=latex} (*it-saṃjñā*) — §6.1
- `{\devanagarifont उदात्त}`{=latex} (*udātta*) / `{\devanagarifont अनुदात्त}`{=latex} (*anudātta*) / `{\devanagarifont स्वरित}`{=latex} (*svarita*) — §6.1
- *Aṣṭādhyāyī* rules 1.3.2 / 1.3.3 / 1.3.5 — Sanskrit + Devanagari first-use in §6.1
- `{\devanagarifont स्वर}`{=latex} (*svara*) / `{\devanagarifont व्यञ्जन}`{=latex} (*vyañjana*) / `{\devanagarifont अक्षरम्}`{=latex} (*akṣaram*) — §6.1 (atom / ion / salt framing)
- `{\devanagarifont अन्तःस्थाः}`{=latex} (*antaḥsthāḥ*) / `{\devanagarifont ऊष्माणः}`{=latex} (*ūṣmāṇaḥ*) — §6.4
- `{\devanagarifont कण्ठ्य}`{=latex} / `{\devanagarifont तालव्य}`{=latex} / `{\devanagarifont मूर्धन्य}`{=latex} / `{\devanagarifont दन्त्य}`{=latex} / `{\devanagarifont ओष्ठ्य}`{=latex} — §6.3, §6.5
- `{\devanagarifont महाप्राण}`{=latex}-`{\devanagarifont घोषवत्}`{=latex} (*mahāprāṇa-ghoṣavat*) — §6.2
- `{\devanagarifont प्रत्यय}`{=latex} (*pratyaya*) / `{\devanagarifont सन्धि}`{=latex} (*sandhi*) — §6.3
- `{\devanagarifont रुकि}`{=latex} (*ruki*) / `{\devanagarifont विसर्ग}`{=latex} (*visarga*) — §6.3
- `{\devanagarifont यण्}`{=latex}-`{\devanagarifont सन्धि}`{=latex} (*yaṇ-sandhi*) — §6.6
- `{\devanagarifont अक्षर}`{=latex} (*akṣara*) — §6.7
- `{\devanagarifont वैचित्र्य}`{=latex} (*vaicitrya*) — §6.10
- `{\devanagarifont वर्ण}`{=latex} (*varṇa*) — §6.15
- All *dhātu* examples in tables paired with Devanagari (kṛ `{\devanagarifont कृ}`{=latex}, bhū `{\devanagarifont भू}`{=latex}, etc.)
...
- §6.7 falsification narrative (48.5% `{\symbolfont →}`{=latex} 58.2%) is the appendix's signature methodological move: name what the wrong stripping produced; name what the right stripping produces; let the methodology improvement carry the engineering signal.
...
**Short:** Ṛgveda 5.40.5 supplies the eclipse diagnostic: Svarbhānu pierces Sūrya with darkness, and the worlds become bewildered like one who does not know the field. The load-bearing phrase is **`{\devanagarifont अक्षेत्रवित्}`{=latex} (*akṣetravit*)**, rendered in the Preface as **field-loss**.

**Deployment:** Preface opening epigraph and first prose activation.

The quoted mantra is Ṛgveda 5.40.5:

> `{\devanagarifont यत्त्वा}`{=latex} `{\devanagarifont सूर्य}`{=latex} `{\devanagarifont स्वर्भानुस्तमसाविध्यदासुरः}`{=latex} `{\devanagarifont ।}`{=latex}\
> `{\devanagarifont अक्षेत्रविद्यथा}`{=latex} `{\devanagarifont मुग्धो}`{=latex} `{\devanagarifont भुवनान्यदीधयुः}`{=latex} `{\devanagarifont ॥}`{=latex}
>
...
The key expression is **`{\devanagarifont अक्षेत्रवित्}`{=latex} (*akṣetravit*)**: *a-* (not) + *kṣetra* (field) + *vit* (knowing). The verse does not only describe darkness. It describes the loss of the field by which light is oriented. The phrase **field-loss** preserves that diagnostic force: Sūrya remains Sūrya, but the worlds no longer know how to locate themselves by his light.

The verse belongs to the Svarbhānu sequence in Ṛgveda 5.40. The opening stops at the eclipse; the closing returns to the same sequence through **5.40.9**, *yaṃ vai sūryaṃ svarbhānus tamasāvidhyad āsuraḥ | atrayas tam anv avindan nahy anye aśaknuvan* — "the Sun whom Svarbhānu pierced with darkness, the Atris found; no others were able." The two verses mirror each other: both carry the same wound-line *svarbhānus tamasāvidhyad āsuraḥ*, and the second hemistich flips from *the worlds went field-blind* (5.40.5) to *the Atris alone found him* (5.40.9). The intervening **5.40.6** is the verse in which Indra strikes down Svarbhānu's *māyā* and Atri discovers the hidden Sun by the fourth *brahman*. Verse text and numbering verified against the Wilson/Sāyaṇa edition; confirm accenting against the selected printed Ṛgveda before final.

---

## `svarbhanu-svar-etymology`
**Short:** *Svarbhānu* (`{\devanagarifont स्वर्भानु}`{=latex}) parses as *svar* (`{\devanagarifont स्वर्}`{=latex}, the bright heaven, the sun's realm of light) + *bhānu* (`{\devanagarifont भानु}`{=latex}, light, ray, the shining one) — the eclipse-asura's name carries the very solar light he obscures.

**Deployments:** Part I opener ("How the Shadow Is Cast") — the *svar* wordplay; echoes the Preface's *Ṛgveda* 5.40.5 deployment.

*Svar* (`{\devanagarifont स्वर्}`{=latex}) is the third of the three Vedic worlds, the realm of light and heaven (after *bhūḥ* and *bhuvaḥ*), and by extension the sun's brightness. *Bhānu* (`{\devanagarifont भानु}`{=latex}) means a ray or beam of light, and as a substantive the sun itself. *Svarbhānu*, the asura who pierces Sūrya with darkness in *Ṛgveda* 5.40.5, therefore bears a name assembled from two words for solar light — the irony the Preface and the Part I opener deploy: the obscurer is named for the radiance he hides. See the `rigveda-5-40-5-svarbhanu-eclipse` note for the verse and the full eclipse sequence.
...
> `{\devanagarifont यं}`{=latex} `{\devanagarifont वै}`{=latex} `{\devanagarifont सूर्यं}`{=latex} `{\devanagarifont स्वर्भानुस्तमसाविध्यदासुरः}`{=latex} `{\devanagarifont ।}`{=latex}\
> `{\devanagarifont अत्रयस्तमन्वविन्दन्नह्यन्ये}`{=latex} `{\devanagarifont अशक्नुवन्}`{=latex} `{\devanagarifont ॥}`{=latex}
>
...
> `{\devanagarifont सक्तुमिव}`{=latex} `{\devanagarifont तितउना}`{=latex} `{\devanagarifont पुनन्तो}`{=latex} `{\devanagarifont यत्र}`{=latex} `{\devanagarifont धीरा}`{=latex} `{\devanagarifont मनसा}`{=latex} `{\devanagarifont वाचमक्रत}`{=latex} `{\devanagarifont ।}`{=latex}\
> `{\devanagarifont अत्रा}`{=latex} `{\devanagarifont सखायः}`{=latex} `{\devanagarifont सख्यानि}`{=latex} `{\devanagarifont जानते}`{=latex} `{\devanagarifont भद्रैषां}`{=latex} `{\devanagarifont लक्ष्मीर्निहिताधि}`{=latex} `{\devanagarifont वाचि}`{=latex} `{\devanagarifont ॥}`{=latex}
>
...
> `{\devanagarifont देवीं}`{=latex} `{\devanagarifont वाचमजनयन्त}`{=latex} `{\devanagarifont देवास्तां}`{=latex} `{\devanagarifont विश्वरूपाः}`{=latex} `{\devanagarifont पशवो}`{=latex} `{\devanagarifont वदन्ति}`{=latex} `{\devanagarifont ।}`{=latex}\
> `{\devanagarifont सा}`{=latex} `{\devanagarifont नो}`{=latex} `{\devanagarifont मन्द्रेषमूर्जं}`{=latex} `{\devanagarifont दुहाना}`{=latex} `{\devanagarifont धेनुर्वागस्मानुप}`{=latex} `{\devanagarifont सुष्टुतैतु}`{=latex} `{\devanagarifont ॥}`{=latex}
>
...
> `{\devanagarifont उत}`{=latex} `{\devanagarifont त्वः}`{=latex} `{\devanagarifont पश्यन्}`{=latex} `{\devanagarifont न}`{=latex} `{\devanagarifont ददर्श}`{=latex} `{\devanagarifont वाचम्}`{=latex} `{\devanagarifont उत}`{=latex} `{\devanagarifont त्वः}`{=latex} `{\devanagarifont शृण्वन्}`{=latex} `{\devanagarifont अशृणोत्}`{=latex} `{\devanagarifont एनाम्}`{=latex} `{\devanagarifont ।}`{=latex}\
...
- **`{\devanagarifont पश्यन्न}`{=latex} `{\devanagarifont ददर्श}`{=latex}** `{\symbolfont ←}`{=latex} *paśyan* + *na dadarśa* — *paśyan* (present participle nom.sg. of √*paś*) ends in *n*; *na* begins with *n*; the doubling is metrical / sandhi geminate (Vedic mode).
- **`{\devanagarifont शृण्वन्न}`{=latex} `{\devanagarifont अशृणोति}`{=latex}** `{\symbolfont ←}`{=latex} *śṛṇvan* + *aśṛṇoti* — Vedic gemination of the final *n* before the following vowel.
...
**Short:** The Śikṣā articulation-place line `{\devanagarifont ऋटुरषाणां}`{=latex} `{\devanagarifont मूर्धा}`{=latex} (*ṛṭuraṣāṇāṃ mūrdhā*) assigns `{\devanagarifont ऋ}`{=latex} (*ṛ*), the `{\devanagarifont टु}`{=latex} (*ṭu*) class, `{\devanagarifont र}`{=latex} (*ra*), and `{\devanagarifont ष}`{=latex} (*ṣa*) to `{\devanagarifont मूर्धा}`{=latex} (*mūrdhā*) — the head / roof-of-mouth site. The line matters in Ch16 because it does not merely name the retroflex site; the operative sound sequence makes the speaker perform it.
...
**Short:** *Bhagavad Gītā* 16.6 gives Chapter 1 its structural binary: `{\devanagarifont दैव}`{=latex} (*daiva*) and `{\devanagarifont आसुर}`{=latex} (*āsura*) are two formations, not two casual adjectives. The epigraph supplies the category for the asuric order the chapter introduces.
...
- **`{\devanagarifont दैव}`{=latex} `{\devanagarifont आसुर}`{=latex}** `{\symbolfont ←}`{=latex} *daivaḥ* + *āsuraḥ* — visarga *-aḥ* before vowel *ā-* drops the visarga (Vedic / *gītā* usage): *daivaḥ āsuraḥ* `{\symbolfont →}`{=latex} *daiva āsura(ḥ)*.
...
The implication is structural. Patañjali's opening axiom asserts, at the foundational level of the *vyākaraṇa* discipline's self-description, that Sanskrit is a received and operating system whose word-meaning relations are not subjects of analysis but premises of it. The engineering of the system is *not* the work of the grammarians; the grammarians inherited the encoded system and decoded it. This is the same point the book makes across Chapter 1 §1.6 (*heroic erasure* and the pyramid's celebration of Pāṇini), Chapter 16, and the foundational chapters on the *varṇamālā* and *dhātupāṭha*: the named figures (Pāṇini, Patañjali, the *Prātiśākhya* compilers) are ***vaiyākaraṇāḥ*** (`{\devanagarifont वैयाकरणाः}`{=latex}) — *decoders*, *analysts*, *unfolders-apart* — not engineers. The axiom *siddhe śabdārthasambandhe* is the discipline's own statement of this distinction: the system was engineered upstream, carried in the *Vedas*, and decoded by the *vaiyākaraṇāḥ* rather than manufactured by them.
...
**Short:** The Chapter 3 etymology places English *liberal* / *illiberal* beside Sanskrit **`{\devanagarifont अरावन्}`{=latex} (*arāvan*)**. Latin *liber* carries the semantic field of freedom and generosity; Sanskrit *arāvan* is glossed in the lexicons as "not liberal," adverse, hostile, and literally "not giving" from privative *a-* + √**`{\devanagarifont रा}`{=latex}** (*rā*, to give, grant, bestow). The body prose uses the comparison structurally: the institutional use of *liberal* operates as a closed-handed, non-giving power.
...
The Sanskrit side is older and sharper. **`{\devanagarifont अरावन्}`{=latex} (*arāvan*)** is analyzed in the Monier-Williams entry as *a-rāvan*, with the gloss "not liberal," envious, hostile, and Vedic. The WisdomLib aggregation of Sanskrit dictionaries preserves the same lexicographic cluster: Apte gives "not offering" and "malignant"; Cappeller gives "hostile, adverse (lit. not giving)." The relevant semantic unit is √**`{\devanagarifont रा}`{=latex}** (*rā*) — to give, grant, or bestow — with privative *a-* negating the action.
...
Standard references: Monier-Williams, *A Sanskrit-English Dictionary* (1899), entries for √**`{\devanagarifont रा}`{=latex}** (*rā*) and **`{\devanagarifont अरावन्}`{=latex} (*arāvan*)**; V. S. Apte, *The Practical Sanskrit-English Dictionary*, **`{\devanagarifont अरावन्}`{=latex}**; Cappeller, *Sanskrit-English Dictionary*, **`{\devanagarifont अरावन्}`{=latex}**. The Cologne Digital Sanskrit Dictionaries and WisdomLib aggregations reproduce these entries in searchable form.
...
**Short:** Forward-pointer to the canonical `assalayana-sutta` endnote — *Majjhima Nikāya* 93's dharmic primary-source documentation of the *ārya* (`{\devanagarifont आर्य}`{=latex}) / *dāsa* (`{\devanagarifont दास}`{=latex}) binary as a foreign-bordering-nations (*Yona* / *Kamboja*) feature, deployed in Chapter 4.
...
The figures are generated from the book's vocal-tract inventory atlas. Each survey holds Sanskrit constant as the 23-cell base after temporarily removing the ten heavy-breath stop cells: `{\devanagarifont ख}`{=latex} `{\devanagarifont छ}`{=latex} `{\devanagarifont ठ}`{=latex} `{\devanagarifont थ}`{=latex} `{\devanagarifont फ}`{=latex} and `{\devanagarifont घ}`{=latex} `{\devanagarifont झ}`{=latex} `{\devanagarifont ढ}`{=latex} `{\devanagarifont ध}`{=latex} `{\devanagarifont भ}`{=latex}. The remaining base cells are: `{\devanagarifont क}`{=latex} `{\devanagarifont च}`{=latex} `{\devanagarifont ट}`{=latex} `{\devanagarifont त}`{=latex} `{\devanagarifont प}`{=latex}; `{\devanagarifont ग}`{=latex} `{\devanagarifont ज}`{=latex} `{\devanagarifont ड}`{=latex} `{\devanagarifont द}`{=latex} `{\devanagarifont ब}`{=latex}; `{\devanagarifont ङ}`{=latex} `{\devanagarifont ञ}`{=latex} `{\devanagarifont ण}`{=latex} `{\devanagarifont न}`{=latex} `{\devanagarifont म}`{=latex}; `{\devanagarifont य}`{=latex} `{\devanagarifont र}`{=latex} `{\devanagarifont ल}`{=latex} `{\devanagarifont व}`{=latex}; `{\devanagarifont श}`{=latex} `{\devanagarifont ष}`{=latex} `{\devanagarifont स}`{=latex} `{\devanagarifont ह}`{=latex}. The comparison measures how many of those 23 Sanskrit coordinates are covered by the union of three selected languages.

The body deploys four figures. The Southern Survey (`sk_tamil_toda_kurukh.svg`) compares Sanskrit with Tamil, Toda, and Kurukh and covers 20 of 23 base cells, leaving `{\devanagarifont ल}`{=latex}, `{\devanagarifont स}`{=latex}, and `{\devanagarifont श}`{=latex} unfilled. The Forest-Belt Survey (`sk_korku_mundari_ho.svg`) compares Sanskrit with Korku, Mundari, and Ho and covers 18 of 23, leaving `{\devanagarifont ण}`{=latex}, `{\devanagarifont स}`{=latex}, `{\devanagarifont ष}`{=latex}, `{\devanagarifont श}`{=latex}, and `{\devanagarifont ल}`{=latex} unfilled. The Western IE Control (`sk_english_french_greek.svg`) compares Sanskrit with English, French, and Greek and covers 14 of 23. The Central Asian Control (`sk_tajik_kazakh_kyrgyz.svg`) compares Sanskrit with Tajik, Kazakh, and Kyrgyz and covers 12 of 23.
...
The tabla — the paired hand-drum of the North Indian classical music continuum — is normally taught through the recitation of ***bols*** (`{\devanagarifont बोल}`{=latex} — *spoken syllables*) before any contact with the drum itself. The *bols* are the spoken-syllable representation of the strokes the player will produce. Each stroke has a named *bol*: *dha*, *dhin*, *na*, *tin*, *ti*, *te*, *ta*, *ke*, *ge*, *ga*, *kat*, *trkt*, *dhin-na*, and others. The student learns the rhythmic compositions (*kāyda*, *raulā*, *gat*, *paran*, *tukṛā*) as sequences of *bols* — speaking them, in rhythm, before learning to produce the corresponding strokes on the drum.
...
**Deployments:** Chapter 9 §9.5 — the citation anchor for the *Sindhuḥ* `{\symbolfont →}`{=latex} *Hinduš* / *Indós* / *Indus* cognate-shadow analysis.
...
1. ***Ṛk-Prātiśākhya (`{\devanagarifont ऋक्प्रातिशाख्य}`{=latex})*** — attached to the *Ṛgveda* in the *Śākala* recension, attributed in the lineage to Śaunaka. Treats the phonetic specification, accent system, and recitational rules of the *Ṛgveda*.
...
3. ***Vājasaneyī-Prātiśākhya (`{\devanagarifont वाजसनेयिप्रातिशाख्य}`{=latex})*** — attached to the *Vājasaneyī Saṃhitā* of the *Śukla-Yajurveda*. Attributed in the lineage to Kātyāyana. Treats the phonetic-recitational framework for the *Vājasaneyī* śākhā.
...
**Short:** The *Śikṣā* timing discipline treats a consonant as a half-*mātrā* event. The line preserved in multiple *śikṣā* texts is **`{\devanagarifont व्यञ्जनं}`{=latex} `{\devanagarifont चार्धमात्रिकम्}`{=latex} (*vyañjanaṃ cārdhamātrikam*)**: the consonant is half-measured. The claim is proportional, not a fixed millisecond value. Sanskrit does not let consonants become timeless filler; it measures them.
...
> **`{\devanagarifont एकमात्रो}`{=latex} `{\devanagarifont भवेद्}`{=latex} `{\devanagarifont ह्रस्वो}`{=latex} `{\devanagarifont द्विमात्रो}`{=latex} `{\devanagarifont दीर्घ}`{=latex} `{\devanagarifont उच्यते}`{=latex} `{\devanagarifont ।}`{=latex}**
> **`{\devanagarifont त्रिमात्रस्तु}`{=latex} `{\devanagarifont प्लुतो}`{=latex} `{\devanagarifont ज्ञेयो}`{=latex} `{\devanagarifont व्यञ्जनं}`{=latex} `{\devanagarifont चार्धमात्रिकम्}`{=latex} `{\devanagarifont ॥}`{=latex}**
>
...
**Deployments:** Chapter 16 §16.4 ¶ — the citation anchor for the opening word of the *Ṛgveda* — *agnimīḷe* — and its placement of the retroflex lateral `{\devanagarifont ळ}`{=latex} at the structural front of the foundational text.
...
**Deployments:** Chapter 9 §9.8 — the citation anchor for Tamil's distinctive alveolar trill phoneme `{\tamilfont ற}`{=latex} (*ṟ*).
...
Urdu — the Persian-and-Arabic-loaned layer of Hindustani that operates with the Perso-Arabic script (*nasta`{\symbolfont ʿ}`{=latex}līq*) and that carries substantial Persian and Arabic vocabulary — includes phonemes that broader Hindi usage does not productively use and that the *varṇamālā* does not include in its base inventory. The principal loan-phonemes:

- **f (labio-dental voiceless fricative)** — written as `{\arabicfont ف}`{=latex} (*fā*) in Urdu. Used in Persian and Arabic loanwords (*faraz*, *firqa*, *fauj*, *falsafa*) and in some words of European origin. The corresponding Hindi form typically renders f as *ph* (the *pavarga* aspirated stop), with the labio-dental fricative articulation lost in standard Hindi speech.

- **z (alveolar voiced fricative)** — written as `{\arabicfont ز}`{=latex} (*ze*) in Urdu. Used in Persian and Arabic loanwords (*zamin*, *zindagi*, *zara*, *zakāt*). Hindi usage renders z as *j* (the *cavarga* voiced stop), with the fricative articulation lost.

- **q (uvular voiceless stop)** — written as `{\arabicfont ق}`{=latex} (*qāf*) in Urdu. Used in Arabic loanwords (*qissa*, *qadr*, *qabil*, *qurān*). Hindi usage renders q as *k* (the *kavarga* unaspirated voiceless stop), with the uvular articulation lost.

- **kh (uvular voiceless fricative)** — written as `{\arabicfont خ}`{=latex} (*ḳhe*) in Urdu. Used in Persian and Arabic loanwords (*khabar*, *khwāhish*). Hindi speech often renders this as the *kavarga* aspirated *kh* (the same grapheme position but with velar rather than uvular articulation).

- **gh (uvular voiced fricative)** — written as `{\arabicfont غ}`{=latex} (*ghain*) in Urdu. Used in Persian and Arabic loanwords (*ghazal*, *ghair*). Hindi speech often renders this as the *kavarga* voiced *g* with aspiration loss.
...
- ***The Classical Dance Lineages*** — *Bharatanāṭyam* (Tamil Nadu), *Kathakaḷi* (Kerala), *Kuchipudi* (Andhra Pradesh / Telangana), *Odissī* (Odisha), *Manipuri* (Manipur), *Mohinīāṭṭam* (Kerala), *Kathak* (north India), and the regional variations. Each lineage operates as a practitioner-side carrier of the *Flexture* preservation across many generations, with the *guru-shishya* lineage-chain maintaining the gesture-and-posture vocabulary and the audience-side critical reception (across the *rasika* community) providing the error-correction function.
...
The recordings and documentation are held in the archives of the Asian Humanities Press, the Film Study Center at Harvard, and the various scholarly collections that have inherited Staal's materials. They are available for scholarly comparison with recitations from other Vedic lineages.
...
The structural significance for Ch15: the Masoretic apparatus was substantially codified *after* the canonization of the consonantal text. The preservation engineering was retrofitted onto an already-canonical text. The contrast with the Vedic recitation lineages is structural: the Vedic eleven-*pāṭha* system is *not* retrofitted onto a separately-canonical text; the recitation engineering and the *Saṃhitā* text are co-architected, with the recitation system being what the *Saṃhitā* text *is* in its operating form. The broader comparative claim — that the Vedic preservation engineering is deeper than the Masoretic — rests on this structural distinction.
...
**Short:** The Wiktionary entry on Sanskrit ***`{\devanagarifont पश्यति}`{=latex}*** (*paśyati*, "he sees") carries the machinery's account that the root is suppletive — *paśyati* derives from PIE *\*spe`{\symbolfont ḱ}`{=latex}-*, the remainder of the paradigm from PIE *\*der`{\symbolfont ḱ}`{=latex}-*; Chapter 18 §18.8 uses the entry as a compact example of the pyramid's account splitting one Sanskrit *dhātu*-family across multiple reconstructed PIE roots.
...
- *Artashumara* `{\symbolfont →}`{=latex} Mitanni Sanskritic *Artasmara* / Vedic cognate *Ṛtasmara* (*r̥ta-smara* = recalling-*r̥ta* / cosmic order).
...
**Deployments:** Chapter 19 §19.2 ¶ (Greek-grammar paragraph) — the citation anchor for Dionysius Thrax's *Téchn`{\symbolfont ē}`{=latex} Grammatik`{\symbolfont ē}`{=latex}* as the first systematic Greek grammar.
...
**Deployments:** Chapter 19 §19.2 ¶ (Arabic-grammar paragraph) — the citation anchor for Sibawayh's *Al-Kitāb* as the foundational Arabic grammar and its methodological-and-contextual proximity to the Pāṇinian-Basran intellectual milieu.
...
**Short:** Ch 10 §10.13 uses Yaska's multiple derivations of **`{\devanagarifont अग्नि}`{=latex} (*agni*)** in *Nirukta* 7.14 as evidence that the analytical discipline treated Sanskrit words as decomposable assemblies, not opaque historical accidents.
...
**Short:** `{\devanagarifont धा}`{=latex} (*dhā*) `{\symbolfont →}`{=latex} `{\devanagarifont दधाति}`{=latex} (*dadhāti*) supplies the teaching-level example for the two correction paths in Ch 13 §13.5. The rule-trained path cites Pāṇini's *Aṣṭādhyāyī* 2.4.75, **`{\devanagarifont जुहोत्यादिभ्यः}`{=latex} `{\devanagarifont श्लुः}`{=latex} (*juhotyādibhyaḥ śluḥ*)**, which governs the *juhotyādi* class operation. The saturation-trained path cites Ṛgveda 1.66.2, where the Vedic line preserves **`{\devanagarifont दधाति}`{=latex} (*dadhāti*)** directly: **`{\devanagarifont वाजी}`{=latex} `{\devanagarifont ।}`{=latex} `{\devanagarifont न}`{=latex} `{\devanagarifont ।}`{=latex} `{\devanagarifont प्रीतः}`{=latex} `{\devanagarifont ।}`{=latex} `{\devanagarifont वयः}`{=latex} `{\devanagarifont ।}`{=latex} `{\devanagarifont दधाति}`{=latex}** (*vājī | na | prītaḥ | vayaḥ | dadhāti*) — "Like a contented stallion, he bestows vital strength."
...
**Short:** Rank-frequency concentration is expected in living languages and is not treated here as engineering evidence by itself. The engineering claim begins where usage concentration couples to compact sonomeric atoms, stable scaffold order, regular bonding, and cross-domain persistence. Natural languages display the *frequency-irregularity correlation* — high-frequency forms tend toward suppletive idiosyncrasy (English *be / have / do*; Latin *esse / ire / ferre*; Greek *eimi / oida / ph`{\symbolfont ē}`{=latex}mi*); the correlation is one of the most-replicated findings in natural-language morphology, explained by high-frequency forms being mastered as wholes and resisting analogical regularization. Sanskrit shows the *opposite* pattern: the most-productive *dhātus* (*kṛ, bhū, gam, sthā, dā, dhā, jñā, hṛ, nī*) are the most structurally *minimal* (CV / CVC) *and* the most paradigmatically *regular*. Empirical signature in the *Dhātupāṭha* curated sample: Spearman ρ = −0.485 between productivity and sonomer count; CV pattern mean productivity 2.9× the CCVCC pattern's; top-20 productivity ranks dominated by minimal-sonomer patterns. Both axes are engineered at once.
...
**Short:** Ch 11 §11.6 percentages compute against the **3,839 distinct *dhātuḥ* labels visible in the Digital Corpus of Sanskrit**, not the **2,168 canonical entries in the Dhātupāṭha**. The DCS surplus comes from variant readings, recension-specific entries, and items not listed in the canonical *Dhātupāṭha*.
...
Sources: `analysis/ganah/data/derived/path_c_valency.csv` (DCS *dhātuḥ* labels, with per-label valency); `analysis/dhatupatha/data/derived/template_distribution.csv` (canonical 2,168 inventory).
...
**Deployments:** Preface ¶ (the *closing-positioning* paragraph anchored on *Nāsadīya Sūkta* humility-as-canonical-text); Chapter 17 §17.7 (the honest answer to the origin-mechanism demand).

The ***Nāsadīya Sūkta*** (`{\devanagarifont नासदीयसूक्तम्}`{=latex}) is *Ṛgveda* 10.129, the famous *Creation Hymn* — seven *ṛcas* on the cosmic-origin question. The hymn's load-bearing move for origin-honesty is its closing stanza (10.129.7), which states the limit of knowledge directly:
...
**Short:** The *Nyāya Sūtra* 1.1.3, **`{\devanagarifont प्रत्यक्षानुमानोपमानशब्दाः}`{=latex} `{\devanagarifont प्रमाणानि}`{=latex}** (*pratyakṣānumānopamānaśabdāḥ pramāṇāni*), lists four *pramāṇāni* — means of knowledge. Chapter 10 uses it because the four-fold list also describes the book's own method.
...
**Short:** Sanskrit prosody counts possible **`{\devanagarifont लघु}`{=latex} (*laghu*)** and **`{\devanagarifont गुरु}`{=latex} (*guru*)** arrangements inside fixed *mātrā* budgets. A *laghu* syllable occupies one *mātrā*; a *guru* syllable occupies two. The recurrence produced by this counting is the sequence later known in Europe as the Fibonacci sequence; inside the Sanskrit prosodic record it belongs to the Piṅgala / Virahāṅka / Gopāla / Hemacandra line of *Chandas* analysis.
...
> `{\devanagarifont य}`{=latex} `{\devanagarifont इत्तद्विदुस्त}`{=latex} `{\devanagarifont इमे}`{=latex} `{\devanagarifont समासते}`{=latex} `{\devanagarifont ॥}`{=latex}
>
...
The padapāṭha splits **`{\devanagarifont यस्तन्न}`{=latex}** as **`{\devanagarifont यः}`{=latex} `{\devanagarifont ।}`{=latex} `{\devanagarifont तत्}`{=latex} `{\devanagarifont ।}`{=latex} `{\devanagarifont न}`{=latex} `{\devanagarifont ।}`{=latex}** and **`{\devanagarifont समासते}`{=latex}** as **`{\devanagarifont सम्}`{=latex} `{\devanagarifont ।}`{=latex} `{\devanagarifont आसते}`{=latex}**. **`{\devanagarifont सम्}`{=latex} `{\devanagarifont आसते}`{=latex}** may resonate with the assembly argument, but it should not be overclaimed as the technical grammatical term *samāsa*.
...
**Short:** **`{\devanagarifont नामान्याख्यातजानि}`{=latex}** (*nāmāny ākhyātajāni*) supplies the internal hinge for the assembly argument: names arise from actions. The line is associated with Śākaṭāyana and the Nairukta view preserved in *Nirukta* 1.12.
...
## `kr-bonding-examples`
**Short:** `{\devanagarifont कृ}`{=latex} (*kṛ*) functions as the flagship atom because the same semantic atom generates a wide field of visible molecules: **`{\devanagarifont कर्म}`{=latex} (*karma*)**, **`{\devanagarifont कर्तृ}`{=latex} (*kartṛ*)**, **`{\devanagarifont कार्य}`{=latex} (*kārya*)**, **`{\devanagarifont प्रकृति}`{=latex} (*prakṛti*)**, **`{\devanagarifont विकृति}`{=latex} (*vikṛti*)**, **`{\devanagarifont संस्कृति}`{=latex} (*saṃskṛti*)**, and **`{\devanagarifont संस्कार}`{=latex} (*saṃskāra*)**.
...
- **`{\devanagarifont कर्तृ}`{=latex} (*kartṛ*)** is best explained with the standard agent-suffix label *tṛc*, whose visible result is *tṛ*.
- **`{\devanagarifont कार्य}`{=latex} (*kārya*)** is the lemma; **`{\devanagarifont कार्यम्}`{=latex} (*kāryam*)** is the common neuter sentence form.
- **`{\devanagarifont संस्कृति}`{=latex} (*saṃskṛti*)** and **`{\devanagarifont संस्कार}`{=latex} (*saṃskāra*)** should not be drawn in sonomeric figures as simple *sam + kṛ* adjacency. Their visible **`{\devanagarifont स्}`{=latex}** requires figure-level accounting before production diagrams are finalized.

The data-side reason for choosing *kṛ* is strong. In the Path C usage audit, *kṛ* carries valency 1,062 and 50,155 counted uses, the highest measured deployment among the corpus-linked *dhātavaḥ*. That data remains support; the main proof remains procedural.

---

## `hlad-contrast-atom`
**Short:** **`{\devanagarifont ह्लाद्}`{=latex} (*hlād*)** is the lower-reactivity contrast atom for `{\devanagarifont कृ}`{=latex} (*kṛ*). The contrast prevents the argument from implying that every *dhātuḥ* behaves like the most reactive atom in the corpus.
...
**Short:** Rigveda 9.63.5 carries the call **`{\devanagarifont कृण्वन्तो}`{=latex} `{\devanagarifont विश्वम्}`{=latex} `{\devanagarifont आर्यम्}`{=latex} (*kṛṇvanto viśvam āryam*)** and the adversarial term **`{\devanagarifont अराव्णः}`{=latex} (*arāvṇaḥ*)**, "non-givers." Wilson and Griffith translated the verse through nineteenth-century filters that obscured the civilizational force later restored by Jamison-Brereton.
...
**Short:** The maxim **`{\devanagarifont धर्मो}`{=latex} `{\devanagarifont रक्षति}`{=latex} `{\devanagarifont रक्षितः}`{=latex} (*dharmo rakṣati rakṣitaḥ*)** gives Chapter 0 its caretaker law: what protects must itself be protected.
