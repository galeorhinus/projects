---
title: "Sanskrit Was Engineered"
description: "A short introduction to *Atomic Sanskrit* — the book's central claim that Sanskrit's architecture is engineered, not evolved."
slug: sanskrit-was-engineered
---
...
Pre-publication essays, including longer arguments and chapter previews, are available to advance readers at [/as/private/](/as/private/). Access is granted on request; the door isn't locked, it's just curated.
