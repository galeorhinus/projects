...
| A2 | as_3_02_encyclopaedic | App — Encyclopaedic | 317 | 🟢 swept (clean edits) — dossier-clean polemic; 2 reading-ban locations ("variants are read as"→"treated as" / "not read as"→"not taken as"; "a different reading"→"a different account"). Deliberate antitheses/anaphora protected. LEFT & flagged (deliberate reframe anaphora): §2.8 "Read through X…" + L27 "read through the Forever Nation frame" |
