...
| `[x]` | Ch18 Appendix forward-pointer | Ch18 forwarded to Appendix Part 1 as “institutional cartel” while Appendix Part 1 itself carried unresolved register issues. | The main verdict leans on that appendix as a dossier. | Calibrated Appendix Part 1 register and removed the reader-facing cartel framing. |
