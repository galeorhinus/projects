...
The *t* has a source too, twice over. Root-final in ⟪कृत्⟫, as above. And where it is a suffix, it is the *kta*-participle by stated rule: *kṛt + kta* → **कृत्त (*kṛtta*)**, *cut off, shortened* — which is Latin *curtus*, sound for sound and sense for sense. The \*-tó- suffix the reconstruction deploys is *kta*, harvested from the grammar that states it, like the ablaut before it.
