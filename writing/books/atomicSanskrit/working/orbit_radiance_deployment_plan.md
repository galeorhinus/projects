...
The *s* has a source, and Sanskrit states it as rule. The language's boundary machinery delivers *s + k* sequences constantly. The *suṭ*-āgama inserts an *s* before ⟪कृ⟫ by explicit sūtra — *sam + kṛ* → **संस्कृत (*saṃ-s-kṛta*)** — and the insertion is meaning-bearing: the grammar distinguishes *saṃkṛta*, merely assembled, from *saṃskṛta*, refined, and the inserted *s* carries the refinement.[NOTE: sut-agama-visarga-s] The visarga surfaces as *s* in the standard compounds — **नमस्कार (*namas-kāra*)**, *puras-kāra*, *bhās-kara*. The *s*-final preverbs plant it directly on the cut-family — **दुष्कृत (*duṣ-kṛta*)**. Now put a listener at the boundary. Connected speech offers *…s-kṛ…* and *…s-kart…* strings all day, every one generated by a stated rule, and a hearer who does not know where the word ends cuts it wrong. The *s* adheres to the root; the *bīja* seeded in the receiving head is *sker-*, one unit. Where the same atom arrived in a string without a boundary-*s* — *kṛntati*, bare *kart-* — the seed grew without it. The "mobility" of the *s* is nothing but the variability of word boundaries in the source stream. The pyramid's own leading hypothesis for the s-mobile is exactly this — misdivision of connected speech — which concedes the mechanism while omitting the one language whose grammar wrote the boundary rules down.
