...
The full wording of **S1–S50** remains in [`reference/as_thesis_summary.md`](../../reference/as_thesis_summary.md). Each chapter entry below names the relevant thesis by number and gives enough context to evaluate the match.
...
4. The pyramid needs linear chronology because a beginning gives an apex a first point to own. Sanskrit and the Vedas instead carry memories of recurrence, continuity, and calibrant order.
   ...
   **Thesis match:** **S37**, **S38**. **Candidate:** **NEW-C**.
...
1. The Indian continuum begins from the infinite rather than forcing existence into one owned beginning. Zero and the Vedic question of the whole reveal a culture willing to inquire without placing an apex above what it does not know.

   **Thesis match:** **S37**. **Candidate:** **NEW-E**.
...
7. The Vedas place *sat*, *asat*, and created *ṛta* at the center of an order that requires discernment. Conduct and purpose determine alignment; identity labels do not.
   ...
   **Thesis match:** **S39**. **Candidate:** **NEW-B**.
...
1. An apex tries to reduce plurality and the boundless to one authorized account. Its insistence on a first point, final boundary, and single owner produces the finite geometry of the pyramid.

   **Thesis match:** **S37**.

2. The pyramid is not natural order. It is a created fractal of deformation, **विकृति (*vikṛti*)**, formed when intelligence, memory, and organization are bent toward containment and command.
...
8. *Asat* becomes architecturally recognizable through what it does: it encloses what should circulate, removes the observer’s capacity to discern, and places control above well-being.
   ...
   **Thesis match:** **S36**, **S37**, **S39**. **Candidate:** **NEW-B**.
...
2. Arabic, Latin, Sanskrit, and Tamil cannot be placed in one category merely because each has a major grammatical or textual document. Arabic and Latin rely on identifiable authority structures; Sanskrit and Tamil preserved grammatical knowledge within subcontinental society.
   ...
   **Thesis match:** **S15**, **S16**, **S19**.

3. The two-axis matrix distinguishes origin from generativity. It restores the missing category of a language deliberately engineered to generate new expression from its own architecture.

   **Thesis match:** **C1**; **S3**, **S4**.
...
5. Neither *māyā* nor *asura* determines moral alignment by itself. Power becomes *daivī* or *āsurī* through the purpose it serves, and the listener must exercise *viveka* by examining conduct.
   ...
   **Thesis match:** **S39**. **Candidate:** **NEW-B**, **NEW-G**.
...
7. Vedic passages repeatedly distinguish containment from release. The side that restores circulation, radiance, well-being, or *svasti* aligns with *sat*; the side that obstructs those purposes aligns with *asat*.
   ...
   **Thesis match:** **S36**, **S39**. **Candidate:** **NEW-B**.
...
4. **सिद्धे शब्दार्थसम्बन्धे (*siddhe śabdārthasambandhe*)** begins with the bond among word, meaning, and relation already established. Grammar regulates a speaker’s use of that bond; it does not manufacture the bond.
   ...
   **Thesis match:** **C1**; **S15**, **S17**.

5. The contrast between **सिद्ध (*siddha*)** and **कार्य (*kārya*)** separates an established architecture from language continually remade by usage. Sanskrit’s own analytical account places its word–meaning bonds in the first category.
...
3. Drift, deviation, and divergence describe three different relationships. A natural language drifts internally; Sanskrit can detect a deviation against its calibrant; an orbital language can drift on its own and thereby diverge from Sanskrit.
   ...
   **Thesis match:** **S8**, **S29**. **Candidate:** **NEW-I**, **NEW-T**.

4. The four language categories respond differently to entropy. Natural languages absorb drift, petrified forms rely on authority, lexicon-dependent conlangs require additions, and generative architectures can create new expression from their own design.

   **Thesis match:** **C1**; **S3**, **S4**, **S9**, **S15**, **S16**.
...
1. The human body is the first sound-producing instrument. Lungs, vocal cords, throat, tongue, palate, teeth, lips, and nasal passage create the physical field from which languages select their sounds.

   **Thesis match:** **C1**; **S18**. **Candidate:** **NEW-J**.

2. A consonant is a timed event produced when the body narrows or closes the vocal tract. A vowel is a sustained tone shaped by the open resonating tract. Written marks represent these events after the body produces them.

   **Thesis match:** **C1**; **S18**, **S23**.

3. Every language selects only part of the human sound field. A language’s inventory therefore records choices among sounds that the same human anatomy could produce.

   **Thesis match:** **C1**; **S18**, **S22**. **Candidate:** **NEW-J**.

4. Sanskrit names the sound-producing anatomy and classifies what happens within it through **स्थान (*sthāna*)**, **प्रयत्न (*prayatna*)**, and **मात्रा (*mātrā*)**. These are physical coordinates and durations, not an arbitrary alphabetic order.

   **Thesis match:** **C1**; **S18**. **Candidate:** **NEW-J**.

5. Sanskrit’s four broad sound classes distinguish sustained vowels, contact events, between-standing movements, and turbulent breath. The classification begins in the speaking body and prepares the sonomeric grid.

   **Thesis match:** **C1**; **S18**.

6. Because Sanskrit’s sound analysis can be reproduced in any reader’s mouth, the first layer of the engineering thesis is directly testable rather than dependent upon chronology or institutional authority.

   **Thesis match:** **C1**, **C7**; **S18**. **Candidate:** **NEW-J**.
...
2. A **sonance** is a consonantal sound Sanskrit deliberately recognizes. A **sonomer** is a sonance promoted to an independent, reusable grid address. The distinction allows the Vedic domain to retain bounded or condition-generated sounds without adding every pronounceable sound to unrestricted composition.
   ...
   **Thesis match:** **C1**; **S18**, **S22**. **Candidate:** **NEW-K**, **NEW-T**.

3. The southern comparison of Tamil, Toda, and Kurukh covers twenty-two of Sanskrit’s twenty-three base consonant cells. The central forest-belt comparison covers twenty of twenty-three.
...
7. The survey identifies the regional superset but does not yet explain why Sanskrit selected particular sounds from it. Chapter 9 supplies that engineering test through grid addresses, distinguishability, scope, and exclusion.
   ...
   **Thesis match:** **C1**, **C7**; **S18**, **S22**. **Candidate:** **NEW-K**.

## Chapter 9 — The *Varṇamālā*: The Sonomeric Grid

1. The Vedic sieve and the **वर्णमाला (*varṇamālā*)** describe deliberate selection and ordered arrangement. Sanskrit does not merely collect sounds present in the region; it assigns selected sounds distinct roles within an architecture.

   **Thesis match:** **C1**; **S18**, **S22**.

2. Every sonomer receives an address defined by where the body forms it and what the body does there. Place, manner, voice, breath, nasality, and duration keep the selected sounds repeatable and distinguishable.

   **Thesis match:** **C1**; **S18**. **Candidate:** **NEW-J**.

3. The five contact-stations and the oral/nasal, voiced/unvoiced, and aspirated/unaspirated controls create the familiar twenty-five-cell consonant grid. Acoustic separation among the contact points supports reliable recognition by the ear.
...
5. The numerical distributions of the 2,168 atoms show deliberate concentration in a small number of compact sonomeric and temporal scaffolds rather than uncontrolled accumulation of forms.
   ...
   **Thesis match:** **C1**, **C7**; **S11**, **S20**. **Candidate:** **NEW-L**.
...
5. **कर्मणि (*karmaṇi*)** and **भावे (*bhāve*)** allow the doer to recede while the affected thing or action stands forward. Sanskrit turns a wider subcontinental grammatical posture into an explicit architecture.

   **Thesis match:** **C1**, **C7**; **S19**.
...
7. The Radiance Thesis offers a forward mechanism. Sanskrit atoms and operators travel as seeds, enter receiving languages, undergo local sound and meaning changes, and survive as **प्रतिबिम्बानि (*pratibimbāni*)**, partial reflections of the calibrant.
   ...
   **Thesis match:** **C7**; **S27**, **S29**, **S30**, **S31**. **Candidate:** **NEW-T**.

8. Contact can transmit more than individual words. Prefixes, grammatical operations, analytical methods, and people trained in Sanskrit can reshape a receiving language without mass migration or conquest.

   **Thesis match:** **C7**; **S27**, **S31**.

9. A repeatable radiance map can test the direction family by family. It begins with recorded forms, compares sound and meaning against Sanskrit atoms and operations, and traces what the receiving language added, moved, changed, or lost.

   **Thesis match:** **C7**; **S27**, **S30**, **S31**. **Candidate:** **NEW-Q**.
...
1. Removing PIE does not end language comparison. It reverses the direction and asks how Sanskritic words, structures, and methods reached other linguistic communities.

   **Thesis match:** **C7**; **S27**, **S31**.

2. Wave 1 carried Sanskritic language and knowledge before Pāṇini. Lineage memories, Mitanni records, names, technical vocabulary, and the contrast with drifting Old Persian show trained specialists carrying parts of Sanskrit beyond India.

   **Thesis match:** **C7**; **S27**, **S29**, **S31**. **Candidate:** **NEW-R**.
...
4. Borrowed words become native inside the receiving language and then drift with it. Their later form records contact with Sanskrit without requiring continued calibration or common descent.
   ...
   **Thesis match:** **C7**; **S27**, **S29**, **S30**, **S31**.
...
6. The book distinguishes radiance from diaspora. A small number of trained carriers can transmit language or method; whole migrating communities can carry living speech, customs, and memory, as Romani and modern Indian diasporas demonstrate.
   ...
   **Thesis match:** **C7**; **S29**, **S31**. **Candidate:** **NEW-P**, **NEW-R**.
...
11. A calibrant order does not abolish government. It places the king or government within an order it did not create and cannot own, while distributing correction and responsibility across society.
   ...
   **Thesis match:** **S36**. **Candidate:** **NEW-A**.

12. India must not turn its natural languages into smaller authority-bound pyramids. Sanskrit should remain the invariant calibrant while Marathi, Tamil, Hindi, Bengali, Konkani, and other *prākṛtika* languages remain free to live and change.

   **Thesis match:** **S8**, **S15**, **S29**, **S36**. **Candidate:** **NEW-S**.
...
## Candidate Dispositions After Thesis Reconciliation

The `NEW-*` labels remain beside chapter arguments so the reasoning behind the revision can still be traced. Every marker now has a final disposition.

### Promoted or Made Explicit

- **NEW-A → C8 and expanded S36:** Calibrant order now appears as a core thesis. S36 states its positive architecture and explains why the pyramid cannot own it.
- **NEW-C → S44:** Civilizational memory now stands as part of the engineering problem Sanskrit's preservation system had to solve.
- **NEW-L → S46:** The *sūtra-lakṣaṇam* now supplies the recurring design test for the fractal claim.
- **NEW-M → S45:** Verb and sentence engineering now has a thesis distinct from the general atomic-fractal statement in S10.
- **NEW-N → S47:** The four preservation modes now have their own cross-cutting thesis.
- **NEW-P → S48:** Movement and authorship are now separated explicitly.
- **NEW-Q → S49:** Sanskrit Radiance Mapping now appears as a repeatable research method.
- **NEW-T → S50:** The need for new English vocabulary now stands as part of recovering the engineering.

### Absorbed into Existing Theses

- **NEW-B → expanded S39:** *Viveka*, purpose, and action now displace factional identity across the contested words.
- **NEW-E → C1, S4, and S37:** Infinity, Vāk, and Oṃ remain supporting material rather than a separate thesis.
- **NEW-F and NEW-G → expanded S38:** The thesis now includes all eight methods and names concealment and projection as operations of **आसुरी माया (*āsurī māyā*)**.
- **NEW-H → expanded S12 and S14:** Patañjali's purposes of grammar and the earlier *vaiyākaraṇāḥ* now appear explicitly.
- **NEW-I → expanded S29:** Drift, deviation, and divergence now have distinct definitions.
- **NEW-J → expanded S18:** The sonomeric architecture is now physically and acoustically testable.
- **NEW-K → expanded S19:** The subcontinental sound superset now appears explicitly.
- **NEW-O → expanded S2, S33, and S34:** *Chandas* now appears as an error-detecting layer.
- **NEW-R → expanded S31:** The contact thesis now includes Wave 3 and the diaspora distinction.
- **NEW-S → C8, S29, and expanded S36:** Sanskrit remains the calibrant while natural languages remain free to change.

### Retained as an Example

- **NEW-D → C8 and S36:** *Darśana* and the temple demonstrate calibrant order; they do not require an independent thesis.

## Final Consistency Results

1. S10 remains the concise atomic-fractal spine; S45 and S46 now carry sentence engineering and the recurring design test.
2. S19 now states the subcontinental sound-superset argument directly.
3. S38 now matches the eight methods in Chapter 1 and the **आसुरी माया (*āsurī māyā*)** analysis in Chapter 2.
4. S31 now includes Wave 3 and the distinction between trained carriers and migrating populations.
5. The erroneous “Chapters 18 and 18” reference in S6 now points to Chapters 18 and 19.
6. S32 remains appendix-only and continues to support the Language Factory demonstration.
7. S50 places the vocabulary thesis at the intersection of engineering, category theft, and recovery.

---

## Retention Rankings by Chapter

These ranks apply to each **occurrence** of an argument. They do not rank the importance of the thesis itself.

- **A — Load-bearing:** indispensable to the chapter's function or to the book's proof.
- **B — Necessary:** required mechanism, evidence, explanation, or orientation; supporting detail may still be trimmed.
- **C — Reinforcement:** useful, but established more fully elsewhere or carrying more detail than the argument requires here.
- **D — Removable:** duplicated, tangential, defensive, or expendable without weakening the book.

The **primary home** identifies where the complete argument should remain. An occurrence assigned to another chapter can then be shortened to a clear callback.

### Preface — Beyond the Red Lotus

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| Pref.1 | C | Preface | Establishes the author's path from *Operation Red Lotus* to this inquiry, but the historical detail can be shorter without affecting the thesis. |
| Pref.2 | A | Preface | States the discovery that connects Sanskrit to calibrant order and explains why this book exists. |
| Pref.3 | A | Preface | Gives the reader the book's central engineering distinction before the technical demonstration begins. |
| Pref.4 | B | Preface | Makes calibrant order concrete through a familiar practice; the example was added to prevent the opening from remaining abstract. |
| Pref.5 | B | Preface | Gives the calibration claim a personal, audible example and prepares the later sound and preservation chapters. |
| Pref.6 | A | Preface | Defines the subtitle and the three properties that organize the complete book. |
| Pref.7 | B | Preface | States the direction claim clearly enough for the reader to understand what the later evidence will test; Chapters 17–20 carry the proof. |
| Pref.8 | B | Preface | Establishes the tone contract and identifies the protagonists and antagonists before the argument begins. |
...
| 0.8 | B | Chapters 14–15 | Introduces the living preservation system; later chapters provide the complete demonstration. |
| 0.9 | B | Chapters 10 and 14 | States the fractal test before the book applies it across language and preservation. |

### Chapter 1 — One, the Apex, and the Finite

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 1.1 | A | Chapter 1 | Defines the geometry and first principle of the pyramid. |
| 1.2 | A | Chapter 1 | Establishes the pyramid as a created deformation rather than a natural order. |
| 1.3 | A | Chapter 1 | Explains why distributed calibration threatens an apex and supplies the motive for concealment. |
| 1.4 | B | Prologue and Chapter 1 | Turns Svarbhānu from an image into the recurring method used throughout the book. |
| 1.5 | A | Chapter 1 | Makes civilizational memory part of the struggle and supports the two-enemy engineering thesis. |
| 1.6 | B | Chapter 1 | Explains chronology as an instrument of containment rather than merely a disputed dating scheme. |
| 1.7 | A | Chapter 1 | Supplies the book's complete diagnostic list of the pyramid's recurring methods. |
| 1.8 | B | Chapters 1 and 3 | Connects the pyramid to conduct aligned with *asat*; Chapter 3 supplies the fuller action-versus-faction analysis. |

### Chapter 2 — Category Theft and Āsurī Māyā

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 2.1 | A | Chapter 2 | Directly tests and defeats the claim that Pāṇini's supposed codification explains Sanskrit's invariance. |
| 2.2 | B | Chapters 2 and 14 | Distinguishes documentation, authority-bound preservation, and distributed calibration through concrete comparisons. |
| 2.3 | A | Chapter 2 | Restores the missing category of a deliberately engineered and generative language. |
| 2.4 | B | Chapters 2 and 6 | Esperanto demonstrates why generativity alone does not defeat entropy. |
| 2.5 | A | Chapter 2 | Answers the opening comparison by identifying the Vedas as the missing calibrant. |
| 2.6 | A | Chapter 2 | Names the connected category thefts that the rest of the book dismantles. |
| 2.7 | B | Chapter 16 | Introduces the two domains because Chapter 2 needs the distinction; Chapter 16 carries the full proof. |
| 2.8 | C | Preface and Chapter 3 | The post-1857 shift supplies historical motive, but the engineering argument does not depend on it here. |
| 2.9 | A | Chapter 2 | Defines concealment and projection as the chapter's account of **आसुरी माया (*āsurī māyā*)**. |
...
| 3.8 | A | Chapters 3 and the Epilogue | Establishes the two competing fractals that connect the language argument to calibrant order. |

### Chapter 4 — The Fourth Abrahamic Religion

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 4.1 | A | Chapter 4 | States the chapter's distinctive claim and identifies the retained architecture. |
| 4.2 | B | Chapter 4 | Demonstrates continuity through origin, promised end, and authorized solution. |
| 4.3 | A | Chapter 4 | Connects progressivism to the foundational dogma that excludes prior civilizational authorship. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 5.1 | A | Chapter 5 | Defines *vyākaraṇam* as analysis and decoding rather than the creation of Sanskrit's standard. |
| 5.2 | A | Chapter 5 | Establishes the pre-Pāṇinian analytical lineage through named evidence. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 6.1 | A | Chapter 6 | Defines the two enemies that the larger preservation architecture had to defeat. |
| 6.2 | A | Chapter 6 | Gives unintended linguistic entropy its Sanskrit diagnosis and its principal example. |
| 6.3 | A | Chapter 6 | Establishes drift, deviation, and divergence as distinct movements used later in the book. |
| 6.4 | A | Chapter 6 | Tests the four language categories against entropy and connects this chapter to the 2×2. |
| 6.5 | A | Chapters 2 and 6 | Esperanto demonstrates that engineered generativity does not preserve itself. |
| 6.6 | B | Chapters 14–15 | Previews the checks that resist entropy; the preservation chapters carry the full mechanism. |
| 6.7 | A | Chapters 6 and 16 | Establishes why distribution is part of the engineering against deliberate attack. |
| 6.8 | B | Chapters 6 and 16 | Prevents recorded Vedic variation from being mistaken for uncontrolled drift. |
| 6.9 | B | Chapters 6 and 19 | Applies the technical distinctions to orbital and more distant languages. |
| 6.10 | C | Chapter 6 and Epilogue | Extends the two-enemy distinction beyond language, but needs only enough space to prepare the *Second Shanti* argument. |

### Chapter 7 — ॐ (*Oṃ*): The Anatomy of Sound

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 7.1 | A | Chapter 7 | Establishes the body as the first sound-producing instrument and the starting point for the engineering demonstration. |
| 7.2 | A | Chapter 7 | Gives non-specialists the physical distinction between consonants and vowels required by Chapters 8–10. |
| 7.3 | B | Chapter 7 | Establishes that every language selects from a larger human sound field. |
| 7.4 | A | Chapters 7 and 9 | Introduces Sanskrit's anatomical and temporal axes before the grid is assembled. |
| 7.5 | B | Chapters 7 and 9 | Provides the broad sound classes needed to read the more detailed grid. |
| 7.6 | B | Chapter 7 | States why the engineering claim can be tested directly in the reader's body; the earlier sections provide the test. |

### Chapter 8 — The Sounds of the Indian Subcontinent

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 8.1 | A | Chapter 8 | States the chapter's central subcontinental-superset claim. |
| 8.2 | A | Chapters 8–9 | Establishes the sonance–sonomer distinction required to describe selection and scope. |
| 8.3 | A | Chapter 8 | Supplies the strongest numerical evidence from the southern and forest-belt surveys. |
| 8.4 | A | Chapter 8 | Performs the decisive comparison against the pyramid's preferred language-family grouping. |
| 8.5 | B | Chapter 8 | Interprets the unfilled cells so the reader does not have to infer what the gaps mean. |
| 8.6 | C | Chapter 17 | Prepares the later retroflex argument; the full discussion belongs in Chapter 17. |
| 8.7 | B | Chapters 8–9 | Clearly separates the regional sound inventory from Sanskrit's deliberate architectural selection. |

### Chapter 9 — The *Varṇamālā*: The Sonomeric Grid

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 9.1 | A | Chapter 9 | Converts the inherited garland into a claim of deliberate selection and arrangement. |
| 9.2 | A | Chapter 9 | Defines the address of every reusable sonomer through physical production. |
| 9.3 | A | Chapter 9 | Demonstrates how the two principal axes produce the twenty-five-cell consonant grid and keep its addresses distinct. |
| 9.4 | A | Chapters 9–10 | Defines the *akṣara* and *mātrā*, both of which the later engineering demonstration requires. |
| 9.5 | B | Chapter 9 | Shows that duration, pitch, and nasality remain separate controls rather than an undifferentiated vowel inventory. |
| 9.6 | A | Chapter 9 | Snap-to-grid supplies a concrete operation showing how contextual sound returns to a stable address. |
| 9.7 | A | Chapter 9 | States the selection-and-scope principle that explains inclusion, restriction, and exclusion. |
| 9.8 | A | Chapters 9 and 16 | Applies selection and scope to the two domains and defeats the old-versus-new chronology. |
| 9.9 | A | Chapter 9 | Restores *varṇa* to a measured sound-particle and places writing after sound. |
| 9.10 | A | Chapter 9 | Establishes that Pāṇini indexed an existing architecture rather than creating it. |
| 9.11 | B | Chapters 9–10 | Summarizes the grid as the first complete specification and prepares the move from sonomer to atom. |

### Chapter 10 — Building *Dhātuḥ*: Sanskrit's Atom

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 10.1 | A | Chapter 10 | Establishes the semantic atom and replaces the botanical category on which the later engineering argument depends. |
| 10.2 | A | Chapter 10 | Supplies the chapter's concrete construction from selected sound-particles and measured scaffold to semantic atom. |
| 10.3 | B | Chapter 10 | Explains the internal division of work that makes the scaffold and timing analyses intelligible. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 11.1 | A | Chapter 11 | Defines the engineering problem solved when a semantic atom becomes a sentence-ready verb. |
| 11.2 | A | Chapter 11 | The five worked Vedic procedures are the chapter's principal demonstration rather than an abstract description of grammar. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 12.1 | A | Chapter 12 | Defines the move from meaningful lexical form to a completed form carrying a sentence relation. |
| 12.2 | B | Chapter 12 | The Vedic ⟪कृ⟫ family gives one intelligible demonstration of bonding across several word-types. |
| 12.3 | A | Chapter 12 | Vedic sentences provide the direct evidence that complete grammatical relations already functioned in the corpus. |
| 12.4 | A | Chapter 12 | Connects encoded relations to free word order and explains its compositional and preservational purpose. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 13.1 | A | Chapter 13 | Expands the engineering thesis from constructing Sanskrit to preserving it against both entropy and deliberate attack. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 14.1 | A | Chapter 14 | States the greater engineering feat that the complete preservation matrix must demonstrate. |
| 14.2 | A | Chapter 14 | Identifies distributed human transmission as the archive that resists both medium failure and institutional capture. |
| 14.3 | B | Chapter 14 | Places Auditure inside a broader taxonomy of preservation and prevents all unwritten transmission from being treated as one method. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 15.1 | A | Chapter 15 | Makes the preservation architecture empirically available through recitation still performed in the present. |
| 15.2 | B | Chapter 15 | Explains how *Śikṣā* trains the human instrument and what a teacher and listener must detect. |
| 15.3 | A | Chapter 15 | The eleven *pāṭhāḥ* provide the chapter's principal evidence of deliberate combinatorial preservation. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 16.1 | A | Chapter 16 | Replaces the old-versus-new chronology with the chapter's central claim of two functional domains within one language. |
| 16.2 | A | Chapter 16 | Explains why the invariant and generative domains require different breadth and permissions. |
| 16.3 | A | Chapter 16 | Reverses the primitive-Vedic claim by showing that its additional range performs specified work. |
| 16.4 | B | Chapter 16 | Organizes many technical differences into four readable functions; the detailed inventory can remain in the appendix. |
| 16.5 | A | Chapter 16 | Shows that variation among Vedic forms and styles follows purpose and does not by itself establish chronology. |
...
| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 17.1 | A | Chapter 17 | States the connected mouth, mind, and order claim that the chapter must demonstrate. |
| 17.2 | A | Chapters 8 and 17 | Retroflexion supplies the strongest physical link between Sanskrit's engineered selection and the subcontinental sound field. |
| 17.3 | B | Chapter 17 | Reduplication provides one grammatical feature in the five-part cluster; the number of examples can be reduced without losing it. |
| 17.4 | B | Chapter 17 | Receiver grammar supplies one of the chapter's subcontinental grammatical postures, though its philosophical development can be concise. |
| 17.5 | B | Chapter 17 | Doer de-centering adds a second grammatical posture needed by the cluster; the comparative detail is trimmable. |
| 17.6 | B | Chapter 17 | Folded action completes the five-part cluster and demonstrates another engineered regional construction. |
| 17.7 | A | Chapter 17 | The connected cluster, rather than any isolated feature, carries the chapter's argument against casual borrowing. |
| 17.8 | A | Chapter 17 | The fixed Vedic corpus closes the claim that the complete cluster entered Sanskrit through later borrowing. |
| 17.9 | B | Chapter 17 | Shows that Sanskrit integrates regional features into one architecture; part of the supporting recap can be shortened. |
| 17.10 | A | Chapters 2 and 17 | Adds the subcontinental architecture of distributed grammatical knowledge to the physical and grammatical evidence. |
| 17.11 | A | Chapters 17–18 | Draws the home inference from the combined mouth, mind, and order evidence. |

### Chapter 18 — The Wrong Question

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 18.1 | A | Chapter 18 | Replaces the ancestry-first question with the architectural question on which the chapter depends. |
| 18.2 | A | Chapter 18 | Collects the six requirements against which every proposed origin account is tested. |
| 18.3 | A | Chapter 18 | Demonstrates the categorical limit of genealogy rather than merely rejecting particular reconstructions. |
| 18.4 | B | Chapters 18–19 | Explains how speculative ancestry acquires authority through presentation; Chapter 19 supplies the concrete asterisk case. |
| 18.5 | A | Chapters 18–19 | Exposes the interdependent chain that must keep Sanskrit outside its demonstrated category and civilizational home. |
| 18.6 | A | Chapter 18 | Prevents genetic or demographic movement from being substituted for evidence of linguistic authorship. |
| 18.7 | C | Chapter 18 and its endnotes | Alternative histories of refugees, deserters, and other incoming men defeat *elite dominance* as the only story, but the extended corridor history can be substantially reduced. |
| 18.8 | B | Chapter 18 | Gives the author's speculation its civilizational reason: long memory must survive entropy and deliberate erasure. |
| 18.9 | B | Chapter 18 | States the lineage account of Vāk, the seers, and non-ownership; the several supporting mantras need not all receive equal space in the body. |
| 18.10 | A | Chapter 18 | Joins Sanskrit and the Vedas into the single engineered architecture that an origin account must explain. |
| 18.11 | A | Chapters 17–18 | Uses the complete architecture, not one isolated feature, to identify Sanskrit's subcontinental home. |
| 18.12 | C | Chapters 5 and 18 | Repeats the heroic-erasure conclusion about Pāṇini after Chapters 5, 13, and 16 have already established his role. |

### Chapter 19 — PIE in the Sky

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 19.1 | A | Chapter 19 | Schleicher's fable provides the chapter's clearest historical demonstration that the supposed recovered language had to be constructed. |
| 19.2 | A | Chapter 19 | Exposes how the asterisk simultaneously assigns ancestry and shelters the reconstruction from responsibility for that claim. |
| 19.3 | A | Chapters 18–19 | Applies the complete engineering test directly to PIE and establishes the category failure. |
| 19.4 | B | Chapter 19 | Explains how repetition in reference works turned reconstruction into ordinary ancestry; the extended historical timeline can be trimmed. |
| 19.5 | A | Chapter 19 and Appendix Part 1 | The ⟪कृत्⟫ family provides a worked demonstration of how the reconstructed recipe reverses direction. |
| 19.6 | A | Chapter 19 | The *jan / gen / kin / king* sequence makes the dictionary reversal concrete and accessible to a general reader. |
| 19.7 | A | Chapter 19 | Supplies the positive forward mechanism that replaces ancestry with Sanskrit's outward radiance. |
| 19.8 | B | Chapters 19–20 | Shows that contact can carry operators and analytical methods as well as individual words; Chapter 20 develops the routes. |
| 19.9 | A | Chapter 19 | Turns the Radiance Thesis into a repeatable investigation rather than leaving it as a general counterclaim. |
| 19.10 | C | Chapters 3 and 19 | The *asura / ahura* comparison reinforces action over lexical obsession, but Chapter 3 now carries that principle and Chapter 19 does not depend on this family. |

### Chapter 20 — Life After PIE

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| 20.1 | A | Chapter 20 | States the chapter's positive task: trace outward transmission after removing the imaginary ancestor. |
| 20.2 | B | Chapter 20 | Wave 1 provides evidence for early trained carriers; the individual routes need different amounts of detail according to their records. |
| 20.3 | B | Chapter 20 | Wave 2 explains the outward movement of analytical method and prepares the documented and proposed transmission routes. |
| 20.4 | A | Chapters 19–20 | Explains how a received form can become native and drift without requiring descent from a common parent. |
| 20.5 | B | Chapter 20 and Appendix Part 3 | Eastward and westward sound-matrix transmission supports radiance of method; detailed provenance belongs in the appendix and notes. |
| 20.6 | C | Chapter 20 | The diaspora distinction prevents population movement from being confused with specialist transmission, but its long modern history can be reduced sharply. |
| 20.7 | A | Chapter 20 | Defines Wave 3 and states how this book consciously carries the recovered architecture. |
| 20.8 | B | Chapters 20 and the Epilogue | Gives the reader a role in transmission and prepares the closing invitation without adding another proof. |

### Epilogue — The Atris Find the Sun

| Argument | Rank | Primary home | Reason |
|---|---|---|---|
| Ep.1 | A | Epilogue | Completes the eclipse spine, records what the book has removed, and identifies the work that remains. |
| Ep.2 | C | Epilogue | The *samudra-manthana* supplies a second metaphor for turning accumulated philology toward recovery, but the closing argument does not require its extended retelling. |
| Ep.3 | B | Epilogue | The contrast between enduring flow and enduring containment restates calibration versus codification in the language of the closing metaphor. |
| Ep.4 | B | Epilogue and Appendix Part 1 | Converts the book's critique into a concrete research program; the detailed procedure and examples can live in the appendix. |
| Ep.5 | A | Epilogue | Returns the linguistic demonstration to the two fractal architectures that frame the complete book. |
| Ep.6 | A | Epilogue | States why distributed civilizational memory is the deeper object protected by the calibrant. |
| Ep.7 | A | Epilogue | Gives the reader a concise synthesis of the book's four demonstrated results. |
| Ep.8 | A | Epilogue | Restores *āryatva* as learned conduct and supplies the book's outward invitation. |
| Ep.9 | A | Epilogue | Carries the demonstrated linguistic architecture into the *Second Shanti* thesis of order through calibration. |
| Ep.10 | B | Epilogue | *Bhikṣā*, renunciants, and Vedic lineages provide concrete social evidence; the argument needs the relationships more than every illustration. |
| Ep.11 | B | Epilogue | Prevents calibrant order from being mistaken for the abolition of government and places the king within an order he does not own. |
| Ep.12 | B | Epilogue | Applies the architecture inward so that Sanskrit's preservation does not become authority over India's living natural languages. |
| Ep.13 | A | Epilogue | Ends with distributed relearning rather than a replacement apex and assigns the continuing work to readers and communities. |
...
- **6.10:** preserve the explicit bridge from language engineering to the two enemies faced by other civilizational structures.
- **10.10:** preserve enough of Oṃ to carry the radiant and fractal claim beyond technical construction.
- **Ep.9–Ep.13:** these arguments extend calibrant architecture into society and the *Second Shanti* series. They are not cleanup targets merely because the linguistic proof is complete.
