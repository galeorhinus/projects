...
The complete previous section can always be recovered with:

```sh
git show f85284be:atomicSanskrit/as_1_03_strategic.md
```

## Disposition

- The *bound* example remains in the revised opening.
- The explanation of ***nānārtha***, ***anekārtha***, and ***anekaśabda*** moves mainly into the existing endnote `nanartha-homonymy`; the ***aja / a-ja*** example remains in the body.
- Yāska's action-based method and his alternative derivations remain. The body concentrates on ***asu-ra*** and ***a-sura***; the endnote preserves all four alternatives.
- The Indra and Varuṇa passages remain in the body.
- The Agni, Rudra, and Mitra evidence remains in summarized form and in its existing endnote.
- The institutional incentive paragraph is absorbed into the expanded account of what the conflation gives the pyramid.
- The old claim that ***a-sura*** is a later *laukika* parse is removed because it contradicts the revised argument. Its previous wording remains below for review.
- The previous conclusion is replaced by the sharper action-versus-faction conclusion.
