# Chapter 19.1 Rewrite — Lost and Found

**Date:** 2026-08-09  
**Reason:** Chapter 2 now explains constructed languages and places them in the 2x2 matrix. Section 19.1 needed a shorter connection to that material and a clearer explanation of what Schleicher did.

## Replaced Text

> The first baker was August Schleicher. He made the bakery visible: in 1868 he published a fable in his reconstructed Proto-Indo-European — *Avis akvāsas ka*, "The Sheep and the Horses" — the first complete piece of literature written in a language no human community had ever spoken. Every form was reconstructed. In current notation, examples include \**ávis*, \**akvā́sas*, \**kr̥nuto*, \**wl̥qis*, and \**ágrom*. None was recorded in any speaker's language; each was baked from cognates collected backward across the daughter Indo-European languages.[NOTE: schleicher-1868-fable] The original fable did not place an asterisk before every form, and Schleicher did not invent the reconstruction asterisk. His *Compendium der vergleichenden Grammatik der indogermanischen Sprachen* (1861) systematized reconstructed forms within a complete ancestral language; the 1868 fable extended the reconstruction into connected prose.
>
