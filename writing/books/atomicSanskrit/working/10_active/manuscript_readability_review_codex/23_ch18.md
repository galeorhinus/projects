...
Keep *theory* in the table and preserve the original indictment. Replace only the two paragraphs after the table:
...
>
> The third row, *theory*, shows the same dispersal in another form. Greek ***theōros*** means spectator or seer, and the word's semantic field is vision. Sanskrit ⟪दृश्⟫ generates seeing, sight, the visible, and philosophical perspective within one family. What makes far more logical sense is that *theory* preserves another reflection of that Sanskrit semantic field. The pyramid's account instead sends the word toward a tentative **\*wer-(3)**, “to perceive,” and leaves Sanskrit out. Once surface shape outranks the semantic atom, one coherent field can be scattered among several imaginary ancestors.

This version removes the universal claim that Sanskrit never contains anything described as suppletion. It also avoids claiming that **पश्यति (*paśyati*)** follows without a replacement operation: Pāṇini explicitly documents that operation. The indictment remains intact because Sanskrit retains one semantic atom and one grammatical architecture where comparative reconstruction assigns two different ancestors. The *theory* connection remains in the argument as the book's more logical explanation rather than being discarded.
...
### Comments
Let's keep theory but say - what makes far more logical sense is....
