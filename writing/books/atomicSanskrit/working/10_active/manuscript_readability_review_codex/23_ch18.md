...
### Comments
The author directed that the chapter use the traditional *vyutpatti* method for the ⟪दृश्⟫–*theory* case and that the Epilogue hand the method to Indian universities for repeated Greek and Latin analysis. The *theory* table row was also corrected to show Latin *theoria* and Greek *theōria* before *theōros*.
