...
**Status:** SUPERSEDED — 2026-07-23. The author replaced this worked case with **⟪अस्⟫ / ⟪भू⟫** and moved the full *dṛś–theory* material to [LAF-R-078](../../40_reference/source_material/manuscript_readability_audit_lost_and_found.md#laf-r-078--the-retired-दृश्-theory-case).
### Original
...
### Comments
This decision was later superseded. The fivefold *vyutpatti* method and the university research handoff remain, but Chapter 18 now demonstrates them through **⟪अस्⟫ / ⟪भू⟫** and Latin ***sum, esse, fuī, futūrus***.
