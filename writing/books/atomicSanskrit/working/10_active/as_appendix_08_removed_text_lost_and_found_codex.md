# Appendix Part 8 Consolidation — Removed Text, Lost and Found

This file preserves every passage removed or replaced during the
Vaidika-Laukika ownership pass. Text may be restored from here if a later
review finds that the surviving chapter has lost an important beat, example,
or claim.

## LF-VL-001 — Chapter 0 §0.5

**Source:** `as_1_00_seekers.md`

**Action:** Initially replaced by three shorter paragraphs. The complete
passage was restored verbatim after the ownership decision was revised.
...
## LF-VL-002 — Chapter 2 §2.4

**Source:** `as_1_02_botanical.md`

**Action:** Replaced to remove the conflict between “not composed in time” and
the unknown Vedic beginning established in Chapter 0.
...
## LF-VL-003 — Chapter 14 §14.5

**Source:** `as_1_14_calibration.md`

**Action:** Replaced by the shorter “One Architecture, Two Domains” synthesis.
...
## LF-VL-004 — Chapter 16 §16.9

**Source:** `as_1_16_retroflex.md`
...
## LF-VL-005 — Chapter 16 §16.9

**Source:** `as_1_16_retroflex.md`

**Action:** Replaced by a pointer to both Chapter 9 and Appendix Part 8.

### Original text

Chapter 9 §9.8 showed why exact preservation and continuing generation place different demands on that shared sound-system.

## LF-VL-006 — Appendix Part 7 §7.5

**Source:** `as_3_07_vedic_carrier.md`

**Action:** Replaced by a bridge to Appendix Part 8 and §7.6.
...
## LF-VL-007 — Appendix Part 8 §8.1

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Replaced by a shorter bridge to Chapter 0 and a concise statement
...
## LF-VL-019 — Appendix Part 8 §8.2, repeated ten-category exposition

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Removed because Chapter 16 §16.2 owns the complete explanation of the ten contributions. The appendix retains only the codebook required by its figures and evidence records.
...
## LF-VL-020 — Appendix Part 8 §8.3, repeated īḷe introduction

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Removed because Chapter 16 §16.3 prints the opening mantra and introduces the **ईळे / ईडे** difference. The appendix retains the source-specific phonetic analysis.
...
## LF-VL-021 — Appendix Part 8 §8.3, repeated pitch-and-meter introduction

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Removed because Chapter 16 §16.3 owns the conceptual explanation of pitch and meter. The appendix retains the additional pluta and sentence-accent evidence.
...
## LF-VL-022 — Appendix Part 8 §8.4, repeated Ṛgvedic floating-upasarga example

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Removed because Chapter 16 §16.4 prints and explains **आ ... वहन्तु**. The appendix retains the Aitareya Brāhmaṇa prose control.
...
## LF-VL-023 — Appendix Part 8 §8.4, repeated upasarga conclusion

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Removed because Chapter 16 §16.4 owns the bounded-versus-generative conclusion. A shorter appendix paragraph now states only what the prose control establishes.
...
## LF-VL-024 — Appendix Part 8 §8.4, repeated vibhakti architectural conclusion

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Condensed because Chapter 16 §16.3 owns the benefit-versus-duplication argument. The appendix retains the complete adjacent verses, syllable counts, and Designed Variation classification.
...
## LF-VL-025 — Appendix Part 8 §8.5, repeated leṭ narrative

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Replaced by a compact technical collision record because Chapter 16 §16.4 owns the complete **ब्रवाणि / तारिषत्** narrative and architectural conclusion.
...
## LF-VL-026 — Appendix Part 8 §8.7, repeated conceptual close

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Removed because Chapter 16 §§16.2–16.6 own the conceptual interpretation of the technical comparison table.
...
## LF-VL-027 — Appendix Part 8 §8.8, derivation, composition, style, and chronology

**Source:** `as_3_08_one_architecture_two_domains.md`

**Action:** Removed because Chapter 16 §§16.5 and 16.7 own the style, chronology, compounding, and generativity arguments. The appendix remains focused on evidence not already presented in the body.
...
## LF-VL-029 — Appendix Part 8 reduction, evidence apparatus

**Source:** `as_3_08_one_architecture_two_domains.md`, former §§8.2–8.3

**Action:** Replaced by a shorter explanation of the same evidence states. The redesigned figures print every measure and evidence state in words, so the former bar-and-dot legend no longer applies. Chapter 9 retains the complete sonomer-selection argument.
...
## LF-VL-030 — Appendix Part 8 reduction, repeated PASS conclusions

**Source:** `as_3_08_one_architecture_two_domains.md`, former §§8.4–8.5

**Action:** Consolidated into the prose immediately following each exact example. The passages retain every contribution, load, boundary, and scope needed by the argument.
...
## LF-VL-031 — Appendix Part 8 reduction, former figure arrangement

**Source:** `as_3_08_one_architecture_two_domains.md`, former §8.4

**Action:** Replaced first by twenty-one figures and then by 83 unnumbered data cards. Each card retains one category, prints every field in full, and uses Devanagari without a repeated IAST line. The original eight figures embedded 112 truncated labels.
...
## LF-VL-032 — Appendix Part 8 reduction, repeated complete comparison

**Source:** `as_3_08_one_architecture_two_domains.md`, former §8.7

**Action:** Removed because the seventeen rows summarize the worked evidence and the complete figure record without adding another example or measurement.
...
## LF-VL-033 — Appendix Part 8 reduction, repeated open findings and stewardship qualifications

**Source:** `as_3_08_one_architecture_two_domains.md`, former §§8.6 and 8.8

**Action:** Consolidated. The revised prose retains each open finding and both historical cases.
