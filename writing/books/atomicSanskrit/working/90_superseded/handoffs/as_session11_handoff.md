...
4. **Verification queue** — `working/10_active/as_verification_todo.md` carries the inline `[VERIFY:]` markers logged across chapter drafts. The queue has not been worked since pre-night-sweep.
