...
The book exposes how Western philologists constructed an imaginary language called Proto-Indo-European, invented an imaginary people to speak it, and turned *ārya* into their imaginary race. The race keeps changing, but it remains emphatically *not Indian*. *Atomic Sanskrit* reveals this linguistic fraud as one front in a battle between two architectures of order that has continued across the ages.
