...
| CUT | 16 | ~3,800 |
| POINTER | 28 | ~6,300 |
| ENDNOTE | 9 | ~2,100 (moved, not cut from book — but cut from body) |
| PROMOTE | 4 | ~400 (small body savings via glossary/sidebar consolidation) |
| **Total findings** | **125** | **~18,900 words trimmed from body if all non-KEEP applied** |
