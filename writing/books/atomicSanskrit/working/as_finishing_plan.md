...
- [x] Apply the 34 🔴 findings marked `[APPLY REWRITE]` in `working/contrastive_framing_audit_2026-05-30.md`.
...
- [ ] Work through `working/as_verification_todo.md`. Each `[VERIFY:]` marker becomes a concrete check.
...
- [ ] Source: `working/sanskriti_prakriti_vikriti_vedic_corpus_research_2026-05-30.md`.

### B.3 — Deploy chosen epigraphs [ ]

- [ ] Per-chapter pass: insert the epigraphs chosen in `working/as_epigraph_plan.md`.
...
- [ ] Title + subtitle locked: ***Atomic Sanskrit: The Fractal Architecture of Sanātan*** (per current `as_book.yaml`).
...
- [ ] Per `working/public_facing/articles/article_release_table.md`, draft and place the priority essays.
