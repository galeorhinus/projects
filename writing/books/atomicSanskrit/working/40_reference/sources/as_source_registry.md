...
### `generativity-vidyut-040-pilot`

- **Citation:** Ambuda, Vidyut 0.4.0; source tag `py-0.4.0`, commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`.
- **Source type:** Original software, input datasets, API declaration, and implementation tests. Software output is not independent proof of grammatical or semantic validity.
- **Canonical locator:** `vidyut-prakriya/data/dhatupatha.tsv`, `sutrapatha.tsv`, README, architecture notes, Python declarations and integration tests, the argument definitions for *sanādi*, ordinary *kṛt*, and *taddhita*, and the 3.1/4.1 Kashika test files at the pinned commit.
- **Digital URL:** https://github.com/ambuda-org/vidyut/tree/f3ba4167d40eebc4b3023d24e66867aa6a8cdb32
- **Accessed:** 2026-09-12.
- **Local record:** `working/40_reference/sources/archive/documents/generativity-pilot/`; software, data, and source snapshots listed individually in `manifest.json`.
- **Integrity:** Individual SHA-256 checksums, exact download URLs, byte counts, and UTC retrieval timestamps are recorded in the manifest. The pilot runner validates these checksums before use.
- **Rights/storage:** Source code and data retained with the project's archived MIT license; preserve original provenance when redistributing.
- **Notes:** Supports the generator pilot and candidate crosswalk in `analysis/generativity/`. The installed Python constructors for krt/taddhita derivation do not expose an artha argument. The crosswalk is not a completed lexical-identity reconciliation. No deployment in published endnotes yet.
- **Base-meaning audit, 2026-09-12:** The same pinned Dhatupatha has 2,229 usable entries and 30 placeholder rows. `analysis/generativity/results/base_meanings.md` links the full extracted ledger, including source line numbers, original Sanskrit glosses, source URLs, and checksums. The first extraction yielded 2,632 provisional assignments and 38 interpretation gaps. The commentary review below resolves 28 gaps: 2,712 source assignments, or 2,710 after two documented repetitions are consolidated. Explicit segmentations and source-specific decisions live separately in `meaning_analysis.json` and `meaning_review.json`; the archived source remains unchanged. These are not a final vocabulary total. The older 2,168-entry inventory remains separate, and candidate crosswalk matches have not been accepted as lexical identities.
- **Follow-up, 2026-09-12:** Review of the remaining ten adds 29 assignments, yielding 2,741 before and 2,739 after the same two duplicate reductions. Five additional entries have interpreted lists, three have sourced partial counts, and two remain unenumerated. Some added meanings are supplied or clarified by the commentary rather than the pinned gloss alone; the meaning-level evidence fields identify the witness and any cross-reference. No derivational or inflectional multipliers enter these subtotals.
- **Formation-inventory update, 2026-09-13:** The archived argument definitions yield a reproducible census of seven *sanādi*, 122 ordinary *kṛt*, and 175 *taddhita* identifiers. `analysis/generativity/results/operation_inventory.json` stores the source URL and SHA-256 for every row. These 304 identifiers establish software coverage only. They do not establish 304 meanings, universal eligibility, or a vocabulary multiplier; every row remains outside the count pending semantic and base-level review.
- **Bounded *sanādi* update, 2026-09-13:** `analysis/generativity/run_sanadi_eligibility.py` applies one verbal-base operation at a time, without prefixes, to all 2,229 pinned engine entries. Causative and desiderative requests return output for every entry; *yaṅ* and *yaṅ-luk* return output for 1,775 and zero output for 454. The results are reconciled to the 2,634 base word-meanings without multiplying alternative surface forms. All candidates remain unadmitted pending semantic review. The three nominal-input operations are deferred until a nominal source inventory is declared.
- **यङन्त semantic-review update, 2026-09-13:** Rules 3.1.23 and 3.1.24 and the pinned `vidyut-prakriya/src/sanadi.rs` module were added to the archive. `analysis/generativity/results/yan_semantic_review.json` retains the source records and hashes. The review separates the general repetition and intensity meanings under 3.1.22 from crooked movement under 3.1.23 and disparaged action under 3.1.24. It also records that Vidyut 0.4.0 implements no separate 3.1.23 semantic-selection path. A broad source-gloss screen therefore produced 312 possible movement meanings for explicit review.
- **यङन्त approval update, 2026-09-13:** The author approved YAN-P1 through YAN-P5. `approved_yan_semantics.json` preserves that approval separately from the proposal report. `apply_yan_semantic_approvals.py` reviews each unique movement-screen candidate and writes `yan_movement_classification.csv`: 289 meanings directly denote movement and move to the 3.1.23 crooked-movement path; 23 do not themselves denote movement and return to general 3.1.22 review. The seven initial edge cases are resolved from the Kāśikā's requirement that the धातुः itself express movement. No 3.1.23 scope deferral remains.
- **First verbal-ledger update, 2026-09-13:** Rule 3.1.25 was added to the archive, bringing it to 922 records. The approved `admission_standard.md` treats a productive rule as positive semantic authorization, uses Vidyut for reproducible form construction, does not require dictionary attestation, and honors explicit restrictions. `verbal_derivation_ledger.csv` admits 12,522 derived word-meanings: 2,112 णिजन्त causatives, 2,634 सन्नन्त desideratives, 3,888 यङन्त word-meanings, and 3,888 यङ्लुगन्त word-meanings. With 2,634 base meanings, the bounded verbal subtotal is 15,156. Rule 3.1.25 prevents 522 चरादिगणः-only first-णिच् forms from being miscounted as causatives. Six explicit अनभिधानम् operation/base rows and 1,070 zero-output operation/base rows remain outside the subtotal. This is a research subtotal; no published vocabulary total or manuscript claim changed.
- **Initial उपसर्ग inventory and pilot update, 2026-09-13:** `upasarga_inventory.csv` preserves the 22 प्रादि forms listed with the 1.4.58 commentary while normalizing निस्/निर् and दुस्/दुर् to 20 inventory identities. `run_upasarga_pilot.py` verifies Aṣṭādhyāyī 1.4.58, 1.4.59, 1.4.60, and 1.4.80 against the pinned `sutrapatha.tsv`, then applies each identity once to गम् through Vidyut 0.4.0. All 20 expected constructions match. The 21 generated spellings are diagnostics; the सम् + गम् alternatives remain one operation/base relation. This initial record treated the prospective 52,680-pair matrix as a semantic review queue. The corrected generated-capacity treatment is recorded immediately below. No new source was required: the rule pages, pinned rule table, engine source, and Dhātupāṭha were already present among the 922 archived records. No manuscript or published total changed.
- **उपसर्ग generated-capacity correction, 2026-09-13:** The pilot's initial attestation gate was rejected because it contradicted the approved admission standard used for the सनादि passes. `admission_standard.md` now states that a rule-licensed, successfully constructed उपसर्ग-धातु pair enters generated capacity even when its exact conventional gloss remains open. `build_upasarga_generation_ledger.py` tested all 44,580 source-entry operations; every operation generated. Reconciliation across the 2,634 original base meanings produced 52,680 prefixed word-meanings and a bounded verbal-capacity subtotal of 67,836. `upasarga_conflicts.json` provides a separate channel for actual grammatical conflicts; the reviewed general rules supplied none. Missing attestation is not an exclusion. Root-specific conflict review and meaning enrichment remain open. The result is a research subtotal and does not alter the manuscript.
- **Six-pass generativity expansion, 2026-09-13:** The root-specific धातुपाठ audit now records 134 one-prefix exclusions and 21 source-attested prefixed meaning enrichments, yielding 52,567 one-prefix meanings. The next bounded layers admit 250,040 one-prefix + one-सनादि meanings, 522 true चरादिगण causatives formed with a second णिच्, and 1,051,340 meanings from exactly two ordered prefixes. The ordinary-कृत्प्रत्यय pass classifies all 122 identifiers and admits 29,996 word-meanings from twelve identifiers carrying fourteen explicit laukika semantic operations. Together the completed layers yield a research subtotal of 1,399,621 word-meanings. The archive now contains 925 records, including the pinned कृदन्त implementation and the rule pages for 3.1.124 and 3.4.67. Every report stores source URLs and checksums; the large stacked ledgers are compressed CSV files. The integrated suite passes all 156 tests. This is not a complete vocabulary total and has not changed the manuscript.

### `generativity-dhatu-commentary-review`

- **Citation:** University of Hyderabad, Concordance of Paninian Dhatuvrittis: Madhaviya Dhatvritti by Sayana (Phadake and Sadasiva Sarma Sastri edition, Chowkhamba, Benares, 1934); Kshiratarangini by Kshirasvamin (Yudhishthira Mimamsaka edition, Ramlal Kapur Trust, 2005); Dhatupradipa by Maitreyarakshita (Sishachandra Chakravarti Bhattacharya edition, Ramlal Kapur Trust, 1986), as identified by the site's edition statement.
- **Source type:** University-hosted transcriptions of traditional grammatical commentary, with a concordance and edition information. Not a fresh collation against scans.
- **Digital URLs:** https://sanskrit.uohyd.ac.in/scl/dhaatupaatha/About.html ; https://sanskrit.uohyd.ac.in/scl/dhaatupaatha/gaNa.html ; individual commentary URLs in the archive manifest and decision ledger.
- **Supporting base transcription:** https://sanskritdocuments.org/doc_z_misc_major_works/dhatupatha.html
- **Accessed:** 2026-09-12.
- **Local record:** `working/40_reference/sources/archive/documents/generativity-pilot/`: 576 `dhatu-mA*.html` / `dhatu-kRi*.html` / `dhatu-XA*.html` commentary snapshots, the About page, legacy concordance, current interface wrapper, and Sanskrit Documents base transcription. Together with the earlier 47 software/data and rule records, the archive now has 627 records. This includes candidate pages retained for comparison, not only passages used as evidence in a decision.
- **Integrity:** Exact URLs, UTC retrieval timestamps, sizes, and SHA-256 checksums are stored per file in `manifest.json`. The original source files are unchanged. The review validates selected locator phrases against the archived commentary.
- **Decisions:** `analysis/generativity/meaning_review.json`; readable results in `analysis/generativity/results/meaning_review.md`. Across the two commentary passes: 33 interpreted lists, three partial counts, and two unenumerated entries. MR24-MR30 record meaning-level source anchors and reading attribution; MR31-MR32 retain the unenumerated entries without a count. Downloaded passages not used in a decision are not thereby marked verified.
- **Additional evidence:** kRi720 distinguishes asana (throwing) from the alternative ashana/vyapti (pervasion); kRi749 explicitly assigns vi's meanings to vevi, while XA766 records the Vedic restriction. mA732 expressly records hu in the satisfying sense as well as the alternative giving/eating/taking readings. mA653 supplies sowing, impregnation, and cutting examples for vap. mA821 discusses additional radh meanings but illustrates droha with prefixed forms, retained for the prefix stage. mA487 and mA493 do not supply a finite enumeration for kage and van. Each cited page's exact URL and checksum is in the manifest.
- **Identity findings:** Madhaviya mA494/mA511 explicitly explain the repeated jval entry through mit status; mA232 refers back to the earlier gadi entry (mA52). Both pairs retain their source records but share a provisional word-and-meaning identity for counting. Other repeated-citation groups remain unmerged.
- **Identity batch 1, 2026-09-12:** `analysis/generativity/identity_review.json` records ten groups / 22 entries, with full evidence in `results/identity_review.json` and a before/after table in `results/identity_review.md`. mA418/mA1299 connect bhush's adorning meaning across classes; mA987/kRi1213 connect chut's cutting meaning; kRi911/mA1088/mA1351 connect dhu's shaking meaning across three classes; mA601/mA1003 connect dhru's shared stability meaning while retaining movement separately. These consolidate five assignments, reducing the adjusted subtotal from 2,739 to 2,734. Bhu, bhat, and dhup retain different meanings; bhram, dhri-ng, and dhvan remain open with specific follow-ups. Source-specific variants found for bhu and dhup are recorded for later meaning review, not added to this batch's count. Original source and meaning IDs remain intact; only explicitly documented shared assignments receive the same counting key.
- **Identity batch 2, 2026-09-12:** Decisions IR11-IR20 in the same ledger cover ten more groups / 20 entries. Separate reports are generated as `results/identity_review_batch_02.md` and `.json`; batch 1 is also retained separately. mA433/mA924 support jharjh's shared paribhashana meaning and the accent-purpose repetition; mA811/mA1050 link khid's dainya entries; mA876/mA1121 link nabh's himsa entries. Three assignments are consolidated, reducing 2,734 to 2,731. Ghat, ghush, khud, nad, and shik retain distinct listed meanings. Ghri and nat remain open. The latter was checked against mA192/mA481, kRi201/kRi504, and XA509: the common base is explicit, but the competing meaning readings prevent an automatic nrtta merger. Additional source variants and jharjh's unresolved tarjana/bhartsana relationship remain explicit follow-ups. The 25 newly archived pages retain their original URLs, timestamps, and checksums. No original source entry, manuscript passage, or endnote was changed.
- **Scope findings:** The commentary records prefix requirements, meaning-conditioned pada use, nominal-derived entries, and Vedic-only treatment of selected inputs. These must be carried into the derivation stage rather than assuming every source row supports every operation.
- **Rights/storage:** Public university-hosted source pages retained for research verification with original notices. No manuscript prose or published endnote deployment in this pass.

### `generativity-primary-rule-pilot`

- **Citation:** Panini's *Astadhyayi*, principal rules for the generativity pilot, with Kashika and other traditional commentary as compiled by Sanskrit Documents.
- **Source type:** Primary grammatical rules and traditional commentary in a public digital compilation.
- **Canonical locator:** Individual sutra wording and commentary; principal pilot passages include 3.1.7-9, 3.1.22, 3.1.26, 3.1.133, 3.3.10, 3.3.18, 3.3.115, 3.4.21, 4.1.120, and 5.1.119. The manifest also lists pages retained for deferred operation families.
- **Digital URL:** https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/3/3.1.7.htm
- **Additional URLs:** All 39 exact page URLs are recorded individually in the archive manifest, not inferred from this representative link. The semantic pass added 3.3.117 and 1.4.60.
- **Accessed:** 2026-09-12.
- **Local record:** `working/40_reference/sources/archive/documents/generativity-pilot/rule-*.html` and `manifest.json`.
- **Integrity:** Individual SHA-256 checksums and UTC retrieval timestamps in the manifest; source HTML retained unchanged.
- **Rights/storage:** Public Sanskrit source compilation retained for research verification.
- **Notes:** Principal passages were checked for the operations and conditions used by the pilot; downloading other pages does not mark them verified. Some page names and numeric headings disagree: `1.4.59.htm` contains the 1.4.60 commentary, and `5.1.119.htm` mixes 5.1.118/119 headings. Locate by the actual sutra wording and reconcile numbering before publication. The separately archived sutrapatha supplies the engine's code-to-wording map. No manuscript correction or published endnote deployment in this pass.
- **Semantic-pass update:** `analysis/generativity/results/words_and_meanings.md` records the selected meaning applications. 3.3.117 supplies the instrumental and locative lyut meanings; its Nyasa explicitly discusses karana as an instrumental formation. 3.3.115 lists asana in the action-noun examples. The corresponding seat reading is labeled as an application of the locative rule, not as an exact quotation from this page. Dataset entry 06.0022 explicitly lists `stutO dIptO ca`, supporting separate praise and shine annotations for rc. Every selected row retains its source URL and locator; no whole-language count is asserted.
- **Identity batch 3, 2026-09-12:** Decisions IR21-IR50 cover thirty groups / 66 entries in `analysis/generativity/results/identity_review_batch_03.md` and `.json`. Eleven supported consolidations reduce 2,731 to 2,720; eleven groups retain different words or meanings and eight remain open. The 68 newly archived commentary pages retain URLs, timestamps, and checksums. Notable evidence: mA1029 and mA809 explicitly link repeated shad/shap entries; mA490 explicitly rejects treating the ghatadi and curadi shrana atoms as repetitions; mA1226 calls the idit shuthi repetition prapancartha; mA112/mA1326 explain arch's pada/nich-related repetition; mA448/mA1301 connect two arha entries while the third stays provisional; mA518/mA1211 support bal's shared living meaning while keeping grain storage; mA970/mA1191 link bil; mA442/mA1209 link chah; kRi530 supports the two kampana entries for chal; kRi928 links cham's eating use across classes. mA629 versus XA868 flags kshvid/svid, and mA80 versus mA1286/XA1337 flags barking/speaking. The ledger preserves those unresolved readings rather than altering the pinned data. Fifty-two groups are examined in total; 171 remain unreviewed. No manuscript or endnote changes.

### `generativity-identity-review-completion`

- **Scope, 2026-09-12:** The author authorized all remaining passes after the thirty-group trial. Decisions IR51-IR221 cover 171 exact-citation groups and 375 source entries in six batches. Every batch has its own before/after Markdown and JSON report under `analysis/generativity/results/`. The combined report is `identity_passes_complete.md`.
- **Sources:** The same University of Hyderabad primary commentary transcriptions documented above. This run added 409 commentary snapshots, bringing the archive to 627 records. Exact URLs, UTC retrieval times, byte counts, and SHA-256 checksums remain in `archive/documents/generativity-pilot/manifest.json`; each decision carries its own source filenames and quoted locator phrases. Candidate retrieval does not constitute verification, and the transcriptions have not been freshly collated against printed editions.
- **Counting result:** Batch subtotals are 2,708, 2,701, 2,691, 2,678, 2,663, and 2,653, down from 2,720 before these six batches. All 2,741 original source-meaning assignment rows remain. The separate counting keys consolidate only documented shared word-meanings. No derivational or inflectional multiplier has been applied, and this is not a replacement Sanskrit vocabulary total.
- **Examples:** mA856 explains plush's repeated burning entries through different aorist forms. mA932 explicitly attributes repetition of the tup/tump/tuph/tumph harming entries to accent; the four different words are not merged with each other. mA1028 explains sad's repeated meanings through grammatical forms and accent. mA1175 discusses the two dividing entries of vati. mA1311 records disagreement over whether initial u belongs to udhras, leaving its identity open. mA1208 requires distinguishing yam's grammatical exclusion from an independent lexical meaning.
- **Remaining work:** All 223 exact-citation groups have been examined. Thirty-seven remain wholly open, and 47 other groups contain a narrower follow-up. `identity_followups.md` and `.json` preserve all 84 records, including source links. Three partial meaning lists and two unenumerated entries remain separately in the meaning review. Cross-spelling identity, finer senses, and formation eligibility remain additional work.
- **Integrity:** The fetcher retains prior manifest records if a later request fails. Fifty-five regression tests cover source preservation, exact locators, scope, partial mergers, different words sharing a meaning, batch order, counts, and complete follow-up reporting. No manuscript, companion prose, published endnote, or historical wordspace calculation was changed.

### `generativity-reconciliation-01`

- **Scope, 2026-09-13:** Ten selected count-affecting follow-ups, IR117, IR141, IR145, IR156, IR164, IR170, IR194, IR201, IR210, and IR211. `analysis/generativity/results/reconciliation_review_01.md` and `.json` retain before/after treatment, original decisions and entries, proposed count effects, exact source phrases, URLs, access timestamps, and hashes. These proposals have not changed the 2,653 subtotal.
- **Sources:** Twenty-six additional University of Hyderabad commentary transcriptions and three extended grammatical commentary pages (6.4.92, 7.4.68, 1.3.89), declared in `analysis/generativity/reconciliation_sources.json`. The archive now contains 656 records, including 602 commentary pages and 42 rule-page snapshots. All exact URLs and SHA-256 records are in `archive/documents/generativity-pilot/manifest.json`. Existing snapshots were reused unchanged.
- **Principal locators:** kRi522 explicitly explains nR's repetition for mit treatment. kRi1335 and XA1369 identify repeated dhras under the u-marker reading. kRi889 and mA1247 distinguish rush in anger from harming. The extended commentary on the 1.3.89 page identifies yam's apariveshana wording as a mit prohibition. The rule number locates the hosted page; these grammatical discussions are not quotations of those sutras themselves.
- **Alignment corrections:** The patha's division sequence at 4.114-4.121 identifies the correct push occurrence, resolving a false conflict caused by retrieving the nourishing occurrence. Its 1.1031 ay/movement listing is aligned by neighboring entries as well as numbering, with kRi576 as a commentary witness. The existing 1.1139 yam/cessation listing remains. Do not overwrite pinned dataset rows when applying a later approved normalization.
- **Limits and disposition:** This is a source-transcription comparison, not a fresh collation of print editions. Four reductions are proposed, yielding 2,649 if approved. Lal, paksh, rat, and vr retain open reading or meaning questions. A downloaded candidate is not automatically verified. No manuscript, companion, endnote, or historical batch was edited.
- **Subsequent approval, 2026-09-13:** The author approved the supported corrections. `approved_reconciliation.json` and `apply_reconciliation.py` apply them in a separate normalized dataset, yielding 2,649. Original source rows and the nine historical batch decisions remain unchanged. The normalized CSV keeps original fields plus explicit corrected fields and grammar/lexical classification.

### `generativity-reconciliation-02`

- **Scope, 2026-09-13:** Corrected ay plus IR01, IR04, IR07, IR08, IR10, IR11, IR12, IR13, IR14. `analysis/generativity/results/reconciliation_review_02.md` and `.json` record before/after proposals against the applied 2,649 baseline, not the original 2,653 baseline. The four proposed reductions remain unapplied.
- **Sources:** Twenty-four added snapshots: 21 University of Hyderabad commentary transcriptions, the accented Sanskrit Documents Dhatupatha, and extended commentary pages 7.2.23 and 8.2.19. Exact URLs, resolved URLs where available, access times, byte counts, and SHA-256 checksums are preserved in the archive manifest. There are now 680 source records. The previously archived 7.4.68 page supplies the dhvan-specific grammatical explanation.
- **New evidence:** kRi865 defines anavasthana as deshantaragamana; kRi546 identifies bhram's shamadi-purpose repetition. The extended Bala-manorama passage on the 7.4.68 page explicitly identifies the repeated dental dhvan and gives the bell example. mA127 glosses tarj with bhartsana, while mA1257 lists tarj and bharts under santarjana; these support the proposed shared-meaning consolidation within jharjh, not a merger of the different tarj/bharts words. kRi1329 calls bhuvo a panchami and gives bhavayati dadhnaudanam. The 7.2.23 commentary explains ghushta rajjuh as produced or extended, preserving alternative interpretations.
- **Source alignment:** The accented patha confirms ay at 1.1031 and avadhvamsana at 1.1115. The three inspected traditional dhri-ng commentaries agree with destruction; the pinned binding assignment remains an unresolved source reading and is proposed for exclusion from the admitted subtotal. Kshiratarangini's shining group lists ghati rather than the plain ghata citation, so group-level alternative readings must preserve membership. No silent transfer of glosses between similar spellings.
- **Disposition:** Proposed 2,649 -> 2,645. The ay identity remains open. These are digital-transcription checks, not a fresh print-edition collation. Across the first two targeted passes, 19 distinct historical follow-up records have been revisited; 65 have not. Revisited does not mean resolved. The manuscript, companion, endnotes, and original data remain unchanged.
- **Subsequent approval, 2026-09-13:** The four reductions were approved and applied through `approved_reconciliation_02.json` and `apply_reconciliation_02.py`. The current dataset has 2,645 provisional assignments and retains all 2,741 original rows. The unsupported binding annotation remains classified as an unresolved source reading, not deleted.

### `generativity-eight-pass-followups`

- **Scope, 2026-09-13:** Seven batches review the 65 remaining historical follow-ups; the eighth consolidates all 84 records, including the 19 previously revisited. `analysis/generativity/results/remaining_followup_batch_01.md` through `_07.md` provide before/after decisions. Corresponding JSON files retain exact source anchors and complete manifest records. `eight_pass_consolidation.md` and `.json` record coverage and deferred work.
- **Sources:** 234 additional University of Hyderabad commentary transcriptions, selected through the declared candidate retrieval in `remaining_followup_sources.json`. There are now 914 archive records. The manifest records exact URLs, access timestamps, byte counts, and SHA-256 hashes. Retrieval tolerates spelling variation only to find candidates; it never determines word identity.
- **New evidence:** kRi1304 gives a dog as the subject of bukkayati and points back to bukkati. kRi350 explicitly adds flowing to gal and links the curadi occurrence. kRi1130 and kRi1368 define sandarbha as bandhana. kRi1152 explains the repeated laksh entry through atmanepada treatment. kRi290 gives the movement-specific mit restriction for ran; kRi438 explicitly links rish's harming entries. kRi624 and kRi713 give reciprocal links for short-vowel su, with the permission meaning independently defined in mA599 and mA691.
- **Shared grammatical evidence:** The already archived 7.4.68 page's extended Bala-manorama discussion identifies lad and mad as the same atoms under their restricted grammatical treatments and supplies svan's adornment definition. These are commentary passages, not statements of the sutra itself. The carc threatening merger uses mA433/mA924 and the already established tarjana/bhartsana relationship.
- **Disposition:** Eleven additional reductions are proposed across ten records, giving a possible 2,634 from the applied 2,645. They remain unapplied. Other decisions retain distinctions or readings, or explicitly defer citation, identity, finer-sense, and formation questions. IR220/IR221 share one cross-spelling follow-up. The three partial lists and two unenumerated entries remain outside the scope of completion. No published material changed.
- **Completed approval, 2026-09-13:** The author approved all ten count-changing records: IR43 bukk, IR51 carc, IR68 gal, IR72 granth, IR116 laksh, IR118 lad, IR131 mad, IR160 ran, IR166 rish, and IR219 su. `approved_eight_passes_01.json` and `apply_eight_pass_approvals.py` apply their eleven reductions above the preserved 2,645 layer, giving **2,634**. All 2,741 source rows remain available.

### `generativity-second-six-pass-expansion`

- **Scope, 2026-09-13:** Six bounded passes following the 1,399,621-word-meaning result: laukika अव्ययानि; classification of 87 conditioned ordinary कृत्प्रत्यय identifiers; selected conditioned कृदन्तानि from original धातु meanings; the fourteen previously classified कृदन्त operations from one-उपसर्गः inputs; the same operations from admitted सनादि-derived inputs; and a five-input तद्धित pilot.
- **Sources:** The pinned Vidyut 0.4.0 implementation and data; individual Aṣṭādhyāyī rule pages with traditional commentary for 3.1.134, 3.1.150, 3.2.107, 3.2.129, 3.3.94, 3.3.118, 3.3.174, 3.4.8, 3.4.9, 3.4.12, 3.4.21, 3.4.22, 4.1.92, 4.1.120, and 5.1.119. Exact URLs, retrieval times, byte counts, and SHA-256 hashes are stored in `working/40_reference/sources/archive/documents/generativity-pilot/manifest.json`.
- **Archive:** **936 records**. The source correction for कमुल्, कसे, and कसेन् follows the rule pages: 3.4.9 and 3.4.12 place them in the Vedic domain even where the engine metadata alone does not expose that boundary.
- **Results:** The completed additions are 7,902 अव्यय meanings, 25,703 conditioned कृदन्त meanings, 598,606 कृदन्त meanings from one-prefix inputs, 142,882 from सनादि-derived inputs, and seven तद्धित pilot meanings. Classification itself adds zero. The reconciled engine-mode subtotal is **2,174,721 word-meanings**.
- **Domain boundary:** Eleven base meanings in three source entries were already documented as Vedic-only. Their 8,660 base-and-descendant rows do not share a generated row with unrestricted source entries. Removing them gives a current known laukika subtotal of **2,166,061**. These removed rows are not automatically a Vedic subtotal. Nineteen Vedic-only कृत्प्रत्यय identifiers also remain uncounted. Their future run must use `is_chandasi=True`, retain accent-sensitive distinctions where relevant, and report its subtotal separately. The five-input तद्धित result demonstrates the method but is not a Sanskrit nominal-base census.
- **Integrity:** Every admitted row retains an input word-meaning ID, semantic operation, rule references, generated forms, and counting status. Compressed ledgers materialize the larger one-prefix and सनादि-derived results. Coincident spellings do not merge distinct meanings; alternate forms of one derivation remain attached to one meaning. Dictionary attestation is not used as an admission gate where a productive rule licenses the formation.
- **Verification:** The integrated generativity suite passes all **178 tests** after complete regeneration against the 936-record manifest.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has been changed.

### `generativity-vaidika-six-pass-expansion`

- **Scope, 2026-09-13:** Six passes audit the domain evidence attached to all 2,634 normalized base meanings; classify nineteen metadata-deferred कृत्प्रत्यय identifiers plus source-recovered क्वसु; generate direct and conditioned Vaidika formations; apply the supported operations to admitted one-prefix and one-सनादि meanings; and reconcile the two domains without double counting.
- **Primary rules:** Aṣṭādhyāyī 3.2.105-107 and 3.4.9-17 with Kāśikā and the other traditional commentaries retained on the Sanskrit Documents pages. The operation model distinguishes the Vedic perfect participle, the fifteen-form purpose family, the शकि construction, the ईश्वर construction, and the two भावलक्षण constructions.
- **Engine:** Vidyut 0.4.0 at commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`, run with `is_chandasi=True` and `use_svaras=True`. The engine directly supports कानच् and कमुल् across the tested inputs and कसुन् for the two roots licensed by 3.4.17. Zero output for the other families is recorded as a coverage gap, not a prohibition.
- **Archive:** **949 records** in `working/40_reference/sources/archive/documents/generativity-pilot/manifest.json`. Every source record contains its exact URL, UTC retrieval time, byte count, and SHA-256 checksum. The new rule snapshots include 3.2.105-109 and 3.4.10-17; the relevant already archived pages remain unchanged.
- **Domain audit:** Eleven base meanings are explicitly documented as Vedic-only. The other 2,623 currently cited evidence packets contain no unresolved domain marker after two false positives were examined: the full धातुपाठः catalogue crossed a Vedic section boundary, and the हु commentary used छन्दसि for a case construction rather than as a restriction on the root. Silence remains `no_domain_restriction_found_in_cited_evidence`, not proof of unrestricted use.
- **Results:** The direct कानच् and क्वसु passes admit 5,268 word-meanings. The conditioned pass admits 2,634 कमुल् constructions and three कसुन् meanings. Applying कानच्, क्वसु, and कमुल् to 52,567 one-prefix and 13,044 one-सनादि meanings admits another 196,833. These 204,738 Vaidika-specific rows join 8,660 base-and-ordinary-descendant rows already moved across the known domain boundary, producing a bounded Vaidika subtotal of **213,398** and a combined bounded subtotal of **2,379,459**.
- **Uncounted capacity:** The 3.4.9 purpose family, the 3.4.13 ईश्वर construction, and the 3.4.16 तोसुन् construction contain 5,280 semantic candidates under the declared inputs. They contribute zero because the pinned engine does not implement their forms. They are not rejected Sanskrit formations.
- **Integrity:** Every admitted row stores the source word-meaning, semantic operation, source rules, generated accent-bearing forms, and count status. Alternative forms and accent variants remain attached to one word-meaning. Three materialized Vaidika ledgers have disjoint stable identifiers and reconcile exactly to the reported subtotal.
- **Verification:** The integrated generativity suite passes all **183 tests** against the 949-record manifest.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-stri-six-pass-expansion`

- **Scope, 2026-09-13:** Six passes inventory the feminine suffixes exposed by the pinned engine, extract active and ignored assertions from its Kāśikā 4.1 tests, build a deduplicated source-demonstrated input set, verify each candidate through the generic Python constructor, separate derivation from inflection, and reconcile the lexical subtotal.
- **Grammar:** Aṣṭādhyāyī 4.1.3 supplies the स्त्रियाम् scope. The pinned implementation locates its feminine-base rules in 4.1.4-4.1.75 and exposes चाप्, टाप्, डाप्, ङीन्, ङीप्, ङीष्, and ऊङ्. These are base-conditioned operations, not seven universal multipliers.
- **Digital sources:** `https://raw.githubusercontent.com/ambuda-org/vidyut/f3ba4167d40eebc4b3023d24e66867aa6a8cdb32/vidyut-prakriya/src/stritva.rs`; `https://raw.githubusercontent.com/ambuda-org/vidyut/f3ba4167d40eebc4b3023d24e66867aa6a8cdb32/vidyut-prakriya/src/args/internal.rs`; and the already archived `kashika_4_1.rs` plus `sutrapatha.tsv` from the same pinned commit.
- **Local record:** The two added source snapshots and exact URLs, UTC retrieval times, sizes, and SHA-256 checksums are in `working/40_reference/sources/archive/documents/generativity-pilot/stri_manifest.json`. The test source and rule table remain protected by the 949-record core manifest.
- **Results:** The tests contain 77 feminine assertions: 66 active and 11 ignored. One repeated active assertion collapses, leaving 65 candidate inputs. Vidyut verifies 50 with an actual स्त्रीप्रत्यय path. Five inputs are already feminine and merely decline; ten constructed examples lose required metadata when reduced to the generic Python input and remain outside the count. The pass adds 50 word-meanings and raises the combined bounded subtotal to **4,762,714**.
- **Boundary:** Nominative forms are evidence, not separately counted grammatical cells. The pass does not extrapolate across the 794,078 nominal meanings, infer eligibility from spelling, count ignored tests, or use missing attestation as an exclusion.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-upasarga-stacking-boundary`

- **Scope, 2026-09-13:** Documentation correction for the completed two-उपसर्ग experiment. Aṣṭādhyāyī 1.4.80 supplies the लौकिक before-the-धातुः order in the pinned rule table. Rule 6.4.96 expressly recognizes a two-prefix environment, and its Kāśikā discussion states that the treatment extends from two to two or more, illustrating समुपच्छादः and समुपातिच्छादः.
- **Digital source:** `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/6/6.4.96.htm`.
- **Local record:** `rule-6.4.96-stacking.html` and `upasarga_stacking_manifest.json` in `working/40_reference/sources/archive/documents/generativity-pilot/`, with retrieval time, byte count, and SHA-256 checksum.
- **Consequence:** The existing 400-sequence ledger remains a declared two-position experiment. Its 1,051,340-word-meaning count is unchanged and is not presented as the grammar's maximum stack depth.

### `generativity-namadhatu-six-pass-expansion`

- **Scope, 2026-09-13:** Six passes classify the नामधातुः rules, recover source examples, declare semantic eligibility, generate derived verbal bases, reconcile the subtotal, and emit a machine-readable stage graph. Rules 3.1.8-3.1.11 supply four productive relations across the first 794,078-meaning लौकिक nominal inventory. Rules 3.1.12-3.1.21 remain limited to their named conditions and active source-demonstrated relations.
- **Sources:** Pāṇini's Aṣṭādhyāyī 3.1.8-3.1.21 with Kāśikā and other traditional commentaries as compiled by Sanskrit Documents; the pinned Vidyut 0.4.0 `sanadi.rs`, `kashika_3_1.rs`, and `sutrapatha.tsv` snapshots at commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`.
- **Local record:** Fourteen rule pages, their exact URLs, access times, byte counts, and SHA-256 checksums are stored in `working/40_reference/sources/archive/documents/generativity-pilot/namadhatu_manifest.json`. The pinned software and test files remain protected by the 949-record core manifest.
- **Results:** Four productive operations add 3,176,312 meanings. Forty active narrower relations add another 40. All 3,176,352 candidates generate, raising the combined bounded subtotal to **7,939,066**. Ten relations from an ignored engine test remain documented outside eligibility rather than being treated as rejected Sanskrit formations.
- **Form boundary:** The generated rows are derived verbal bases. Source-example present forms verify the conditioned operations but do not enter the lexical subtotal. The stage graph separately marks the 7,902 complete indeclinables already counted and leaves finite तिङन्त and declined सुबन्त counts pending.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-nan-six-pass-expansion`

- **Scope, 2026-09-13:** Six passes classify one नञ् compound relation and its two surface outcomes, verify source examples, assemble the current bounded nominal inventory, materialize one negative meaning per eligible input, reconcile the subtotal, and extend the generation-stage graph.
- **Primary grammar:** Aṣṭādhyāyī 2.2.6 licenses the नञ् compound. Rules 6.3.73 and 6.3.74 produce अ- before a consonant and अन्- before a vowel. The two forms are phonetic outcomes of one semantic operation and are not counted separately.
- **Digital sources:** Sanskrit Documents commentary pages for 2.2.6, 6.3.73, and 6.3.74; pinned Vidyut commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`, including `samasa.rs`, `kashika_2_2.rs`, and `kashika_6_3.rs`.
- **Local record:** Exact URLs, retrieval times, sizes, and SHA-256 checksums for all six snapshots are stored in `working/40_reference/sources/archive/documents/generativity-pilot/nan_manifest.json`.
- **Numbering note:** The Sanskrit Documents page bodies carry inconsistent neighboring numbers for the two 6.3 rules. The classification follows the rule wording in the pinned `sutrapatha.tsv` and the matching Vidyut test functions: 6.3.73 `nalopo naYaH` and 6.3.74 `tasmAnnuqaci`.
- **Verification:** Five pinned source examples cover both outcomes: `abrAhmaRa`, `avfzala`, `asomapa`, `anaja`, and `anaSva`. The Python API does not expose compound construction, so the ledger implements the three classified rules directly and tests its output against those examples.
- **Results:** The current nominal inventory contains 3,177,340 meanings: 794,078 from the first inventory, 2,382,237 from the broad तद्धित ledger, 975 conditioned तद्धित meanings, and 50 feminine meanings. One bounded negative counterpart per input raises the combined subtotal from 7,939,066 to **11,116,406**.
- **Boundary:** Dictionary attestation is not an admission gate. Recursive negation, additional interpretations of नञ्, other compound families, and compound inflection remain outside the count. Coincident spellings do not merge distinct source meanings.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-suffix-operation-six-pass-expansion`

- **Scope, 2026-09-13:** Six passes distinguish visible endings from grammatical suffix operations, group all 175 pinned तद्धित identifiers by semantic work, separate broad from conditioned and structural formations, recover relations encoded through local helpers or constructed inputs, verify their forms, and reconcile the bounded subtotal.
- **Sources:** The already archived Kāśikā integration tests `kashika_4_2.rs`, `kashika_5_1.rs`, and `kashika_5_2.rs`, together with the pinned Vidyut 0.4.0 तद्धित implementation and argument inventory at commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`.
- **Digital records:** Exact GitHub raw URLs, retrieval timestamps, byte counts, and SHA-256 checksums remain stored in `working/40_reference/sources/archive/documents/generativity-pilot/taddhita_manifest.json`. This pass reuses those unchanged snapshots and adds no unrecorded external source.
- **Results:** Two source helpers supply twelve “having this as its देवता” relations and ten crop-field relations. Two constructed inputs add purchase-by-measure relations. Vidyut reproduces all 24 semantic relations; for the two purchase relations, the generic constructor reproduces one expected form but loses a second optional variant. Since output variants do not multiply meanings, all 24 relations count once and raise the combined bounded subtotal to **11,116,430**.
- **Boundary at this stage:** Another 292 positive plain तद्धित assertions record further forms but do not themselves name a distinct semantic relation. This pass sets them aside rather than inferring meanings from visible -क or -य endings. The next source record returns them to their governing rules and resolves the active examples.
- **Local results:** `analysis/generativity/results/suffix_semantic_families.*`, `suffix_productivity_classification.*`, `suffix_conditioned_*`, and `suffix_operation_six_pass_summary.*`.
- **Verification:** The integrated generativity suite passes all **222 tests** after the new ledger and graph stage are generated.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-plain-taddhita-six-pass-expansion`

- **Scope, 2026-09-13:** Six passes recover the semantic work behind every literal plain तद्धित assertion in the pinned Kāśikā tests for Aṣṭādhyāyī 4.1-5.4. The inventory contains 301 assertions: 292 positive and nine negative. Of the positive assertions, 248 are active and 44 occur only in ignored tests.
- **Grammar sources:** Aṣṭādhyāyī and Kāśikā pages compiled by SanskritDocuments. The archived pages follow `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/{book}/{rule}.htm`. Each assertion is attached to its governing semantic rule before the engine is asked to verify its form.
- **Local record:** The original pass archived **109** rule pages. The same manifest now contains **110** after the later comparative and superlative pass added rule 5.3.58. Exact URLs, UTC retrieval times, byte counts, and SHA-256 checksums are listed in `working/40_reference/sources/archive/documents/generativity-pilot/plain_taddhita_rule_manifest.json`. The pinned Vidyut test files remain protected by the 949-record core manifest and the separate तद्धित manifest.
- **Method:** The source rule supplies the meaning. Vidyut 0.4.0 at commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32` verifies formation under the named suffix. Generic engine output alone is never treated as semantic evidence.
- **Results:** The 248 active assertions produce 249 semantic rows because मूल्य has two explicitly stated meanings. Four repeated assertions collapse, leaving 245 eligible word-meaning relations. Vidyut reproduces all 245. Nine overlap earlier तद्धित ledgers, leaving **236 new word-meanings**: 197 nominal bases and 39 complete indeclinables. The combined bounded subtotal becomes **11,116,666**.
- **Boundary:** The 44 ignored positive assertions remain documented but unadmitted. Twenty-three admitted same-referent or lexical derivatives are identified separately. The pass does not extrapolate these examples across the nominal inventory and does not multiply optional output forms.
- **Local results:** `analysis/generativity/results/plain_taddhita_*`, including the source inventory, semantic classification, eligibility set, engine verification, reconciled ledger, six-pass summary, and updated stage graph.
- **Verification:** The integrated generativity suite passes all **228 tests** after regeneration.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-taddhita-comparison-generalization`

- **Scope, 2026-09-14:** Six passes classify all 57 semantic families recovered from the plain तद्धित source assertions and extend only the comparative and superlative families beyond their listed examples.
- **Primary grammar:** Aṣṭādhyāyī 5.3.55 supplies तमप् and इष्ठन् in the superlative relation; 5.3.57 supplies तरप् and ईयसुन् in a comparison; 5.3.58 limits the vowel-initial alternatives इष्ठन् and ईयसुन् to quality-denoting nominal inputs.
- **Digital sources:** `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/5/5.3.55.htm`, `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/5/5.3.57.htm`, and `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/5/5.3.58.htm`.
- **Local record:** The three rule pages and their exact URLs, access times, sizes, and SHA-256 checksums are stored in `working/40_reference/sources/archive/documents/generativity-pilot/plain_taddhita_rule_manifest.json`. Rule 5.3.58 is stored as `plain-taddhita-rule-5.3.58.html`, SHA-256 `c25b59284d83cd0944dc8e868fe4a0ffb5422496c730bca4f65024b427060d97`.
- **Eligibility:** तमप् and तरप् apply to all 794,078 declared लौकिक nominal word-meanings when the comparative relation is intended. Rule 5.3.58 limits इष्ठन् and ईयसुन् to गुणवचन inputs. The inventory's English labels do not independently establish that traditional category, so those two operations remain deferred.
- **Results:** Vidyut 0.4.0 generates all 1,588,156 eligible relations. One तमप् result already occurs in the plain-source ledger. The pass therefore adds **1,588,155 word-meanings** and raises the combined bounded subtotal to **12,704,821**.
- **Boundary:** The other recovered families remain source-bounded. They require independently identified classes such as names, places, times, materials, measures, persons, directions, or numbers, or they belong to explicit lexical lists. Engine construction alone does not establish those conditions.
- **Local results:** `analysis/generativity/results/taddhita_generalization_*`, including the family classification, eligibility records, compressed candidate and reconciled ledgers, verification, six-pass summary, and updated stage graph.
- **Verification:** The integrated generativity suite passes all **234 tests**.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-stri-generalization`

- **Scope, 2026-09-14:** Six passes extend feminine derivation only across nominal meanings already classified as agents. Four source operations proceed: ण्वुल् and तृच् agent nouns, the conditioned अच् agent, and the blessing-specific वुन् agent.
- **Primary grammar:** Aṣṭādhyāyī 4.1.3 places the following rules under स्त्रियाम्. Its Kāśikā treats स्त्रीत्व as suffix meaning or as qualifying the base meaning. Rules 4.1.4 and 4.1.5 supply the regular टाप् and ङीप् paths produced by this inventory.
- **Digital sources:** `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/4/4.1.3.htm`, `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/4/4.1.4.htm`, and `https://sanskritdocuments.org/learning_tools/ashtadhyayi/vyakhya/4/4.1.5.htm`; pinned Vidyut `stritva.rs` and `internal.rs` at commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`.
- **Local record:** Exact URLs, retrieval times, sizes, and SHA-256 checksums are stored in `working/40_reference/sources/archive/documents/generativity-pilot/stri_manifest.json`. The source ledgers preserve the original धातुः codes, कृदन्त suffix, उपसर्गः, and सनादि stack for each candidate.
- **Results:** The four selected operations identify 140,568 lexical agent meanings. Vidyut reconstructs and generates every feminine relation, using टाप् in 72,596 rows and ङीप् in 67,972. Two confirmed कर्तृ/कर्त्री and हर्तृ/हर्त्री overlaps are not added twice. The pass adds **140,566 word-meanings** and raises the combined bounded subtotal to **12,845,387**.
- **Meaning boundary:** A matching spelling does not establish a matching meaning. Four other surface matches with the earlier source-example ledger remain separate because the earlier examples do not establish the same derived-agent sense. Participles, obligation forms, descriptive nominals, and other agreement-driven feminine forms remain outside the lexical subtotal.
- **Local results:** `analysis/generativity/results/stri_generalization_*`, including classification, compressed eligibility and generation ledgers, exclusions, verification, reconciliation, six-pass summary, and updated stage graph.
- **Verification:** The integrated generativity suite passes all **240 tests**.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-samasa-six-pass-expansion`

- **Scope, 2026-09-14:** Six passes inventory the compound types exposed by pinned Vidyut 0.4.0, extract its Kāśikā regression assertions, admit only active examples whose members and outputs are directly reconstructible, verify the retained source records, reconcile repeated assertions, and extend the stage graph.
- **Pinned implementation:** Vidyut commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`, including the compound arguments and implementation plus `kashika_2_1.rs`, `kashika_2_2.rs`, and their test support.
- **Grammar sources:** Aṣṭādhyāyī and Kāśikā pages for the rules invoked by the retained regression assertions, archived from Sanskrit Documents.
- **Local record:** The manifest contains 42 snapshots: seven pinned code or data files and 35 governing rule pages. Exact URLs, UTC retrieval times, byte counts, and SHA-256 checksums are stored in `working/40_reference/sources/archive/documents/generativity-pilot/samasa_manifest.json`.
- **Results:** The source suite contains 167 recognized compound assertions: 132 active and 35 ignored. Twelve active assertions construct one or more members inside test helpers and remain outside this pass. Seven repeated assertions collapse. The retained set contains **113 unique source-demonstrated compound relations** across all eight engine compound types, with at most three members and one derivational level. Adding one word-meaning for each relation raises the bounded subtotal from 12,845,387 to **12,845,500**.
- **Verification boundary:** All 113 retained relations are literal active assertions in the pinned source suite. Vidyut 0.4.0 does not expose its compound API through Python. A Rust verifier is preserved in `analysis/generativity/rust/samasa_verifier/`, but it was not run on this machine because no Rust toolchain is installed. The report therefore distinguishes pinned-source verification from local engine regeneration.
- **Counting boundary:** The pass does not infer meaning from a generated spelling, admit ignored tests, multiply every nominal pair, recurse over compound outputs, or treat output variants as separate meanings. Dictionary attestation is not an admission gate.
- **Local results:** `analysis/generativity/results/samasa_*`, including source assertions, exclusions, eligible relations, verification status, reconciled ledger, six-pass summary, and the updated generation-stage graph.
- **Verification:** The integrated generativity suite passes all **245 tests** after the समास ledger and graph stage are generated.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `generativity-compound-input-operation-stack`

- **Scope, 2026-09-14:** Six passes classify the 113 source-demonstrated compounds by output class, declare one additional operation over eligible nominal compounds, generate every candidate, reproduce every output set in a separate verification pass, reconcile prior input overlap and repeated spellings, and extend the stage graph.
- **Reused grammar sources:** Aṣṭādhyāyī 2.2.6, 3.1.8-3.1.11, 5.1.119, 5.2.94, 5.3.55, and 5.3.57 with the already archived Kāśikā pages; pinned Vidyut 0.4.0 at commit `f3ba4167d40eebc4b3023d24e66867aa6a8cdb32`. This pass introduces no new external source.
- **Input classification:** Seventeen अव्ययीभाव compounds are already complete indeclinables and remain outside nominal derivation. The other 96 compound meanings enter as nominal bases. Nine established operations apply to all 96. The नञ् operation applies to 94 after excluding two compounds that are already negative.
- **Results:** All **958** eligible depth-two relations generate and reproduce: 480 तद्धित nominal meanings, 384 नामधातुः verbal meanings, and 94 nonrecursive नञ् nominal meanings. The subtotal rises from 12,845,500 to **12,846,458 word-meanings**.
- **Reconciliation:** None of the 96 compound input forms occurs in the earlier 794,078-meaning broad nominal inventory. Ninety-five output spellings occur in more than one relation, primarily because क्यच् can express two different meanings through the same form. Those meanings remain separate; spelling does not merge them.
- **Boundary:** The pass adds exactly one operation after a source-demonstrated compound and stops at derivational depth two. It does not reopen complete indeclinables, recurse नञ्, generate further compounds, or infer arbitrary operation sequences. Finite तिङन्त and declined सुबन्त forms remain outside the lexical subtotal.
- **Local results:** `analysis/generativity/results/compound_stack_*`, including input classification, eligibility and exclusions, generated and reconciled ledgers, independent verification, six-pass summary, and the updated stage graph.
- **Verification:** The integrated generativity suite passes all **250 tests** after the compound-input stack is generated.
- **Publication status:** Research subtotal only. No manuscript, companion, cover, or published endnote has changed.

### `project-generativity-capacity-synthesis`

- **Citation:** *Atomic Sanskrit* six-pass generativity capacity synthesis.
- **Source type:** Reproducible project calculation and review record.
- **Canonical locator:** `analysis/generativity/results/generativity_six_pass_synthesis.md` and its five linked pass reports.
- **Digital URL:** Not applicable.
- **Archived URL:** Not applicable.
- **Accessed:** 2026-09-15.
- **Local record:** `analysis/generativity/results/integrated_grammatical_capacity.*`; `vaidika_capacity_boundary.*`; `publication_capacity_cascade.*`; `manuscript_generativity_claim_audit.*`; `generativity_manuscript_proposal.*`; `generativity_six_pass_synthesis.*`.
- **Integrity:** SHA-256: integrated capacity `b99d5cee146a91c52f2ae0537d5f88503b7ffa331d3ef81da45b309a4a1a989d`; publication cascade `d7f067ce51ce341526692622d96a8b399305f2d8b881258bea872fc054e4be84`; final synthesis `4303c8d7a7747de050909abc4a03c9578fcfe3b96bbac4b20f34bb724e697f48`.
- **Inputs:** The final JSON records SHA-256 values for the two twelve-pass inflection reports, reader-facing word-space graph, domain-boundary report, manuscript audit, and proposal.
- **Results:** The bounded lexical analysis proceeds from 2,634 reconciled semantic-atom meanings to 12,846,458 word-meanings before inflection. The 12,633,060 लौकिक meanings occupy 602,707,133 semantic grammatical cells under the declared matrices. The 213,398 Vedic meanings remain a separate lexical inventory.
- **Boundary:** The result is not a distinct-spelling total or dictionary-entry count. It excludes Vedic inflection, additional verbal constructions, agreement-driven gender extensions, and unrestricted recursive compounding.
- **Verification:** The complete pinned-environment generativity suite passes all **276 tests**.
- **Publication status:** Approved wording deployed in Chapter 0 §0.6, Chapter 12 §12.7, and the shared endnote on 2026-09-15.
