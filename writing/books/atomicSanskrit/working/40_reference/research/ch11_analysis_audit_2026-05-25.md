...
The old working note `working/40_reference/research/ch11_racana_gana_cross_findings.md` still contains stale interpretive tables from the pre-cleanup matrix. Use the regenerated derived files below for numbers.
