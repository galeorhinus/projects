...
- as_1_01_botanical.md (Ch 1) — book contests + Chapter 15 walks
...
- as_1_13_affixation.md (Ch 13) — book-as-agent
...
Ch 11 / App 5 Dhātupāṭha empirical-analysis bundle (af297ae): FINDINGS.md (~12K words, 23 sections); three new analysis scripts (analyze_internal_structure.py, analyze_position_roles.py, cluster_by_reactivity.py); particle-count one-particle row added to PROSE-READY SUMMARY. Ch 11 §11.10 figure planting + Engineering Was Common Knowledge close (11ffe97). Ch 12 drafting scaffold landed (fd79d5c).
...
3. **Figure production pass** — chapters 11, 12, 13 carry inline `[FIGURE X.Y]` placeholders that need to be materialized as actual figure scripts and built outputs. Ch 11 has its figure scripts already (figures/ch11/); Ch 12 and Ch 13 do not.
...
6. **Ch 12 polemic-landing pass** — the Ch 12 drafting scaffold landed in fd79d5c carries the structural framework; the polemic-landing pass that converts the scaffold into final prose has not yet been done.
