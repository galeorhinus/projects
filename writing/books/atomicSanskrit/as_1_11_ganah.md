...
Figure already produced: [`figures/build/building_dhatuh_position_roles.svg`](figures/build/building_dhatuh_position_roles.svg) — per-consonant position-role deployment across 1,852 single-akṣara atoms. Currently anchored in Ch 10 §10.11 with caption.
...
## Status — Ch 11 workstream (mirrors `working/as_todo.md`)
...
**Pending workstream items (`working/as_todo.md` §[P1] Ch 11):**
