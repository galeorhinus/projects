...
**Terminology note.** The chapter introduces *architectural test* and *architectural object* as paired English-coined terms for the chapter's diagnostic apparatus. They sit alongside the book's other engineering-coined vocabulary (*calibration matrix* in Ch13; *calibrant language* / *calibrant contact* / *Pratibimba* in Ch17; *engineering thesis* established in Ch2 §2.5). The chapter's coined English compounds do not need Devanagari per the audience-principle convention; first-use italics are sufficient.
