...
Chapter 14 develops the calibration matrix that preserves Sanskrit internally, and Chapter 19 follows the contact dynamic beyond the active field. The two scales belong to one architecture: gravity keeps nearby forms in orbit, while radiance travels outward and generates new words and forms in other languages.
