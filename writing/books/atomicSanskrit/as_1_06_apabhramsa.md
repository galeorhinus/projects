...
**Codified correction** is the pyramidal category—***विकृति (*vikṛti*)***—where standardization comes entirely from codification: a prestige form is selected, stabilized, taught, and defended by institutions. Because correction comes from outside the speaker and above the usage (via the academy, priesthood, school, court, committee, dictionary, or grammar), it is exclusively institutional authority that supplies the standard.
...
Because these three categories represent fundamentally different situations—where natural drift represents change, codified correction enforces authority, and engineered self-correction preserves architecture—the pyramid's account deliberately misclassifies Sanskrit. It pushes Sanskrit *before* Pāṇini (पाणिनि) into the first category of *prākṛtika* drift, and Sanskrit after Pāṇini into the second as a *codified* system, even though Patañjali's examples conclusively demonstrate the reality: Sanskrit belongs entirely to the third.
...
Just as modern thermodynamics gives this physical tendency a name—entropy, recognizing that organized systems drift toward disorder when not actively constrained—Patañjali identifies the exact linguistic analogue: speech falls away unless an architecture firmly holds it. However, identifying the tendency is not the engineering response itself; rather, it is the critical diagnosis that prepares the response.
...
This deeper design choice is highly visible in the form of the Vedic corpus. Because *apabhraṃśa* can occur anywhere—in any speaker, any utterance, or any moment—the engineering answers this universal failure mode with two precisely linked constraints: ***chandas*** (छन्दस्), metrical form, and ***śruti*** (श्रुति), heard transmission. Since *chandas* makes phonetic drift immediately show up as metrical mismatch, and *śruti* makes perceptual drift audible to the teacher, student, and audience as the recitation happens, meter and hearing together make quiet drift incredibly difficult, ensuring the *guru-shishya* lineage-chain can make correction continuous.
...
This pattern is absolutely consistent: while the pyramid's account arbitrarily turns difference into time, Sanskrit's own architecture meticulously assigns difference to function, mode, recension, option, meter, or transmission stream. Fundamentally, difference is not drift until the mechanism of drift is explicitly shown, yet the pyramidal account usually supplies only the label, completely avoiding the mechanism.
...
The term is **calibrant**: a stable reference against which other systems align. For example, a master clock calibrates the network, or a laboratory standard calibrates instruments, or a gauge block calibrates measurement. If the calibrant drifted with the systems around it, it would cease to be a calibrant.

Languages sort into three tiers by their relation to that standard: the calibrant itself, and two kinds of natural language divided by a single fact — whether they move inside the calibrant's field.

**Sanskrit is the calibrant.** The *Vedas* preserve the architecture. The *Aṣṭādhyāyī*, *padapāṭha*, *Prātiśākhya*, *Śikṣā*, and *Vedāṅga* disciplines document and transmit it. Drift is what they filter. Within Sanskrit, *gauḥ* stays *gauḥ*, and **जड (*jaḍa*)** — inert, lifeless, dull-minded, cold-and-heavy — stays *jaḍa*.

**Orbital languages remain within the field.** A calibrant-anchored language moves from the engineered form — *apabhraṃśa*, the falling-away — yet stays in orbit: Sanskrit's gravity pulls it back toward a form it can still be measured against. Marathi and Hindi inherit Sanskrit vocabulary with enough dhātu-image still alive to constrain drift. *Gauḥ* becomes *gāy*. Marathi **जाड (*jāḍ*)** specializes the physical-density branch of the *jaḍa* meaning-family into *fat / thick*, while cognitive heaviness survives in related forms. **मूर्ख (*mūrkha*)**, built from **मूर्छ् (*mūrch*)**, retains its descriptive force in Marathi and Hindi because the cognate **मूर्छा (*mūrchā*)** remains available beside it. The word stays in orbit because the dhātu-image around it stays alive.

**Outside the field, forms drift.** With no calibrant in reach, the form moves without bound — nothing holds a center for it to depart from. English is the limit case. Its vocabulary for cognitive failure cycles through replacement terms: *idiot*, *imbecile*, *moron*, *feebleminded*, *retarded*, *intellectually disabled*, *neurodivergent*. Henry Goddard coined *moron* in 1910 from Greek *mōros* as a neutral clinical term; it became insult. *Retarded* traversed the same path, leaving federal statute through Rosa's Law and diagnostic usage through DSM-5.[NOTE: rosa-law-2013] Steven Pinker coined the term *euphemism treadmill* for the cycle: stigma attaches to the referent, the word follows, and the replacement inherits the stigma.[NOTE: pinker-euphemism-treadmill]
