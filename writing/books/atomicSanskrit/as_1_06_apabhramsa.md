...
The figure's geometry carries the point. The four forms fall at different distances, and each falls *around* the calibrant. Inside the Indic field, Sanskrit's gravity holds: a form can fall far from *gauḥ* and remain in orbit, visible and measurable against the center it fell from. *Apabhraṃśa* is the satellite's fall — the fall that keeps its center. The botanical metaphor knows one fall only: the leaf drops, touches ground, and dies. It described the wrong kind of falling. What becomes of a form that leaves the field altogether is Chapter 18's story.
