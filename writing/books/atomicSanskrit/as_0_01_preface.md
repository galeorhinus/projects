...
The *paramparā* names the human-side conduit by which the corpus arrived: the ***dṛṣṭāḥ*** (दृष्टाः, *the seers*), who saw the *Vedas* the eternal *śabda* manifests as. They are ***mantra-dṛṣṭāḥ*** (मन्त्रद्रष्टाः), not ***mantra-kartṛs*** — *mantra*-seers, not *mantra*-composers; they received what they saw, they did not compose it. The *Mīmāṃsā* doctrine of ***apauruṣeyatva*** (अपौरुषेयत्व) is the *paramparā*'s own anchor for the position: no separate human agent-class is hypothesized between the eternal *śabda* and the *dṛṣṭāḥ*.[NOTE: apauruseya-mimamsa-sutra-1-1-5] The grammarians who systematically documented the system — Pāṇini, Kātyāyana, Patañjali, and the pre-Pāṇinian roster — came later still. None of them invented Sanskrit. They decoded what the *Vedas* encode. In the Indic ethos, knowledge belongs to the *paramparā*, not to a named inventor. Insight is ***heard*** (*śruti*), not authored.
