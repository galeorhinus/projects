...
| I-8 | 21–26 | सिद्धे शब्दार्थसम्बन्धे quote + Patañjali context | **Ch3** | IN-VOICE | Move to Chapter 3. Ch1 doesn't need this depth; Ch3 is built around it. Ch1 can preview with a single sentence reference. |
| I-9 | 28–32 | *kārya* vs *siddha* debate; Patañjali concludes the bond is *siddha* | **Ch3** | IN-VOICE | Move to Chapter 3 — this is the chapter's central paragraph. |
...
4. **Chapters drafted to v1:** Ch1 (full, including ¶7/¶8 split mid-session-late with morphological grounding of *kṛta*/*kṛti* contrast and the "everything else" hammer), Ch2 (full, with §2.5 close in hammer form and the architecture-of-*Sanātan* / engineering thesis identification), Ch5 (full, with the *dhātuḥ* recovery across four sciences and bridge into Part IV without naming the Atomic Corollary — that introduction reserved for Ch9). Section II of the rough draft is now fully resolved. Section III¹-1 and III¹-2 partially resolved (shared seam material with Ch9). **Next target: Chapter 3** (the *siddha* / *kārya* chapter) — sections I-8 and I-9 of the rough draft lift directly into Ch3 with substantial Patañjali quote material already in place; Ch3 is the next-most-served by remaining draft material, and Ch1 has set up the forward-pointer. **Alternative target: Chapter 9** (the Atomic Corollary's formal introduction) — sections III¹-3 and III¹-4 (formal introduction of *Atomic Corollary* + *prakṛti* worked example) plus IV-1 and IV-2 (atomic compression) supply Ch9's opening; Ch5 has primed the framework. Ch3 is the cleaner next move because it stays inside Part II's prosecutorial arc (Ch1 → Ch3 → Ch4 → Ch2's etiology already in place); Ch9 is the move if the architectural Part IV needs to advance for momentum reasons.
