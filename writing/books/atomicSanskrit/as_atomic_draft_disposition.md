...
| I-8 | 21–26 | सिद्धे शब्दार्थसम्बन्धे quote + Patañjali context | **Ch3** | RESOLVED | Drafted into Ch3 §§3.2–3.5 (`as_ch03_draft.md`). The *Vārttika siddhe śabdārthasambandhe* with translation tightened to "Given that the bond between word and meaning is established" anchors §3.2. |
| I-9 | 28–32 | *kārya* vs *siddha* debate; Patañjali concludes the bond is *siddha* | **Ch3** | RESOLVED | Drafted into Ch3 §§3.3–3.4 (`as_ch03_draft.md`). §3.3 frames the contrastive line "**सिद्ध (*siddha*) vs कार्य (*kārya*)** — eternal/established vs evolving/produced"; §3.4 develops Patañjali's *siddha* conclusion as physical-constant framing. |
| I-10 | 34–39 | "The corruptions are many; perfectly engineered words are few" / *apabhraṃśa* | **Ch4** | IN-VOICE | Move to Chapter 4. The translation of *apabhraṃśa* as "corruption, or falling away" is the gloss Ch4 needs. |
| I-11 | 41–49 | The गौः example; multi-variant decay; architects "thousands of years before them" understood entropy | **Ch4** | IN-VOICE | Move to Chapter 4. The "thousands of years before them" phrasing aligns with the chronological-principle reminder in the handoff. |
...
| ¶ | Lines | Content | Destination | Tag | Action |
|---|---|---|---|---|---|
| II-1 | 57 | Definition of *dhātuḥ* as technical civilizational term | Ch5 | RESOLVED | Drafted into Ch5 §5.1 ¶1 (`as_ch05_draft.md`) — opening four-domain inventory paragraph, expanded from the rough draft's three-domain treatment to add the grammatical sense as the fourth domain. |
...
| ¶ | Lines | Content | Destination | Tag | Action |
|---|---|---|---|---|---|
| II-10 | 79 | Rejecting botanical, "root" must be reexamined | Ch5 | RESOLVED | Drafted into Ch5 §5.5 ¶1 (`as_ch05_draft.md`) — the chapter-close transition into the Necessary Pause. |
...
The Epilogue also has its own further work — the civilizational close, the second-shānti signal, the "the recovery has only begun" close — that the draft does not supply. See `as_epilogue_notes.md`.
...
4. **Chapters drafted to v1:** Ch1 (full, including ¶7/¶8 split with morphological grounding of *kṛta*/*kṛti* contrast and the "everything else" hammer), Ch2 (full, with §2.5 close in hammer form and the architecture-of-*Sanātan* / engineering thesis identification), Ch3 (full, with the *Trimuni Vyākaraṇam* opening and the *siddha*/*kārya* contrastive structure across §§3.1–3.5; final hammer "Without *siddha*, there is nothing to defend." — closes I-8 and I-9), Ch5 (full, with the *dhātuḥ* recovery across multiple Indic sciences and bridge into Part IV without naming the Atomic Corollary — that introduction reserved for Ch9; §5.1 retitled "One Word, Many Sciences" with cross-disciplinary expansion). Section II of the rough draft is fully resolved across Ch1, Ch2, and Ch5. Section III¹-1 and III¹-2 partially resolved (shared seam material with Ch9). I-8 and I-9 fully resolved into Ch3. **Next-target candidates per `as_todo.md` section B:** **Ch4** (*apabhraṃśa* / entropy chapter — lifts I-10 and I-11 from rough draft, completes Section I); **Ch15** (PIE / Wave 1/2/3 — central to new sidebar structure in `as_sidebars.md`, requires Sidebar 3 + Mitanni evidence integration); **Ch7** (retroflex / *mūrdhanya* — requires creating `as_ch07_notes.md` first; Sidebars 1 and 4 supply framework and anecdotal opening); **Epilogue** (Wave 3 mantra-landing — completes the two-stage Ch2 §2.4 / Epilogue arc per Sidebar 5). Author choice; Ch4 is the cleanest next-step within Section I; Ch15 is highest-value structurally; Ch7 and Epilogue require precursor notes work.
