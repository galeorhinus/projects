...
| I-10 | 34–39 | "The corruptions are many; perfectly engineered words are few" / *apabhraṃśa* | **Ch4** | RESOLVED | Drafted into Ch4 §4.1 and §4.2 (`as_ch04_draft.md`). The *apabhraṃśa* term introduced in §4.1 with full morphological gloss; the *bhūyāṃso 'pabhraṃśāḥ, alpīyāṃsaḥ śabdāḥ* maxim quoted in §4.2 as the quantitative observation. The translation gloss "fallings-away" preserved as voice-load-bearing. |
| I-11 | 41–49 | The गौः example; multi-variant decay; architects "thousands of years before them" understood entropy | **Ch4** | RESOLVED | Drafted into Ch4 §4.3 (`as_ch04_draft.md`). The four canonical *apabhraṃśas* (*gāvī*, *goṇī*, *gotā*, *gopotalikā*) named with deviation types (vowel-lengthening / consonant shift / diphthong simplification / derivational extension). The "thousands of years before any modern philological project" framing observes the chronology rule. FIGURE 4.1 placeholder added — central *gauḥ* node with four radiating *apabhraṃśas*. |
