...
*Draft v2 (2026-05-20). Codex compression of the previous draft, with two author restorations: §3.6 specificity in the asuric-pyramid cross-reference at §2.5; "preserved across thousands of years of continuous transmission" beat in the arāvan etymology at §2.4.*
...
The class also calls itself *liberal*, and the word turns against it. Latin *liber-* meant free, but also generous, open-handed, unstinting. *Illiberal* preserves the negation: closed-handed, ungenerous, withholding. Sanskrit names the same structure with older precision. The root *rā-* means to give; the privative *a-* yields *arāvan* (अरावन्), the non-giver, the one who holds rather than releases, centralizes rather than distributes.[NOTE: liber-arāvan-etymology] Two etymologies, two languages, one diagnosis.
...
- §2.4 — restored *"preserved across thousands of years of continuous transmission"* in the *arāvan* etymology paragraph: *"By the Sanskrit etymology, preserved across thousands of years of continuous transmission, it is arāvan."* — the Sanskrit-side anti-entropy beat the Codex compression dropped.
- §2.5 — restored §3.6 specificity in the asuric-pyramid cross-reference: *"Chapter 3 §3.6 names the deeper formation behind them: the asuric pyramid…"*

**Codex compressions retained:**

- Five-section structure (§§2.1–2.5) preserved.
- Two new one-line hammers: *"The metaphor remains."* (§2.1, §2.3); *"There is a reason."* (§2.3).
- The *"first two are not wrong"* hedge in §2.1 dropped — direct verdict *"The third explanation is the right one."*
- One meta-pointer paragraph dropped from §2.1 (*"The remainder of this chapter develops each pillar in turn…"*) — content largely restated in the structural-firewall + pre-emption paragraphs.
- §2.5 closing-sequence paragraph split for rhythm: *"the metaphor is the architecture of containment"* sentences separate from the *priests of progress* / *asuric pyramid* cascade.
- Generally tighter prose throughout (§2.2, §2.4); Abrahamic citations (Leviticus, Ephesians, Quran), Buddha-*Assalāyana*, Delhi Sultanate, *kālacakra* / *sattva* / *tamas* with Devanagari, *liber-* / *arāvan* etymology, and the §2.5 four-sentence close all preserved intact.

**Endnote stubs in this chapter:** `leviticus-slavery-25-44-46`, `ephesians-slavery-6-5`, `quran-slavery-citations`, `delhi-sultanate-mamluk`, `assalayana-sutta`, `liber-arāvan-etymology`.
