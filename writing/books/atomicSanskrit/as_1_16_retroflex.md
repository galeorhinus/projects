...
The *Dhātupāṭha* turns that placement into measurable architecture. Of the fourteen vowels of the वर्णमाला (*varṇamālā*), *ṛ* carries 15.3% of CVC deployment across the *Dhātupāṭha* — second only to *a* (अ). *Ra* covers all four position-roles at meaningful magnitude, and the *mūrdhanya* class as a whole shows the dual profile the reference appendix measures in detail: closure at atom-boundaries and joining inside clusters. Chapter 10 §10.14 and Appendix Part 6 carry the full statistical audit; here the point is placement. The retroflex is load-bearing.
