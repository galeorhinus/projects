...
The dharmic continuum's commitment is the opposite. The *Vedas* are ***apauruṣeya*** (अपौरुषेय) — without human author, not composed in time. They are ***śruti*** (श्रुति) — heard, not made. The eleven *pāṭhas* (पाठाः), the *Prātiśākhya* (प्रातिशाख्य) phonetic discipline, the *guru-shishya paramparā* (गुरुशिष्यपरम्परा) together form an error-correcting transmission channel engineered precisely to prevent change. The continuum's foundational commitment is that the *Vedas* have not changed.

The orthodoxy needs change. The continuum forbids it. There is no middle ground between them.

And the orthodoxy's position is internally incoherent. The same scholarly community that concedes the *Prātiśākhya* discipline operates engineered preservation — the layered redundancy, the phoneme-level error correction, the multi-generational *paramparā* — must explain why those engineers, capable of building a preservation channel more rigorous than any other ancient tradition documents, passively recorded substrate-acquired phonemes at the structural center of the system they engineered. Architects who design preservation at that level of rigor *choose* what to preserve. They do not arrive at central placement by accident. The substrate-borrowing claim asks the reader to accept that engineers of unprecedented rigor were also passive recipients of contact phonology — at the exact site (the *mūrdhanya* class) where the architecture later turns out to be most active. The claim cannot survive the structural reading.
