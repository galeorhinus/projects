...
- **Move one is wrong.** Vedic Sanskrit was not a naturally-spoken pastoralist tongue. It was engineered. The *"Aryans"* of the orthodoxy's migration script are the racial assemblage Chapter 17 dismantles; the language was engineered before and independent of any migration.
...
- **Move five is wrong.** An engineered language needs no natural ancestor. The Indo-European family tree built on the natural-language premise of moves one and two has nothing to inherit from. Chapter 19 dismantles the reconstruction.
