...
**The orthodoxy's foundational commitment runs opposite to the *Vedic* corpus's foundational commitment.** Moves one and two require Vedic Sanskrit to have changed — Indo-Aryan natural drift, accumulated phonological variation, the dialect-shift accounts of how features the parent language did not carry (the retroflex consonant series, the typologically rare syllabic *ṛ* ऋ) ended up in the corpus. None of those accounts work without change. The dharmic continuum's commitment is the opposite: the *Vedas* are ***apauruṣeya*** (अपौरुषेय) — without human author, not composed in time — and ***śruti*** (श्रुति) — heard, not made. The eleven *pāṭhas* (पाठाः), the *Prātiśākhya* (प्रातिशाख्य) phonetic discipline, the *guru-shishya paramparā* (गुरुशिष्यपरम्परा) together form an error-correcting transmission channel engineered precisely to prevent change. The orthodoxy needs change. The continuum forbids it. There is no middle ground between them. Chapter 16 develops the case where the contradiction lands sharpest — the retroflex consonant series — but the structural shape is present across every move that smuggles natural-language drift into the orthodoxy's account.
...
|---|---|---|---|
| ***Engineered*** | The architects (anonymous) | build | construct the architecture (*varṇamālā*, *dhātupāṭha*, the grammatical system) |
