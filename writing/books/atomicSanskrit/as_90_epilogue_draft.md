...
## Draft notes (Epilogue)

**Word count:** ~3,400 words across five sections plus opening framing paragraph. Affirmative forward-looking close of the book. Voice authoritative throughout per CLAUDE.md canonical convention.

**Section structure:**

- *Opening framing* — names the Epilogue's three moves: what becomes possible, what is still at stake, what the next generation must do.
- §1 *What Becomes Possible* — research domain opened by the engineering thesis: *Dhātupāṭha* as scientific object, *Aṣṭādhyāyī* as documented specification, *Vedic* recitation as empirical evidence, comparative engineered-preservation studies, language-factory experiments, Brāhmī engineering thesis. Forward-looking.
- §2 *The Contest of Architectures* — the polemic restated in the *asuratva* / *Sanātan* axis. **The reorientation**: the book's claim is *not "Sanskrit came first"* but *"the dharmic civilization today uniquely represents lokakṣema"*. Priority arguments are themselves asuric; the dharmic claim is contemporary-uniqueness, not primacy. The positive-pole close.
- §3 *The Battle for Brāhmī, the Battle for PIE* — the polemical appendix framed as four prosecutions of the same asuric-dharmic contest at different layers (language, institution, script, individual operator). Names why this fight is necessary.
- §4 *The Chronology Refusal* — the strategic position. The chronology may or may not be accurate. India is not yet equipped; the mindset is not aligned. Eighty years after independence, Deccan College Pune still operates the asuric framework. **Refuse to accept, refuse to provide an alternative**. The book holds the ground for the next generation.
- §5 *The Mantra* — *kṛṇvanto viśvam āryam | apaghnanto arāvṇaḥ*. Two phrases paired and conditional. The call is conditional on the speaker having operated *āryatva*. The reader as Wave 3 *ṛṣi* in potentia *after the re-learning*. Close with the mantra in Devanagari and English; "The work continues."

**Voice notes:**

- **Voice register: authoritative throughout** per CLAUDE.md canonical convention. Content as direct subject; impersonal third-person; named-cluster vocabulary (*asuratva* / *sattva* / *tamas* / *lokakṣema* / *kālacakra* / *Sanātan* / *āryatva*).
- Devanagari on first use within this chapter for: कृण्वन्तो विश्वम् आर्यम् अपघ्नन्तो अराव्णः (the mantra, full form).
- Polemic sharpened through active verbs with named agents (the orthodoxy claims, the asuric formation suppresses, the dharmic civilization operates, the next generation will fight) and through named-cluster vocabulary.

**Key polemic moves:**

- The book's argument is *not* "Sanskrit came first" but "the dharmic civilization today uniquely represents *lokakṣema*."
- The chronology refusal is *strategic*, not just methodological — India is not yet equipped; the mindset is not aligned; refuse to accept and refuse to provide an alternative.
- The contemporary cost of the asuric suppression: the *kṛṇvanto viśvam āryam* call cannot be authentically made by a civilization the world has been told is downstream.
- Deccan College Pune named as the contemporary exemplar of the institutional continuation of the colonial framework, 80 years after political independence.
...
- Ch 16 §16.5 (cross-lineage empirical verification of the *pāṭha* tradition).
...
- §1 (*What Becomes Possible*) could be expanded with named contemporary scholars / programs whose work the engineering thesis would enable. Currently the section is research-domain-oriented rather than people-oriented; could be re-pointed if specific scholar attributions become available.
- §4 (*The Chronology Refusal*) extends the Preface's chronology note. The two are intentionally paired — Preface establishes the methodological asymmetry; Epilogue establishes the strategic refusal. Could be tightened in a future pass if the doubling reads as repetitive.
- §5 (*The Mantra*) lands the full Rigvedic call. The primary-source citation and the philological-omission case (Wilson and Griffith translators omitting *viśvam āryam* and *apaghnanto arāvṇaḥ*) are developed in Chapter 3 §3.4. The Epilogue's mantra-landing assumes that prior development; the close does not re-prosecute the omission case.
