...
**Word count target:** ~2,600 words across the four sections. Codex compression (1,430) + Tier 1 + Tier 2 fully restored + Tier 3 content compressed to Codex-register tightness.

**Restoration log (Codex base → merged v2):**

- §13.1 — restored: Patañjali's four documented *apabhraṃśas* with *Mahābhāṣya* anchor (*gāvī*, *goṇī*, *gotā*, *gopotalikā*); four-section roadmap (compressed to one sentence); three-clause "Chapter 13 names the problem; Chapter 14 names the engineering; Chapter 15 develops it in operation" hammer; *guru-shishya paramparā* phrasing on the eleven *pāṭha* forms.
- §13.2 — restored: *prākṛtika* (प्राकृतिक) / *sāṃskṛtika* (सांस्कृतिक) adjective pair with Devanagari; *saṃskṛta*-is-the-name-of-the-language reflexive observation.
- §13.3 — restored: **Decay** / **Destruction** as bolded structural labels; modern digital-media decay examples (magnetic tape, optical disk, flash bit-rot, cloud institutional continuity); Islamic-and-colonial destruction track-record; three-Abrahamic-faiths specific naming (Hebrew Bible / New Testament / Qur'an); capital-S *Scripture* structural observation; *asuric pyramid* Ch 3 §3.6 cluster reference; *Appendix Part 3 — The Imperishable Audiograph* cross-reference + ***audiography*** coinage; engineering-thesis subtitle anchor (compressed); every-move-has-the-same-shape pattern statement naming the four-case *heroic erasure* (Pāṇini / *Prātiśākhya* / *Śikṣā* / script adapter); glyph-shapes-may-show-contact narrow concession; closing "architecture's hard work is the *varṇamālā* itself" hammer.
- §13.4 — restored: Chapter 2 §2.4 linear-progress teleology cross-reference; multi-channel-redundancy expanded language; four-engineered-modes count phrasing; verdict-register hammer-close: *"The label oral tradition tells the reader nothing about the architecture. It tells the reader only that the standard narrative has decided not to look."* (Final "The architecture placed the answer elsewhere. The next chapter lays out where." line dropped since the new §13.5 now does the Ch 14 handoff.)
- §13.5 (added 2026-05-20) — ***Calibrated*, Not *Codified*** — new closing section landing the *standardization by architecture, not authority* load-bearing theme. Five-language drumbeat catalog (Greek / Latin / Arabic / Hebrew / Tibetan) with the codification-doesn't-stop-drift opening verdict and the calibration-architecture closing hammer. Mirrors §13.4's *Aural*, Not *Oral* heading pattern at the categorical layer. Discipline-name casing made consistent with Ch 14 (*Prātiśākhya* / *Śikṣā* / *Chandas* / *Vyākaraṇam* / *Dhātupāṭha* capitalized; *pāṭha* lowercase as a recitation form).

**CLAUDE.md convention pass:** *Prātiśākhya tradition* → *Prātiśākhya discipline*; *Śikṣā tradition* → *Śikṣā discipline* (per the *tradition* reserved-for-orthodoxy rule). *Oral tradition* preserved as the orthodoxy's mislabel — the entire §13.4 is the polemic against the label. *Guru-shishya paramparā* / *guru-shishya transmission* preserved as the Indic transmission unit.

**Codex compressions retained:**

- Four-section structure (Codex tightened, restoration kept the tightened structure).
- Punchier topic-sentence openings: *"Sanskrit's architecture was built to last."* / *"The civilization that engineered Sanskrit organized its world through a functional distinction."* / *"लीपि (lipi) is writing: linguistic content fixed in visible marks."* / *"India has an oral tradition. So does every civilization."*
- *"That is the category error."* one-line hammer between the script-chronology-obsession description and the Brāhmī-is-the-varṇamālā-made-visible counter.
- *"That is the normal direction of language. It falls away."* §13.1 short-line.

**Cross-references:**

Backward — Ch 5 §5.3 (*gauḥ* + Patañjali's four *apabhraṃśas*); Ch 5 §5.6 (*apabhraṃśa* / *sanātan* / calibrant envelope); Ch 7 / Ch 8 (*varṇamālā* / *sthāna* / *prayatna* — the engineering the *lipi* coda references); Ch 8 §8.6 (*heroic erasure* established; this chapter applies it at the script level); Ch 2 §2.4 (linear-progress teleology); Ch 3 §3.6 (*asuric pyramid* / *church of progress* establishment); Ch 1 §1.1 (the four-term polemic stack).

Forward — Ch 14 (the calibration matrix proper; the four preservation modes; the *Auditure* and speech-hearing engineering); Ch 15 (the *pāṭha* operational walkthrough); Appendix Part 3 (the imperishable audiograph + *audiography*).
