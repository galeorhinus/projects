...
- **§9.5 reframed.** Section title changed from *The Pedagogical Reading* to *The True Test of Āryatva* per author direction — keeps with the recurring theme of what *ārya* really means. The pedagogical account is the section's content; the section title commits the reader to the chapter's structural thesis.
...
- §9.5 chapter-close hammer — current: *The flex is the test. The training is open. The work begins at the mouth.* Three-sentence rhythm; echoes the chapter's controlling wordplay; commits to the pedagogical account. Alternative candidates from `archive/notes/as_1_08_mapping_mouth_notes.md` §5.5 retained for author preference.
