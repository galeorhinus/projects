...
- §9.5 chapter-close hammer — current: *The flex is the test. The training is open. The work begins at the mouth.* Three-sentence rhythm; echoes the chapter's controlling wordplay; commits to the pedagogical reading. Alternative candidates from `as_1_08_mapping_mouth_notes.md` §5.5 retained for author preference.
