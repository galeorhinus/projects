...
Only now does the pyramid's puzzle appear, and only now does it dissolve. The *asura* also stands as the adversary the *devāḥ* throw down; across the mountains the Avestan *ahura* is the high word of praise — Ahura Mazdā, the Wise Lord. To Western philology this is a discovery: one word that flipped its sense across the ages, and on the flip a whole prehistory — an Indo-Iranian religious schism, two branches of one people who split and traded their *devas* for *asuras*, the debris of a lost common theology reconstructed backward into PIE. But nothing flipped, and nothing came late. The praised *asura* is the breath-bearer, the holder of life — and the Iranian *ahura* is that same holder of life, never turned, because he was never the other word at all. The adversary is *a-sura*, the withholder — the other word on the same shape, standing beside the praise, not arriving after it. The schism the machinery reconstructed was never in the languages, and never in time. It was in the philologist's ear, which could not hold two words on one form.
