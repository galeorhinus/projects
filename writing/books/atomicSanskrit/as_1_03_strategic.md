...
So when this book says *asura*, it means the second word. Not the breath-bearer the Ṛgveda praises — the *a-sura*, the un-shining, the one who holds back the light. That is the *asura* the book carries across its chapters: the container, the withholder. The word does not settle the category; the deed does. And the deed of the *a-sura* is withholding — which is exactly where the Veda's oldest myths take up the case.
...
*Vṛtra* (वृत्र) — from ⟪वृ⟫ (*vṛ*, *to cover, to obstruct*) — dams the waters on the mountain; Indra's *vajra* splits the enclosure and the rivers run (RV 1.32).[NOTE: rv-1-32-vrtra] The **Paṇis** (पणयः) — the *niggards* — hoard the cattle, which are the dawn-herd, the light, walled in the **Vala** (वल) cave; Indra with the Aṅgirases (अङ्गिरसः) breaks the rock and "displays the light of heaven" (RV 2.24.3; the Saramā (सरमा)–Paṇi dialogue, RV 10.108).[NOTE: rv-vala-panis] *Svarbhānu* (स्वर्भानु) pierces Sūrya with darkness until "the worlds knew not their place"; Indra dissolves his *māyā*, and Atri, by the fourth formulation, restores "the eye of Sūrya" — none besides had the power (RV 5.40).[NOTE: rigveda-5-40-atri-clearing] Waters, cattle-light, sun: three goods enclosed, three releases. The moral axis is not power against weakness. It is **release against withholding** — the swastika against the pyramid.

**Now the proof that the deed rules, not the word.** *Vṛtra* is the greatest container in the Ṛgveda, and the Ṛgveda never calls him *asura*; he is *māyin*, Dāsa, Dānava. The Paṇis are the archetype of hoarding, and they are not *asura* either. Yet *Svarbhānu* the sun-darkener *is* called *āsura* (RV 5.40.5), and so is Namuci (नमुचि) the strength-withholder. The word attaches to some containers and skips others; the *function* attaches to all of them. Judged by the word, the category dissolves. Judged by the deed, it is exact. **Action, not word.**

**The power is real, and it is one power in two orientations.** In the Veda the *asura* is the sovereign *measurer*: Varuṇa *amimīta* — "measured out the earth" (RV 8.42.1) — by *māyā*, which here is the power to measure and form.[NOTE: rv-8-42-1-varuna-measures] That is the engineering faculty in Vedic dress. ***असुरत्व (*asuratva*)*** is that measuring sovereignty in its two orientations: it upholds the measure and lets the flow move — *suric*, oriented to *lokakṣema* (लोकक्षेम) — or it walls the flow and hoards the light — *asuric*, the pyramid. Varuṇa *builds*: he props the sky and measures the earth, and the Veda praises him, because under his propped frame the waters and the light still move. Vṛtra *builds* too — a dam — and the Veda condemns him, because his structure withholds. **Building is not the fault. Enclosure is.** That is the exact line between a *boundary*, a constraint that serves the order, and an *enclosure*, a capture that hoards.

And the sovereign power is not a single peak. *mahád devā́nām asuratvám ékam* — "great is that one sovereign power *of the devas*" (RV 3.55): held across the many, not seized at an apex.[NOTE: rv-3-55-asuratvam-ekam] The pyramid is precisely the seizure the Veda refuses.
