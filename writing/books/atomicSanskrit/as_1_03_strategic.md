...
No institution had to refute an engineered-Sanskrit thesis, because the accepted categories made that thesis difficult to formulate. A student first learns that *dhātuḥ* means root, that Sanskrit descends from PIE, and the codification myth in which Pāṇini imposes order on a language already changing through time. Those categories arrive before the evidence, so they teach the student how every later fact must be interpreted.
