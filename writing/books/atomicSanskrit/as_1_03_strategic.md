...
English, like Sanskrit and many other languages, keeps words identical in form yet opposite in meaning. A captive lies *bound* — tied, pinned, unable to move a limb. A hare goes *bounding* over the hedge — leaping, springing, moving as freely as a thing can move. Held fast and leaping free, on the same one syllable. No English speaker ever confuses the two: *the prisoner lay bound to the chair* and *watch the deer bound across the field* fall on opposite sides without a moment's thought. The sentence around the word decides which is meant. Context does the whole work.
...
Context is as decisive in the Veda as in English, and the Ṛgvedic *asura* is a title won by a deed. Indra wears it for what he does — he holds the sovereignty the *devāḥ* themselves stand under, and he guards the people:
...
Varuṇa wears it for a different deed — he *releases*. The sovereign addressed as *asura* is the one with the authority to loosen what binds:
...
Two deeds, one title. Indra holds and guards; Varuṇa binds and looses. The *asura* the Ṛgveda crowns is the sovereign who holds the life of the worlds and lets it move — the bearer of *asu*, the life-breath, exactly the figure *nāmāny ākhyātajāni* would predict. This is the *asura* the corpus praises.
...
> ***a-sura*** (असुर) — *the sura's opponent*: *asurāḥ suravirodhinaḥ*, "adversaries of the *suras*." A *laukika* parse — *sura* is a later back-formation.
>
...
Four alternatives for one form. Three parse the word by a deed — *vaidika* action-derivations: the evil-caster who hurls off misfortune (⟪अस्⟫), the cast-down flung from his station (⟪अस्⟫), and the breath-bearer who holds the life-force (*asu*). The fourth, *a-sura*, is *laukika* — a relational gloss from the curated world, *asurāḥ suravirodhinaḥ*, "opponents of the *suras*," which leaves *sura* unrooted. The discipline completes it: *sura* is the shining one, from the *dhātu* ⟪सुर्⟫ (*sur*, *to shine*), and *a-sura* is its privative — the un-shining, the one who gives no light, the one who holds it back. **Separate the derivations and the two asuras stand apart. The *asura* the Ṛgveda crowns and the *asura* of the adversary are not one word. They are two** — *asu-ra*, the breath-bearer the mantras just crowned, and *a-sura*, the withholder, the other word on the same shape.

Only now does the pyramid's puzzle appear, and only now does it dissolve. In the later corpus the *asura* is the adversary the *devāḥ* throw down; across the mountains the Avestan *ahura* is the high word of praise — Ahura Mazdā, the Wise Lord. To Western philology this is a discovery: one word that flipped its sense, and on the flip a whole prehistory — an Indo-Iranian religious schism, two branches of one people who split and traded their *devas* for *asuras*, the debris of a lost common theology reconstructed backward into PIE. But there was never one word to flip. The Ṛgveda's *asura* is the breath-bearer, the sovereign — and the Iranian *ahura* is that same crowned sovereign, never reversed, because he was never the other word at all. The adversary is *a-sura*, the withholder — the other word wearing the same shape. The schism the machinery reconstructed was never in the languages. It was in the philologist's ear, which could not hold two words on one form.

So when this book says *asura*, it means the second word. Not the breath-bearer the Ṛgveda crowns — the *a-sura*, the un-shining, the one who holds back the light. That is the *asura* the book carries across its chapters: the container, the withholder. The word does not settle the category; the deed does. And the deed of the *a-sura* is withholding — which is exactly where the Veda's oldest myths take up the case.
