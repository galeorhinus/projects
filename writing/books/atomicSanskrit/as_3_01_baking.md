...
*Draft v2 (2026-05-20). Four-tier merge of Codex compression (2,084 words) against the canonical session-2026-05-14 draft (5,800 prose words). **Appendix register**: T1 + T2 + T4 restored verbatim; T3 compressed to Codex-register tightness. T4 = dossier-register preservation (dated-figure chains, primary-source quotation specifics, institutional/pipeline named specifics, verification-trail material the body footnotes-out but the appendix keeps inline). Prosecutorial-appendix posture: the receipts stay on the page.*

---

The bake began before independence. The continuation after independence is Appendix Part 2.

This appendix prosecutes the pre-independence operation: the colonial Sanskrit-knowledge enterprise that gathered, trained, catalogued, translated, and fed Sanskrit into the European philological machine. Deccan College Pune is the named exemplar, not because it invented PIE, but because its institutional arc exposes the machinery. Sanskrit knowledge was taken from the *paramparā* (परम्परा), processed through colonial institutions, routed into Europe, baked into PIE, and returned to India as the new authority over Sanskrit.

The wheat was Indian. The bakery was European. The recipe was inversion.

## 1.1 The Pipeline

The East India Company entered India as a trading corporation and became a controlling apparatus. To control, it needed Sanskrit. It needed *dharmaśāstra*, land grants, customary law, temple records, legal categories, and the Sanskrit-literate intermediaries who could read the civilizational order the Company had conquered. The Company therefore built and funded a Sanskrit-knowledge enterprise.
...
The starred form is the bake. Every starred PIE root in the contemporary literature was produced by this operation. The Sanskrit *dhātu* was the input. The daughter-language cognates were the surface data. The starred form was the fabricated middle term that demoted Sanskrit from source to sibling. The orthodoxy made an *apaśabda* (अपशब्द) and then called the *apaśabda* the source of the *śabda* (शब्द). Where Sanskrit's own framework names *apaśabdas* as derivatives of *śabdas* (Chapter 5 §5.3; Chapter 12 §12.5), the orthodoxy's framework names PIE as the source of *śabdas* — inverting the direction of derivation by main force.
...
- **CIE date discrepancy** — canonical body says **CIE 1889**; canonical draft notes say **CIE 1894**. Inline [VERIFY: bhandarkar-cie-date] marker added at the Bhāṇḍārkar paragraph. Standard biographical references (Wikipedia, BORI institutional history) report variable dates (1885, 1887, 1889 across sources). Resolve via BORI's institutional archive or standard Bhāṇḍārkar biography before chapter-lock.
- **BORI founding date** — 6 July 1917 confirmed. Canonical body said this was Bhāṇḍārkar's "eighty-first birthday"; he was born 1837, so 6 July 1917 would be his eightieth birthday. Adjusted to "eightieth" in merged text; verify against canonical biographical sources before chapter-lock.

**Endnote stubs (preserved from canonical, no changes):**

- `jones-1786-anniversary-address`; `boden-chair-1832-evangelical-purpose`; `deccan-college-founding-arc`; `shabdakalpadruma-deb-1858`; `vacaspatyam-taranatha-1873`; `rg-bhandarkar-honors`; `bopp-1816-conjugationssystem`; `schleicher-1861-compendium`; `schleicher-1868-fable`; `brugmann-grundriss-1886`.
