...
> ***The engineering's upstream origin is not visible in the historical record;* apauruṣeyatva *is the* paramparā*'s own anchor for the position. The* Vedas *carry the engineering across thousands of years as the corpus form, implicit in every recitation rule and every metrical specification.***
...
- ***vareṇyam*** (वरेण्यम्) — **accusative singular neuter** of *vareṇya* (वरेण्य, *to be chosen, excellent*) — a *kṛdanta* (कृदन्त, primary derivative) formed from the *dhātu* *vṛ* (वृ, *to choose*) + the *kṛt-pratyaya* (कृत्-प्रत्यय) *-ya* with *guṇa* vowel-grade. The *dhātu* → *śabda* assembly chemistry the book describes (Chapter 12) is operating directly in the verse.
...
The *dhātu*-level demonstration completes the appendix's empirical case. The *varṇa*-level architecture (Chapters 7–10) is operating in the Vedic phonemes; the *dhātu*-level inventory (Chapter 10, Appendix Part 5, this section) is operating in the Vedic verbs and nouns; the *śabda*-level assembly chemistry (Chapter 12) is operating in the *upasarga* + *dhātu* + *pratyaya* stacks the verses deploy. The architecture is present in the corpus at every level the book describes. No *vyākaraṇa* text yet exists to *describe* it; the *Vedic* corpus is operating it.
...
|---:|---|---|---|
| 1 | Retroflex lateral **ळ (*ḷ*)** "lost" | Vedic *agnimīḷe* (अग्निमीळे) → Classical *agnimīle* / *agnimīḍe* | Not lost; preserved in *chandasi* mode, not deployed in *bhāṣāyām* mode by engineered design (Ch 16 §16.3). The Nambūdiri, Mādhyandina śākhās still recite the Vedic ळ exactly. |
...
| 7 | Vedic compound looseness "tightened" | Vedic loose *tatpuruṣa* (तत्पुरुष) compounds with separable elements → Classical tight compounds with productive *bahuvrīhi* (बहुव्रीहि) proliferation | Productive register shift, not drift. The *bhāṣāyām* mode operates the full Pāṇinian *samāsa* (समास, compound) framework more aggressively because *bhāṣā* is the productive register; the Vedic corpus operates compounds more loosely because meter constrains the available compound-forms differently. |
